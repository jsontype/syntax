...
<div class="container">
  ...
  <div class="row">
    <ul class="list-group">
      <!-- 이전 강의 타이틀 -->
      <?php
      $sqlminus = "SELECT * FROM `azuma_f_bbs1` WHERE no = $no-1 and del_flg = '0'";
      ...
      <!-- 다음 강의 타이틀 -->
      <?php
      $sqlplus = "SELECT * FROM `azuma_f_bbs1` WHERE no = $no+1 and del_flg = '0'";
...
<?php
// 댓글 수 표시하기
$sql_count = "SELECT * FROM `azuma_f_comment1` WHERE del_flg = '0' AND cid = 'bbs1' AND no = '$no'";
