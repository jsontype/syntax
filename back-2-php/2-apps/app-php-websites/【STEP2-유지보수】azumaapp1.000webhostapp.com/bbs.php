                                    ...
                                    <a href="#">
                                        <?php
                                            ...
                                            if(strlen($limitedStr) >= 10) {
                                                $limitedStr = str_replace($bbs['name'], mb_substr($bbs['name'],0,10,"utf-8")."...", $bbs['name']);
                                            }
                                            echo $limitedStr;                                            
                                        ?>
                                    </a>
                                ...
                                <p class="tags">in
                                    <a href="#">
                                        <?php                                            
                                            ...
                                            if(strlen($limitedStr) >= 10) {
                                                $limitedStr = str_replace($bbs['category'], mb_substr($bbs['category'],0,10,"utf-8")."...", $bbs['category']);
                                            }
                                            echo $limitedStr;
                                        ?>
                                    </a>
