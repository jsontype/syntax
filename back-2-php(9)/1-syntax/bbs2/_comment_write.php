...
/* <!-- DB 업로드 --> */
$sql = "INSERT INTO `azuma_php_comment1` (`cno`, `no`, `cid`, `id`, `nickname`, `pw`, `regdate`, `moddate`, `ip`, `comment`, `delflag`) VALUES (NULL, '$no', '$cid', '$id', '$nickname', NULL, current_timestamp(), NULL, NULL, '$comment', '0')";
