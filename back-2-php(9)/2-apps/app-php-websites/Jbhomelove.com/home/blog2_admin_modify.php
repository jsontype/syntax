...
<div class="row justify-content-center mb-5 pb-2">
  <div class="col-md-8 text-center heading-section ftco-animate">
    <form action="_blog2_admin_modify.php?no=<?=$no?>" class="p-5 bg-light" method="post" enctype="multipart/form-data">
      <div class="form-group">
      <h2 class="mb-4"><span><?=$no?>번 교육자료</span> 수정<br><br></h2>
      ...
      <div class="form-group">
        ...
        <input type="button" value="뒤로가기" onclick="location.href='blog2_admin.php'" class="btn py-3 px-4 btn-primary">
      </div>
    </form>
  </div>
</div>
