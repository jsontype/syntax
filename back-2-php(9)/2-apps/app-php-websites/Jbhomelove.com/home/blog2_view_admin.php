            ...
            <div class="tag-widget post-tag-container mb-5 mt-5">
              <div class="tagcloud">
                ...
                if(isset($_SESSION['id'])){
                  if($_SESSION['id'] == $v['id']){ ?>
                    <a href="blog2_admin_modify.php?no=<?=$v['no']?>" class="tag-cloud-link">수정</a>
                    <a href="_blog2_admin_delete.php?no=<?=$v['no']?>" class="tag-cloud-link" OnClick="return confirm('정말 삭제하시겠습니까?');">삭제</a>
                    <a href='blog2_admin.php' class='tag-cloud-link' class='tag-cloud-link'>목록</a>
                  <?php
                } else { echo "<a href='blog2_admin.php' class='tag-cloud-link' class='tag-cloud-link'>목록</a>"; }
                } else { echo "<a href='blog2_admin.php' class='tag-cloud-link' class='tag-cloud-link'>목록</a>"; }
                ?>
              </div>
            </div>
