      ...
      <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
          <div class="about-content col-lg-12">
            ...
            <p class="text-white link-nav"><a href="index.php">홈 </a>  <span class="lnr lnr-arrow-right"></span>  <a href="blog1.php"> 공지사항</a></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-6 appointment-right pt-60 pb-60">
            <form class="form-wrap" action="_blog1_modify.php?no=<?=$no?>" method="post" enctype="multipart/form-data">
              ...
              <textarea name="content" class="form-control" cols="30" rows="10" placeholder="내용을 입력해주세요."><?php $bcontent = $mod['content']; $bcontent = str_replace("<br />", "", $bcontent); echo $bcontent?></textarea><br>
              ※ 이미지 수정 필요시 등록하세요. : <input type="file" name="img1"><br><br>
              <button type="submit" class="primary-btn text-uppercase">보내기</button>
              <button type="button" class="primary-btn text-uppercase" onclick="location.href='blog1.php'">뒤로가기</button>
            </form>
          </div>
        </div>
      </div>
