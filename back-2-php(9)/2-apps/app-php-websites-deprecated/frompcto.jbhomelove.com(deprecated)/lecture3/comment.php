<div class="container">
  ...
  $sql_comment = "SELECT * FROM `azuma_f_comment1` WHERE del_flg='0' AND cid='bbs3' AND no={$v['no']}";
...
<br>
  ...
  <form class="form-horizontal" action="_comment_write.php" method="post">
    <div class="form-group">
      ...
      <input type='hidden' name='cid' value='bbs3'> <!-- ★ 게시판 ID : cid는 bbsid와 동일하게 설정한다. cid가 없으면 타게시판/블로그와 no 동일할 경우에 다른 곳의 댓글이 여기서도 댓글이 보이게 된다. -->
