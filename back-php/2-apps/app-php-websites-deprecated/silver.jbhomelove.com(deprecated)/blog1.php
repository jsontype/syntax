						...
						<div class="col-lg-6">
							<div class="single-cat-widget">
								<div class="content relative">
								    ...
								    <a href="blog1.php">
								      <div class="thumb">
												<img class="content-image img-fluid d-block mx-auto" src="img/blog/cat-widget2.jpg" alt="공지사항 사진">
								  	  </div>
						...
						<div class="col-lg-8 posts-list">
							...
							<div class="single-post row">
								<div class="col-lg-3  col-md-3 meta-details">
									<ul class="tags">
										<li><a href="#"><b><strong>공지사항</strong></b></a></li>
									</ul>
								...
								<div class="col-lg-9 col-md-9 ">
									...
									<?php
		              if(isset($v['imgfile1'])){  ?>
										<div class="feature-img"><a href="blog1_view.php?no=<?=$v['no']?>"><img class="img-fluid" src="blog_images/<?=$v['imgfile1']?>" alt="게시물이미지"></a></div>
									<?php } else {} ?>

									<a class="posts-title" href="blog1_view.php?no=<?=$v['no']?>"><h3><?=$v['title']?></h3></a>
									<!-- <p class="excert">
										MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.
									</p> -->
									<a href="blog1_view.php?no=<?=$v['no']?>" class="primary-btn"><strong>자세히보기</strong></a>
								</div>
							</div>
							<!-- Single-Post End -->
              ...
              <nav class="blog-pagination justify-content-center d-flex">
                  <ul class="pagination">
                      ...
                      <li class="page-item"><a href="#" class="page-link"><strong>앞</strong></a></li>
										<?php } else { ?>
											<li class="page-item active">
                          <a href="blog1.php?current_blog_page=1" class="page-link" aria-label="Previous">
                              <span aria-hidden="true">
                                  <span class="lnr lnr-chevron-left"></span>
                              </span>
                          </a>
                      </li>
                      <li class="page-item"><a href="blog1.php?current_blog_page=<?=$prev_blog_page?>" class="page-link"><strong>앞</strong></a></li>
										<?php } ?>
                          ...
                          <a href="#" class="page-link" aria-label="Next">
                              <span aria-hidden="true">
                                  <span class="lnr lnr-chevron-right"></span>
										...
										<?php } else { ?>
											<li class="page-item"><a href="blog1.php?current_blog_page=<?=$next_blog_page?>" class="page-link"><strong>뒤</strong></a></li>
                      <li class="page-item active">
                          <a href="blog1.php?current_blog_page=<?=$end_blog_page?>" class="page-link" aria-label="Next">
                              <span aria-hidden="true">
                                  <span class="lnr lnr-chevron-right"></span>
                              </span>
                          </a>
								...
								<li> &nbsp;
											...
											<?php } else { // 세션 있는 경우 ?>
													<a href="blog1_write.php"> &nbsp;<strong>등록</strong></a>
											<?php } ?>
