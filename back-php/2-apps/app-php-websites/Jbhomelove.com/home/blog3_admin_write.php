<?php require('lib/top_admin.php'); ?>
    ...
    <div class="row justify-content-center mb-5 pb-2">
      <div class="col-md-8 text-center heading-section ftco-animate">
        <form action="_blog3_admin_write.php" class="p-5 bg-light" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="hidden" class="form-control" name="pw" value="sdvewvedveve24">
          </div>
