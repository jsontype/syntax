/*
    ...
    따라서 진정한 의미의 값 복사를 하려면 JSON.stringify()로 한번 문자열화 한 뒤, JSON.parse()로 배열로 파싱을 해서 새로운 주소로 값 복사가 된다.
*/
...
// 배열의 값 복사
// let a = [1]
// let b = JSON.parse(JSON.stringify(a)) // 새 주소로 복사됨
// a.push(2)
// console.log(b) // [1]
...
// let b = a
// a.id = 'kang'
// console.log(b.id) // 'kang'

// 객체의 값 복사
let a = {id: 'yang'}
let b = JSON.parse(JSON.stringify(a)) // 새 주소로 복사됨
a.id = 'kang'
console.log(b.id) // 'yang'
