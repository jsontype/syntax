...
export default function Login({ onSubmit }: LoginProps) {
    ...
    // onChange의 e 객체의 타입은 React.ChangeEvent<HTMLInputElement>로 지정해서 구현할 수 있다.
    // 또는 그냥 e만 입력한 뒤, e에 hovering하고, 빠른 수정으로 간 뒤, "매개형식 유추"로 유추된 타입을 지정하면 된다.
    ...
    // onSubmit의 e 객체의 타입은 React.FormEvent<HTMLFormElement>로 지정해서 구현할 수 있다.
    // 또는 그냥 e만 입력한 뒤, e에 hovering하고, 빠른 수정으로 간 뒤, "매개형식 유추"로 유추된 타입을 지정하면 된다.
