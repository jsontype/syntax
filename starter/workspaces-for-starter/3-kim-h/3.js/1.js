...
// JSON: JavaScript Object Notation, 객체 안에, 객체가 들어있으면 JSON 타입
const json = {
    user1: { id: "ydhvocal", pw: "lasd;kdfjksak", name: "Yang" },
    user2: { id: "ydhvocal", pw: "lasd;kdfjksak", name: "Yang" },
    user3: { id: "ydhvocal", pw: "lasd;kdfjksak", name: "Yang" }
}
