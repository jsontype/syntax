                        ...
                        <div class="login-form">
                            <form action="_userChange.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input name="id" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="* Enter Your E-mail Address" value="<?=$_SESSION['id'];?>" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" class="form-control" placeholder="* Enter Your Nick Name" value="<?=$_SESSION['name'];?>">
                                </div>
