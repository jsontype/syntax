...
--
-- 테이블 구조 `azuma_jb_blog1`
--

CREATE TABLE `azuma_jb_blog1` (
  `no` int(15) NOT NULL,
  `id` char(15) NOT NULL,
...
--
-- 테이블의 인덱스 `azuma_jb_blog1`
--
ALTER TABLE `azuma_jb_blog1`
  ADD PRIMARY KEY (`no`);
...
--
-- 테이블의 AUTO_INCREMENT `azuma_jb_blog1`
--
ALTER TABLE `azuma_jb_blog1`
