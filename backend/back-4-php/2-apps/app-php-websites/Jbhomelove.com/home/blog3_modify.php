...
<div class="row justify-content-center mb-5 pb-2">
  <div class="col-md-8 text-center heading-section ftco-animate">
    <form action="_blog3_modify.php?no=<?=$no?>" class="p-5 bg-light" method="post" enctype="multipart/form-data">
      <div class="form-group">
        <h2 class="mb-4"><span><?=$no?>번 자유게시판</span> 수정<br><br></h2>
        <input type="hidden" name="id" value="guest">
        <input type="text" name="nickname" placeholder="성함 또는 닉네임을 입력해주세요." value="<?=$mod['nickname']?>">
      </div>
      <div class="form-group">
