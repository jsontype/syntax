...
function loadClass(className) {
  ...
  switch (className) {
    case 'Connection':
      Class = require('mysql/lib/Connection');
      break;
    case 'ConnectionConfig':
      Class = require('mysql/lib/ConnectionConfig');
      break;
    case 'Pool':
      Class = require('mysql/lib/Pool');
      break;
    case 'PoolCluster':
      Class = require('mysql/lib/PoolCluster');
      break;
    case 'PoolConfig':
      Class = require('mysql/lib/PoolConfig');
      break;
    case 'SqlString':
      Class = require('mysql/lib/protocol/SqlString');
      break;
    case 'Types':
      Class = require('mysql/lib/protocol/constants/types');
      break;
    default:
