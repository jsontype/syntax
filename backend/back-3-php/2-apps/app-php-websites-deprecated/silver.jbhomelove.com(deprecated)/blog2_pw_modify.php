      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-6 appointment-right pt-60 pb-60">
            <form class="form-wrap" action="_blog2_pw_modify.php?no=<?=$no?>" method="post" enctype="multipart/form-data">
              <h3 class="pb-20 text-center mb-30">글쓰기</h3>
              <input type="text" class="form-control" name="nickname" value="<?=$mod['nickname']?>" placeholder="닉네임을 입력해주세요." maxlength="15"><br>
