...
function work(callback) {
  ...
  setTimeout(() => {
    ...
    callback(start, end) // callback 함수사용법 2: callback을 마지막에 놓는다.
  }, 1000)
}

work((startTime, endTime) => {
  console.log("시작 시간: ", startTime)
  console.log("끝난 시간: ", endTime)
}) // callback 함수사용법 3: 콜백을 사용하는 함수를 호출할 때는 work()가 아닌 work(() => {}) 이렇게 "★★ 함수형 업데이트"를 통해서 호출해야 한다.
