...
} from 'apollo-server-core/src/plugin/usageReporting/operationDerivedDataCache';
import { usageReportingSignature } from '@apollo/utils.usagereporting';
import type {
  ApolloServerPluginUsageReportingOptions,
  SendValuesBaseOptions,
} from 'apollo-server-core/src/plugin/usageReporting/options';
import { dateToProtoTimestamp, TraceTreeBuilder } from 'apollo-server-core/src/plugin/traceTreeBuilder';
import { makeTraceDetails } from 'apollo-server-core/src/plugin/usageReporting/traceDetails';
import { GraphQLSchema, printSchema } from 'graphql';
import { computeCoreSchemaHash } from 'apollo-server-core/src/plugin/schemaReporting';
import type { InternalApolloServerPlugin } from 'apollo-server-core/src/internalPlugin';
import { OurReport } from 'apollo-server-core/src/plugin/usageReporting/stats';
import { defaultSendOperationsAsTrace } from 'apollo-server-core/src/plugin/usageReporting/defaultSendOperationsAsTrace';
import {
