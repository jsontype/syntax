...
arr.forEach((item, index) => {
  item > 3 ? console.log("index ===>", index) : console.log("")
})
...
arr.map((item, index, arr) => {
  console.log("value, index, arr ===>", item, index, arr)
  return item + 1
})
...
arr.reduce((accumluate, value, index, array) => {
  console.log(
    "return누적값, value, index, array ===> ",
    accumluate,
    value,
    index,
    array
  )
  return accumluate + value
})
