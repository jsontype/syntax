...
function App() {
  ...
  const [isCounter3, setIsCounter3] = useState(false);
  ...
  return (
    <div className="App">
      ...
      <button onClick={() => setIsCounter3(!isCounter3)}>Toggle Counter3 (Life Cycle)</button>
      { isCounter3 && <UseEffectSample count={count} setCount={setCount} /> }
    </div>
  );
}
