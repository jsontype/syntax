...
//   console.log("x: ", x)
// }
// 문제 : 변수 x가 10보다 크거나, 20보다 작을 때 변수 x를 출력하는 조건식을 완성하라.
// if (x > 10 || x < 20) {
//   console.log("x: ", x)
// }
// 문제 : 변수 x에 3을 곱한 값이 10보다 큰 경우, 변수 x를 출력하는 조건식을 완성하라.
// if (x * 3 > 10) {
//     console.log("x: ", x)
// }
// 문제 : y를 1로 선언하라.
...
// 문제 : 변수 y에 5를 곱한 값이 x보다 큰 경우, 변수 x를 출력하는 조건식을 완성하라.
// if (y * 5 > x) {
//     console.log("x: ", x)
// }
...
// 1. 반복문 x 조건문
// 문제(난이도 2/3) (if문필요) : 알파벳으로 이루어진 배열이 주어졌을 때, 배열중에 g 가 있는지 확인하고 있으면 "g 찾았다!"를 출력하시오.
