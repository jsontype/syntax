...
var rem = function (px) { return "".concat(round(px / 16), "rem"); };
var em = function (px, base) { return "".concat(round(px / base), "em"); };
        ...
        css: [
            ...
            },
            {
                ...
                'ul > li::before': {
                    width: em(6, 16),
                    height: em(6, 16),
                    top: "calc(".concat(em(28 / 2, 16), " - ").concat(em(3, 16), ")"),
                    left: em(4, 16),
                },
                '> ul > li p': {
                    marginTop: em(12, 16),
        ...
        css: [
            {
                ...
                'ul > li::before': {
                    height: em(5, 14),
                    width: em(5, 14),
                    top: "calc(".concat(em(24 / 2, 14), " - ").concat(em(2.5, 14), ")"),
                    left: em(3, 14),
                },
                '> ul > li p': {
                    marginTop: em(8, 14),
        ...
        css: [
            {
                ...
                'ul > li::before': {
                    width: em(6, 18),
                    height: em(6, 18),
                    top: "calc(".concat(em(32 / 2, 18), " - ").concat(em(3, 18), ")"),
                    left: em(4, 18),
                },
                '> ul > li p': {
                    marginTop: em(16, 18),
        ...
        css: [
            {
                ...
                'ul > li::before': {
                    width: em(7, 20),
                    height: em(7, 20),
                    top: "calc(".concat(em(36 / 2, 20), " - ").concat(em(3.5, 20), ")"),
                    left: em(5, 20),
                },
                '> ul > li p': {
                    marginTop: em(16, 20),
        ...
        css: [
            {
                ...
                'ul > li::before': {
                    width: em(8, 24),
                    height: em(8, 24),
                    top: "calc(".concat(em(40 / 2, 24), " - ").concat(em(4, 24), ")"),
                    left: em(6, 24),
                },
                '> ul > li p': {
                    marginTop: em(20, 24),
...
function configToCss(config) {
    ...
    return __spreadArray(__spreadArray([], Object.keys(config)
        ...
        .map(function (key) { return computed[key](config[key]); }), true), castArray(config.css || {}), true).reduce(function (previous, current) { return combineConfig(previous, current); }, {});
}
var index = createPlugin.withOptions(function (_a) {
    ...
    return function (_a) {
        ...
        var all = uniq(__spreadArray(__spreadArray([
            'DEFAULT'
        ], modifiers, true), Object.keys(pluginConfig).filter(function (modifier) { return !DEFAULT_MODIFIERS.includes(modifier); }), true)).filter(function (i) { return !['RTL', 'DARK'].includes(i); });
        addDynamic(className, function (_a) {
            ...
            if (!all.includes(modifier))
                return;
            return __spreadArray(__spreadArray(__spreadArray([], Style.generate(isDefault ? ".".concat(className) : ".".concat(className, "-").concat(modifier), configToCss(pluginConfig[modifier])), true), (dark && isDefault ? Style.generate(".".concat(className), configToCss(pluginConfig['DARK'])).map(function (i) { return darkMode === 'class' ? i.parent('.dark') : i.atRule('@media (prefers-color-scheme: dark)'); }) : []), true), (rtl ? Style.generate(isDefault ? ".".concat(className, "[dir=\"rtl\"]") : ".".concat(className, "-").concat(modifier, "[dir=\"rtl\"]"), configToCss(pluginConfig['RTL'][modifier])).map(function (i) {
            ...
            order: 149,
            group: 'typography',
            completions: all.map(function (i) { return i === 'DEFAULT' ? className : "".concat(className, "-").concat(i); }),
        });
    };
}, function () { return ({
