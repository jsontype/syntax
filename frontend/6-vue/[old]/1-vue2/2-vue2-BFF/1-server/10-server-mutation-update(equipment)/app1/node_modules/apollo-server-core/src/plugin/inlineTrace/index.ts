...
import { TraceTreeBuilder } from 'apollo-server-core/src/plugin/traceTreeBuilder';
import type { ApolloServerPluginUsageReportingOptions } from 'apollo-server-core/src/plugin/usageReporting/options';
