...
import type { GraphQLServerOptions } from 'apollo-server-core/src/graphqlOptions';
...
import type {
  ...
  DocumentStore,
  PluginDefinition,
} from 'apollo-server-core/src/types';

import { generateSchemaHash } from 'apollo-server-core/src/utils/schemaHash';
import {
  processGraphQLRequest,
  GraphQLRequestContext,
  GraphQLRequest,
  APQ_CACHE_PREFIX,
} from 'apollo-server-core/src/requestPipeline';

import { Headers } from 'apollo-server-env';
import { buildServiceDefinition } from '@apollographql/apollo-tools';
import type { SchemaHash, ApolloConfig } from 'apollo-server-types';
import type { Logger } from '@apollo/utils.logger';
import { cloneObject } from 'apollo-server-core/src/runHttpQuery';
import isNodeLike from 'apollo-server-core/src/utils/isNodeLike';
import { determineApolloConfig } from 'apollo-server-core/src/determineApolloConfig';
import {
...
} from 'apollo-server-core/src/plugin';
import { InternalPluginId, pluginIsInternal } from 'apollo-server-core/src/internalPlugin';
import { newCachePolicy } from 'apollo-server-core/src/cachePolicy';
import { GatewayIsTooOldError, SchemaManager } from 'apollo-server-core/src/utils/schemaManager';
import * as uuid from 'uuid';
import { UnboundedCache } from 'apollo-server-core/src/utils/UnboundedCache';
