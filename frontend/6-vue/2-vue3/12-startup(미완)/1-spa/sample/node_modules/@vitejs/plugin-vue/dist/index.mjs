...
function vuePlugin(rawOptions = {}) {
  ...
  const refTransformFilter = computed(
    () => options.value.reactivityTransform === false ? () => false : options.value.reactivityTransform === true ? createFilter(/\.(j|t)sx?$/, /node_modules/) : createFilter(options.value.reactivityTransform)
  );
  return {
    name: "vite:vue",
    api: {
