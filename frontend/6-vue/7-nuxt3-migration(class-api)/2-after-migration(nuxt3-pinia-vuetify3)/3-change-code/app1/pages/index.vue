  ...
  <v-container>
    <v-row>
      <v-col cols="12">
            ...
            <v-card-title class="align-end">
              <div>
                ...
                <div class="text-h6 text-white opacity-75">
                  vue-facing-decorator + Class API로 구현된 영화 앱
                </div>
              </div>
            </v-card-title>
          </v-img>
          ...
          <v-card-text>
            <v-row>
              <v-col
                ...
                class="text-center"
              >
                <div class="text-h4" :class="`text-${stat.color}`">
                  {{ stat.value }}
                </div>
                <div class="text-body-2 text-medium-emphasis">
                  {{ stat.label }}
        ...
        <v-card class="mt-6" elevation="2">
          <v-card-title>
            <v-icon start color="success">mdi-clock-outline</v-icon>
            최근 활동
          </v-card-title>
          <v-card-text>
