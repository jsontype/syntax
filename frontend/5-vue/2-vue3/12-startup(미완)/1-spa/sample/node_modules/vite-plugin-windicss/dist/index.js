...
function createVirtualModuleLoader(ctx) {
  return {
    ...
    async watchChange(id, change) {
      if (change.event === "delete" || !(0, import_node_fs.existsSync)(id))
        return;
      if (!ctx.utils.isDetectTarget(id))
        return;
      ctx.utils.lock(async () => {
        const content = await import_node_fs.promises.readFile(id, "utf-8");
  ...
  return [
    {
      ...
      async load(id, options) {
        ...
        if (id === DEVTOOLS_PATH) {
          if (!clientCode) {
            clientCode = [
              await import_node_fs2.default.promises.readFile((0, import_node_path.resolve)(_dirname, "client.mjs"), "utf-8"),
...
function VitePluginWindicss(userOptions = {}, utilsOptions = {}) {
  ...
  plugins.push({
    ...
    async handleHotUpdate({ server: server2, file, read }) {
      if ((0, import_node_path2.resolve)(file) === utils.configFilePath) {
