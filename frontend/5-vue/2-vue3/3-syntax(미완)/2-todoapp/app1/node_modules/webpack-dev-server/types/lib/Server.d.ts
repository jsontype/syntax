...
declare class Server {
  static get cli(): {
    ...
    readonly processArguments: (
      args: Record<string, import("webpack-dev-server/types/bin/process-arguments").Argument>,
      config: any,
      values: Record<
        string,
        | string
      ...
      >
    ) => import("webpack-dev-server/types/bin/process-arguments").Problem[] | null;
  };
  static get schema(): {
    title: string;
    type: string;
...
type Schema = import("webpack-dev-server/node_modules/schema-utils/declarations/validate").Schema;
