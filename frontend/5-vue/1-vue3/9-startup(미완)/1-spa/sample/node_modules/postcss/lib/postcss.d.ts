...
import AtRule, { AtRuleProps } from 'postcss/lib/at-rule.js'
import Comment, { CommentProps } from 'postcss/lib/comment.js'
import Container, { ContainerProps } from 'postcss/lib/container.js'
import CssSyntaxError from 'postcss/lib/css-syntax-error.js'
import Declaration, { DeclarationProps } from 'postcss/lib/declaration.js'
import Document, { DocumentProps } from 'postcss/lib/document.js'
import Input, { FilePosition } from 'postcss/lib/input.js'
import LazyResult from 'postcss/lib/lazy-result.js'
import list from 'postcss/lib/list.js'
import Node, {
  AnyNode,
  ChildNode,
  ChildProps,
  ...
  Position,
  Source
} from 'postcss/lib/node.js'
import Processor from 'postcss/lib/processor.js'
import Result, { Message } from 'postcss/lib/result.js'
import Root, { RootProps } from 'postcss/lib/root.js'
import Rule, { RuleProps } from 'postcss/lib/rule.js'
import Warning, { WarningOptions } from 'postcss/lib/warning.js'
