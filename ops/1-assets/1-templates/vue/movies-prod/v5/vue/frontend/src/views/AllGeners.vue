      ...
      <div class="row">
        <div class="col-sm-12 my-4">
          <div class="d-flex align-items-center justify-content-between">
            <h5 class="main-title text-capitalize mb-0">{{ $t('episode_page.geners') }}</h5>
          </div>
        </div>
      </div>
              ...
              <div class="img-box rounded position-relative">
                ...
                <div class="blog-description">
                  <h6 class="mb-0 iq-title">
                    <a href="" class="text-decoration-none text-capitalize line-count-2 p-2">{{ $t('episode_page.action') }}</a>
                  </h6>
                </div>
              </div>
            </div>
