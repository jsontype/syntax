...
src="/assets/images/avatars/avtar_3.png" alt="User-Profile"
          ...
          <ul id="profile-pills-tab" class="d-flex nav nav-pills mb-0 text-center profile-tab" data-toggle="slider-tab" role="tablist">
            <li class="nav-item">
    ...
    <b-col lg="6">
      <div class="profile-content tab-content iq-tab-fade-up">
        ...
        <div id="profile-profile" class="tab-pane fade">
          <profile-widget
name="Austin Robertson" date="Feb 15, 2021" location="United States of America"
            email="austin@gmail.com" url="www.bootstrap.com" number="(001) 4544 565 456" />
        </div>
      </div>
...
export default {
  ...
  setup() {
    ...
    const gallery = [
      ...
      {
        image: 'assets/images/shapes/02.png',
      },
      {
        image: 'assets/images/icon/08.png',
      },
      {
        image: 'assets/images/shapes/04.png',
      },
      {
        image: 'assets/images/shapes/03.png',
      },
      {
        image: 'assets/images/shapes/06.png',
      },
      {
        image: 'assets/images/shapes/05.png',
      },
      {
        image: 'assets/images/shapes/04.png',
      },
