  ...
  <b-row>
    <b-col lg="12">
      <b-card>
        ...
        <b-row class="mt-4">
          ...
          <b-col lg="2" md="6" class="text-center mt-0 mt-lg-3">
          ...
          <!-- <b-col lg="2" md="6" class="text-center mt-4">
              <p class="bg-gray pt-5 pb-5 text-center rounded"></p>
              <h6>Gray</h6>
            </b-col> -->
        </b-row>
      </b-card>
      <b-card>
        ...
        <b-row class="mt-4">
          ...
          <!-- <b-col lg="2" md="6" class="text-center mt-4">
              <p class="bg-gray-subtle pt-5 pb-5 text-center rounded font-size-18">Gray</p>
            </b-col> -->
        </b-row>
      </b-card>
    </b-col>
    <b-col lg="6">
      <b-card>
        ...
        <p>
          Contextual text classes also work well on anchors with the provided hover and focus states. <strong>Note that the <code>.text-white</code> and <code>.text-muted</code> class has no additional link styling beyond underline.</strong>
        </p>
    ...
    <div class="col-lg-6">
      <b-card>
        ...
        <!-- <p class="bg-gray-subtle ps-3 pe-3 pt-2 pb-2 rounded mb-0">Gray link</p> -->
      </b-card>
    </div>
    <b-col lg="6">
      <b-card>
        ...
        <p class=""><a href="#" class="bg-dark-subtle text-dark ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Dark link</a></p>
        <!-- <p class="mb-0"><a href="#" class="bg-gray-subtle ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Gray link</a></p> -->
      </b-card>
    </b-col>
  </b-row>
</template>
