<template>
  <Swiper
    ...
    class="iq-main-slider p-0 banner-home-swiper overflow-hidden mb-0"
    :modules="modules"
    :loop="true"
  >
        ...
        <div class="slider-inner h-100">
          <div class="row align-items-center iq-ltr-direction h-100">
            <div class="col-lg-7 col-md-12">
              ...
              <div
                class="d-flex flex-wrap align-items-center r-mb-23 RightAnimate-two"
              >
                ...
                <span
                  class="badge rounded-0 text-white text-uppercase p-2 mx-3 bg-secondary"
                  >{{ $t("home.action") }}</span
                >
                <span class="font-size-14 fw-500 time"
                  >2 {{ $t("countdown.hours") }} : 6
              ...
              <div class="RightAnimate-four">
                <CustomButton
                  :button-title="$t('ott_home.play_now')"
                  :link="{ name: 'movies-detail' }"
                ></CustomButton>
              </div>
            </div>
            <div
              class="col-lg-5 col-md-12 trailor-video iq-slider d-none d-lg-block"
            >
    ...
    <div
      ...
      class="swiper-banner-button-prev swiper-nav"
    >
      <i></i>
      <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    <div
      ...
      class="swiper-banner-button-next swiper-nav"
    >
      <i></i>
      <svg
        xmlns="http://www.w3.org/2000/svg"
