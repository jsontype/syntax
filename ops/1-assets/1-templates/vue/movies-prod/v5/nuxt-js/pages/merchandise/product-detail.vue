<template>
  <div class="section-padding-top product-detail">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="product-tab-slider">
            <swiper
              v-if="render"
              class="product-tab-slider-thumb"
              :dir="rtl"
              :modules="modules"
              :slide-per-view="1"
              :loop="true"
            ...
            >
              ...
              <swiper-slide>
                <img
                  src="/assets/images/shop/product/02.webp"
                  class="img-fluid product-detail-image"
                  @click="toggler = !toggler"
                />
              </swiper-slide>
              <swiper-slide>
                <img
                  src="/assets/images/shop/product/03.webp"
                  class="img-fluid product-detail-image"
                  @click="toggler = !toggler"
                />
              </swiper-slide>
              <swiper-slide>
                <img
                  src="/assets/images/shop/product/04.webp"
                  class="img-fluid product-detail-image"
                  @click="toggler = !toggler"
                />
              </swiper-slide>
          ...
          <div class="product-tab-slider-images">
            <swiper
              v-if="render"
              class="product-tab-slider-thumb"
              :dir="rtl"
        ...
        <div class="col-lg-6 mt-lg-0 mt-5 ps-lg-5">
          ...
          <p class="mt-4 mb-0">{{ $t("shop.there_are_many_variations") }}</p>
          <div class="add-product-wrapper mt-5 pb-5">
            <ul
              class="list-inline m-0 p-0 d-flex align-items-center gap-3 flex-wrap"
            >
              <li>
                <div
              ...
              <li class="wish-list">
                <nuxt-link
                  href="#"
                  class="d-inline-block bg-soft-primary border border-white wishlist-btn"
                  @click="wishlistSwal"
                >
              ...
              <li>
                <div class="iq-button">
                  <nuxt-link
                    href="#"
                    class="btn btn-sm cart-btn text-uppercase position-relative"
                    @click="cartSwal"
                  >
            ...
            <ul class="list-inline m-0 p-0">
              <li class="mb-2">
                <span class="text-white fw-semibold"
                  >{{ $t("shop.sku") }} :</span
                >
                <h6 class="d-inline">{{ $t("shop.bag_pack") }}</h6>
              </li>
              <li class="mb-2">
                <span class="text-white fw-semibold"
                  >{{ $t("form.categories") }} :</span
                >
      ...
      <div class="section-padding-top px-0">
        <div class="product-detail-tabs">
          <ul
            id="product-tab"
            class="list-inline nav nav-pills justify-content-center iq-custom-tab tab-bg-gredient-center flex-md-row flex-column gap-md-5 gap-3 mb-5"
            role="tablist"
          >
            ...
            <li class="nav-item" role="presentation">
              <nuxt-link
                ...
                aria-selected="false"
                tabindex="-1"
                >{{ $t("shop.addtional_information") }}</nuxt-link
              >
            </li>
            <li class="nav-item" role="presentation">
              <nuxt-link
          ...
          <div id="product-tab-content" class="tab-content">
            <div
              ...
              role="tabpanel"
            >
              <p class="m-0">{{ $t("shop.there_are_many_variations") }}</p>
            </div>
            <div
            ...
            >
              <div class="table-responsive additional-info-table">
                <table class="table table-border">
                  <tbody>
                    <tr class="text-body">
                      <th class="text-white">{{ $t("shop.color") }}</th>
                      <td>{{ $t("shop.blue_green_red") }}</td>
                    </tr>
                    <tr class="text-body">
                      <th class="text-white">{{ $t("shop.size") }}</th>
                      <td>L, M, S</td>
                    </tr>
                    <tr class="text-body">
                      <th class="text-white">{{ $t("shop.weight") }}</th>
                      <td>50ml, 100ml</td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div id="reviews" class="tab-pane fade" role="tabpanel">
              <h4 class="mb-4">{{ $t("shop.reviews_believe_mask") }}</h4>
                ...
                <ul class="list-inline m-0 p-0">
                    ...
                    >
                      ...
                      <div class="about-user">
                        <div class="d-flex align-items-center flex-wrap gap-2">
                          <h5 class="mb-0">{{ $t("shop.jack_stark") }}</h5>
                          <span
                            class="text-uppercase fst-italic fw-semibold published-date"
                          >
                        ...
                        <p class="mt-2 mb-0">
                          {{ $t("shop.there_are_many_variations") }}
                        </p>
                      </div>
                    </div>
                  </li>
                  <li class="mb-5">
                    ...
                    >
                      ...
                      <div class="about-user">
                        <div class="d-flex align-items-center flex-wrap gap-2">
                          <h5 class="mb-0">{{ $t("shop.jhon_deo") }}</h5>
                          <span
                            class="text-uppercase fst-italic fw-semibold published-date"
                          >
                            <i class="fas fa-minus fa-xs"></i> march 2,
                          ...
                          <div class="lh-1 ratting">
                            ...
                            <span>
                              <i
                                class="fa fa-star-half text-warning"
                                aria-hidden="true"
                              ></i>
                            </span>
                          </div>
              ...
              <div class="mt-5 review-form">
                ...
                <p class="mb-5">{{ $t("shop.email_address_will_not") }} *</p>
                <p class="mb-2">{{ $t("shop.your_rating") }} *</p>
                <form class="needs-validation" novalidate="">
                  ...
                  <div class="mb-5">
                    <label class="form-label">{{ $t("shop.name") }}*</label>
                    <input
                      type="text"
                      class="form-control rounded-0"
                      required=""
                  ...
                  <div class="mb-5">
                    <label class="form-label">{{ $t("shop.email") }}*</label>
                    <input
                      type="email"
                      class="form-control rounded-0"
                      required=""
                  ...
                  <div class="iq-button">
                    ...
                    >
                      <span class="button-text">{{ $t("shop.submit") }} </span>
                      <i class="fa-solid fa-play"></i>
                    </nuxt-link>
                  </div>
                </form>
    ...
    <div class="related-product-block section-padding-top">
      <ProductSection title="merchandise.related_products"></ProductSection>
    </div>
  </div>
  <FsLightbox
    :toggler="toggler"
    :sources="[
      ...
      '/assets/images/shop/product/03.webp',
