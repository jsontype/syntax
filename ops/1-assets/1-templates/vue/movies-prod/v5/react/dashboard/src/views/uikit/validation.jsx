          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/validation"
                  target="_blank"
                >
                  <svg
                    width="20"
        ...
        <Card className=" iq-document-card">
          <Tab.Container defaultActiveKey="first">
            ...
            <Tab.Content>
              ...
              >
                <div className="bd-example">
                  <Form as={Row} className=" g-3">
                    ...
                    <Col md="4">
                      <Form.Label htmlFor="validationServer02">
                        Last name
                      </Form.Label>
                      <Form.Control
                        type="text"
                    ...
                    <Col md="3">
                      <Form.Label htmlFor="validationServer04">
                        State
                      </Form.Label>
                      <Form.Select
                        className=" is-invalid"
              ...
              <Tab.Pane
                eventKey="second"
                className="tab-pane bd-heading-1 fade show"
