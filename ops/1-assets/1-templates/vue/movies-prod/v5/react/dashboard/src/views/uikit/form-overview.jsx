...
// React-bootstrap
import { Nav, Tab, Form, FormCheck, Container } from "react-bootstrap";
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Link
                  className="d-flex disabled btn p-0"
                  to="#"
                  target="_blank"
                >
                  <svg
              ...
              >
                <div className="bd-example">
                  <form>
                    ...
                    <div className="mb-3">
                      <Form.Label htmlFor="exampleInputPassword1" className="">
                        Password
                      </Form.Label>
                      <Form.Control
                        type="password"
                    ...
                    <div className="mb-3">
                      <Form.Label htmlFor="customRange3" className="form-label">
                        Example range
                      </Form.Label>
                      <Form.Range />
                    </div>
