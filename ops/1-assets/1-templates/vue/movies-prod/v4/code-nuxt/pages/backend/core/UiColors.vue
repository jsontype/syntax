        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-1" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre :id="`${appName}-color1`" class="text-white">
                    <code>
  ...
  &lt;h6&gt;Dark&lt;/h6&gt;
            ...
            <b-row class="mt-4">
              <b-col lg="2" md="6" class="text-center">
                <p class="bg-primary pt-5 pb-5 text-center rounded" />
                <h6>Primary</h6>
              </b-col>
              <b-col lg="2" md="6" class="text-center">
                <p class="bg-secondary pt-5 pb-5 text-center rounded" />
                <h6>Secondary</h6>
              </b-col>
              <b-col lg="2" md="6" class="text-center">
                <p class="bg-success pt-5 pb-5 text-center rounded" />
                <h6>Success</h6>
              </b-col>
              <b-col lg="2" md="6" class="text-center">
                <p class="bg-danger pt-5 pb-5 text-center rounded" />
                <h6>Danger</h6>
              </b-col>
              <b-col lg="2" md="6" class="text-center">
                <p class="bg-warning pt-5 pb-5 text-center rounded" />
                <h6>Warning</h6>
              </b-col>
              <b-col lg="2" md="6" class="text-center">
                <p class="bg-info pt-5 pb-5 text-center rounded" />
                <h6>Info</h6>
              </b-col>
              <b-col lg="2" md="6" class="text-center mt-4">
                <p class="bg-light pt-5 pb-5 text-center rounded" />
                <h6>Light</h6>
              </b-col>
              <b-col lg="2" md="6" class="text-center mt-4">
                <p class="bg-dark pt-5 pb-5 text-center rounded" />
                <h6>Dark</h6>
              </b-col>
            </b-row>
          </template>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-2" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre :id="`${appName}-color2`" class="text-white">
                    <code>
...
&lt;p class="iq-bg-dark pt-5 pb-5 text-center rounded font-size-18"&gt;Dark&lt;/p&gt;
            ...
            <b-row class="mt-4">
              <b-col lg="2" md="6" class="text-center">
                <p class="iq-bg-primary pt-5 pb-5 text-center rounded font-size-18">
                  Primary
                </p>
              </b-col>
              <b-col lg="2" md="6" class="text-center">
                <p class="iq-bg-secondary pt-5 pb-5 text-center rounded font-size-18">
                  Secondary
                </p>
              </b-col>
              <b-col lg="2" md="6" class="text-center">
                <p class="iq-bg-success pt-5 pb-5 text-center rounded font-size-18">
                  Success
                </p>
              </b-col>
              <b-col lg="2" md="6" class="text-center">
                <p class="iq-bg-danger pt-5 pb-5 text-center rounded font-size-18">
                  Danger
                </p>
              </b-col>
              <b-col lg="2" md="6" class="text-center">
                <p class="iq-bg-warning pt-5 pb-5 text-center rounded font-size-18">
                  Warning
                </p>
              </b-col>
              <b-col lg="2" md="6" class="text-center">
                <p class="iq-bg-info pt-5 pb-5 text-center rounded font-size-18">
                  Info
                </p>
              </b-col>
              <b-col lg="2" md="6" class="text-center mt-4">
                <p class="iq-bg-dark pt-5 pb-5 text-center rounded font-size-18">
                  Dark
                </p>
              </b-col>
            </b-row>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-3" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre :id="`${appName}-text-color1`" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-4" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre :id="`${appName}-text-color2`" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-5" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre :id="`${appName}-text-color3`" class="text-white">
                    <code>
...
&lt;p class="iq-bg-dark pl-3 pr-3 pt-2 pb-2 rounded mb-0"&gt;Dark link&lt;/p&gt;
            ...
            <p class="iq-bg-primary pl-3 pr-3 pt-2 pb-2 rounded">
              Primary link
            </p>
            <p class="iq-bg-secondary pl-3 pr-3 pt-2 pb-2 rounded">
              Secondary link
            </p>
            <p class="iq-bg-success pl-3 pr-3 pt-2 pb-2 rounded">
              Success link
            </p>
            <p class="iq-bg-danger pl-3 pr-3 pt-2 pb-2 rounded">
              Danger link
            </p>
            <p class="iq-bg-warning pl-3 pr-3 pt-2 pb-2 rounded">
              Warning link
            </p>
            <p class="iq-bg-info pl-3 pr-3 pt-2 pb-2 rounded">
              Info link
            </p>
            <p class="iq-bg-dark pl-3 pr-3 pt-2 pb-2 rounded mb-0">
              Dark link
            </p>
          </template>
        </iq-card>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-6" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre :id="`${appName}-text-color4`" class="text-white">
                    <code>
...
&lt;p class="mb-0"&gt;&lt;a href="#" class="iq-bg-dark pl-3 pr-3 pt-2 pb-2 rounded d-inline-block"&gt;Dark link&lt;/a&gt;&lt;/p&gt;
            ...
            <p><a href="#" class="iq-bg-info pl-3 pr-3 pt-2 pb-2 rounded d-inline-block">Info link</a></p>
            <p class="mb-0">
              <a href="#" class="iq-bg-dark pl-3 pr-3 pt-2 pb-2 rounded d-inline-block">Dark link</a>
            </p>
          </template>
        </iq-card>
      </b-col>
