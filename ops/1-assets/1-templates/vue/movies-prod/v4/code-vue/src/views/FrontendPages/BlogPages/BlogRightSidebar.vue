...
<div class="col-lg-4 col-sm-12">
    <div class="widget-area" aria-label="Blog Sidebar">
                ...
                <ul class="iq-post">
                    <li>
                        ...
                        <div class="post-img-holder">
                            <a href="#" :style= "`background: url(${require('@/assets/images/blog/blog1.jpeg')}); `"></a>
                        </div>
                        <div class="post-blog">
                            <div class="blog-box">
                    ...
                    <li>
                        <div class="post-img">
                        <div class="post-img-holder">
                            <a href="#" :style= "`background: url(${require('@/assets/images/blog/blog2.jpeg')}); `"></a>
                        </div>
                        <div class="post-blog">
                            <div class="blog-box">
                                <ul class="list-inline">
                    ...
                    <li>
                        <div class="post-img">
                        <div class="post-img-holder">
                            <a href="#" :style= "`background: url(${require('@/assets/images/blog/blog3.jpeg')}); `" ></a>
                        </div>
                        <div class="post-blog">
                            <div class="blog-box">
                                <ul class="list-inline">
