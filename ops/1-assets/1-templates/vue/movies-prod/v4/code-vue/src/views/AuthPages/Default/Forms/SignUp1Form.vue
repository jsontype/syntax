<template>
  <form class="" action="index.html">
          <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control mb-0" id="exampleInputEmail3" placeholder="First Name" autocomplete="off" required>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail4">Last Name</label>
                    <input type="text" class="form-control mb-0" id="exampleInputEmail4" placeholder="Last Name" autocomplete="off" required>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputPassword3">Repeat Password</label>
                    <input type="password" class="form-control mb-0" id="exampleInputPassword3" placeholder="Password" required>
                </div>
              </div>
          ...
          <button type="submit" class="btn btn1 my-2">Sign Up</button>
