<template>
      ...
      <Slick id="tvshows-slider" class="iq-rtl-direction" :option="sliderOption">
...
export default {
  ...
  data () {
    return {
      sliderData: [
        { image: require('../../../assets/images/frontend/movie-banner/1.jpg'), title: 'Open Dead Shot', age: '13+', series: '2h 20m ' },
        { image: require('../../../assets/images/frontend/movie-banner/2.jpg'), title: 'Jumbo Queen', age: '9+', series: '2h 40m' },
        { image: require('../../../assets/images/frontend/movie-banner/3.jpg'), title: 'The Lost Journey', age: '20+', series: '2h 15m' }
      ],
      sliderOption: {
        centerMode: true,
        centerPadding: '200px',
