      ...
      <div class="slider">
        <div class="slider-flex position-relative">
          <div class="slider--col position-relative">
            <div class="vertical-slider-prev swiper-button">
            ...
            <div class="slider-thumbs" data-swiper="slider-thumbs">
              <div class="swiper-container" data-swiper="slider-thumbs-inner">
                ...
                >
                  <SwiperSlide
                    v-for="data in thumbsSwiperCard"
                    :key="data.title"
                    tag="li"
                    class="swiper-slide swiper-bg"
                  >
            ...
            <div class="vertical-slider-next swiper-button">
                    ...
                    <div class="block-description">
                      ...
                      >
                        ...
                        >
                          <nuxt-link
                            to=""
                            class="text-white text-decoration-none"
                            >{{ $t(data.geners2) }}</nuxt-link
                          >
                        </li>
                      </ul>
                      <h2 class="iq-title mb-3">
                        <nuxt-link to="">{{ $t(data.title) }}</nuxt-link>
                      </h2>
                      <div class="d-flex align-items-center gap-3 mb-3">
                        <div class="slider-ratting d-flex align-items-center">
                          ...
                          <span class="text-white ms-2 font-size-14 fw-500">{{
                            data.rating
                          }}</span>
                        </div>
                        <span class="text-body">{{ data.time }}</span>
