        ...
        <b-col lg="8" sm="12">
          <div class="blog-box">
            <img
              ...
              class="img-fluid mb-4 pb-3 rounded"
            />
            <div class="d-flex align-items-center justify-content-between mb-3">
              <ul class="iq-blog-category-2 m-0 p-0 list-unstyled">
                <li>
                  <nuxt-link :to="{ name: 'blogs-template' }" class="fw-500">{{
                    $t(blog.categories)
                  }}</nuxt-link>
                </li>
              </ul>
              <div class="d-flex align-items-center gap-2">
                <span class="font-size-12">5 {{ $t("blogs.min_read") }}</span>
                <div>
                  <svg
                    width="16"
                    height="16"
                  ...
                  <span class="font-size-12">{{ $t("blogs.comments") }}</span>
                </div>
              </div>
            </div>
            <h3 class="fw-500">{{ $t(blog.title) }}</h3>
            <div
              class="iq-author-details d-flex align-items-center justify-content-between gap-2"
            >
              <div class="iq-author-image d-flex align-items-center gap-2">
                ...
                <div class="gap-1 d-flex align-items-center font-size-14">
                  By
                  <span
                    ><nuxt-link to="" class="fw-500 text-capitalize">{{
                      $t(blog.username)
                    }}</nuxt-link></span
                  >
                </div>
              ...
              <div class="iq-published-date">
                ...
                >
                  <path
                    d="M2.19336 5.59936H11.8109"
                    stroke="#E50914"
                    strokeWidth="1.5"
                    strokeLinecap="square"
                  ></path>
                  <path
                    d="M9.39685 7.70678H9.40185"
                    stroke="#E50914"
                    strokeWidth="1.5"
                    strokeLinecap="square"
                  ></path>
                  <path
                    d="M7.00232 7.70678H7.00732"
                    stroke="#E50914"
                    strokeWidth="1.5"
                    strokeLinecap="square"
                  ></path>
                  <path
                    d="M4.60291 7.70678H4.6079"
                    stroke="#E50914"
                    strokeWidth="1.5"
                    strokeLinecap="square"
                  ></path>
                  <path
                    d="M9.39685 9.80371H9.40185"
                    stroke="#E50914"
                    strokeWidth="1.5"
                    strokeLinecap="square"
                  ></path>
                  <path
                    d="M7.00232 9.80371H7.00732"
                    stroke="#E50914"
                    strokeWidth="1.5"
                    strokeLinecap="square"
                  ></path>
                  <path
                    d="M4.60291 9.80371H4.6079"
                    stroke="#E50914"
                    strokeWidth="1.5"
                    strokeLinecap="square"
                  ></path>
                  <path
                    d="M9.18255 1.60425V3.37991"
                    stroke="#E50914"
                    strokeWidth="1.5"
                    strokeLinecap="square"
                  ></path>
                  <path
                    d="M4.82318 1.60425V3.37991"
                    stroke="#E50914"
                    strokeWidth="1.5"
                    strokeLinecap="square"
                  ></path>
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M11.8571 2.4563H2.14453V12.3959H11.8571V2.4563Z"
                    stroke="#E50914"
                    strokeWidth="1.5"
                    strokeLinecap="square"
                  ></path>
                ...
                <span class="font-size-14 text-uppercase">
                  <nuxt-link to="#">{{ blog.blogDate }}</nuxt-link>
                </span>
              </div>
            </div>
          </div>
          ...
          <div class="iq-blog-tag">
            <ul class="p-0 m-0 list-unstyled gap-2 widget_tags">
              <li>
                ...
                <span class="font-size-12 fw-semibold">{{
                  $t("header.tags")
                }}</span>
              </li>
              <li>
                <nuxt-link to="" class="text-capitalize">{{
                  blog.item
                }}</nuxt-link>
              </li>
            </ul>
          ...
          <div class="widget my-5 my-md-0">
            <div
              class="iq-author-meta-details d-flex align-items-start align-items-md-center gap-4 flex-b-column flex-md-row"
            >
              ...
              <div>
                <h5>{{ $t(blog.username) }}</h5>
                <ul class="p-0 m-0 list-unstyled widget_social_media mt-4">
                  <li>
                    <nuxt-link to=""><i class="fab fa-facebook"></i></nuxt-link>
                  </li>
                  <li>
                    <nuxt-link to=""
                  ...
                  <li>
                    <nuxt-link to=""><i class="fab fa-dribbble"></i></nuxt-link>
                  </li>
                </ul>
              </div>
            </div>
...
import FormWidget from "../../components/blog/comments/FormWidget.vue";
...
const blog = blogs.find(
  (item) => item.slug === "everything-you-need-to-know-about"
);
</script>
