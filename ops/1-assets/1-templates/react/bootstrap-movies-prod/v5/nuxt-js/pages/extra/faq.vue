        ...
        <b-col :lg="12" :sm="12">
          <div class="iq-accordian iq-accordian-square">
            <div
              ...
              :key="index + 'ac' + item.title"
              :class="`iq-accordian-block ${index} ${
                isOpen[index] ? 'iq-active' : ''
              }`"
            >
              <div
                class="iq-accordian-title text-capitalize"
              ...
              >
                ...
                <h4 class="mb-0 accordian-title text-capitalize">
                  {{ $t(item.title) }}
                </h4>
              </div>
