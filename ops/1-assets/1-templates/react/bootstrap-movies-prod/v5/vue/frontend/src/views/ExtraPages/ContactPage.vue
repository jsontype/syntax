      ...
      <b-row>
        <b-col lg="8">
          <div class="title-box">
            ...
            <p class="mb-0">{{ $t('contact_us.learn_more') }}</p>
          </div>
          <form class="mb-5 mb-lg-0">
            <b-row>
              <b-col md="6" class="mb-4 mb-lg-5">
                <input type="text" class="form-control font-size-14" :placeholder="$t('form.first_name*')" required="" />
              </b-col>
              <b-col md="6" class="mb-4 mb-lg-5">
                <input type="text" class="form-control font-size-14" :placeholder="$t('form.last_name*')" required="" />
              </b-col>
              <b-col md="6" class="mb-4 mb-lg-5">
                <input type="tel" class="form-control font-size-14" maxlength="140" minlength="10" :placeholder="$t('form.phone')" required="" />
              </b-col>
              <b-col md="6" class="mb-4 mb-lg-5">
                <input type="email" class="form-control font-size-14" :placeholder="$t('form.email')" required="" />
              </b-col>
              <b-col md="12" class="mb-4 mb-lg-5">
                <textarea class="form-control font-size-14" cols="40" rows="10" :placeholder="$t('form.message')"></textarea>
              </b-col>
              <b-col>
                <div class="iq-button">
                  <button type="submit" class="btn">{{ $t('contact_us.send_message') }}</button>
                </div>
              </b-col>
            </b-row>
          </form>
        ...
        <b-col lg="3">
          <div class="border-bottom pb-4 mb-4">
            ...
            <span>{{ $t('contact_us.townhouse_consoling') }}</span>
          </div>
          <div class="border-bottom pb-4 mb-4">
  ...
  <div class="section-padding">
    <div class="container">
      <div class="row">
        <div class="col-lg-10">
          <div class="title-box">
            <h3 class="fw-500">{{ $t('contact_us.take_challenge') }}</h3>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="contact-box d-flex gap-3 rounded mb-3 mb-lg-0">
            ...
            <div style="z-index: 1">
              <h6 class="font-size-18 fw-500 mb-4">{{ $t('contact_us.general_enquiries') }}</h6>
              <p class="mb-1 font-size-14">{{ $t('contact_us.call_on') }} <span class="text-primary">(144) 1234 4567</span></p>
              <p class="mb-0">{{ $t('contact_us.mail') }} <a href="mailto:info@medyapim.com" class="text-white fw-500">info@enquiries.com</a></p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="contact-box d-flex gap-3 rounded mb-3 mb-lg-0">
            ...
            <div style="z-index: 1">
              <h6 class="font-size-18 fw-500 mb-4">{{ $t('contact_us.user_support') }}</h6>
              <p class="mb-1 font-size-14">{{ $t('contact_us.call_on') }} <span class="text-primary">(144) 4321 4567</span></p>
              <p class="mb-0">{{ $t('contact_us.mail') }} <a href="mailto:info@medyapim.com" class="text-white fw-500">support@enquiries.com</a></p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="contact-box d-flex gap-3 rounded">
            ...
            <div style="z-index: 1">
              <h6 class="font-size-18 fw-500 mb-4">{{ $t('contact_us.sales_support') }}</h6>
              <p class="mb-1 font-size-14">{{ $t('contact_us.call_on') }} <span class="text-primary">(144) 1234 1234</span></p>
              <p class="mb-0">{{ $t('contact_us.mail') }} <a href="mailto:info@medyapim.com" class="text-white fw-500">user@enquiries.com</a></p>
            </div>
          </div>
        </div>
      </div>
