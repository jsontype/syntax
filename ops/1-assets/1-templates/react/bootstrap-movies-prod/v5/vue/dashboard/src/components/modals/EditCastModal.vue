<template>
  <div>
    <b-button variant="primary" @click="editcastModal = true"><i class="fa-solid fa-square-plus me-2"></i>{{ $t('castmodal.edit_castCrew') }}</b-button>
    <b-modal v-model="editcastModal" :title="$t('castmodal.edit_cast')" :ok-title="$t('castmodal.save')" :cancel-title="$t('castmodal.close')" @ok="formSubmit">
      <b-form class="section-form">
        <b-row>
          <b-col sm="12">
            <InputField :model-value="$t('edit.austin_robertson')" name="person" :label="$t('castmodal.person')" type="text" :placeholder="$t('castmodal.enter_name')"></InputField>
          </b-col>
          <b-col sm="12">
          ...
          <b-col sm="12">
            <InputField model-value="XYZ" :label="$t('castmodal.as')" type="text" :placeholder="$t('castmodal.played_as')"></InputField>
          </b-col>
          <b-col sm="12">
