...
stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <div>
                <span>{{ $t('widgetchart.net_worth') }}</span>
              </div>
            </div>
            <div class="text-center">
              <h2>
                <Vue3autocounter ref="counter" :start-amount="0" :end-amount="65" />M
              </h2>
              <div>
                <span class="text-success">
                  <svg
xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 20 20"
                    fill="currentColor">
                    <path
fill-rule="evenodd"
...
fill-rule="evenodd"
          ...
          <apexchart height="80" type="area" :series="chart2.series" :options="chart2.options" />
        </b-card>
      </b-col>
      <b-col lg="3">
        <b-card no-body>
...
stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="text-center">
              <h2>
                <Vue3autocounter
ref="counter" :start-amount="0" :end-amount="96.6" duration="3" decimal-separator="."
                  :decimals="1" />K
              </h2>
              <div>
                <span>
...
fill-rule="evenodd"
          ...
          <apexchart height="80" type="area" :series="chart3.series" :options="chart3.options" />
        </b-card>
      </b-col>
      <b-col lg="3">
        <b-card no-body>
          <b-card-body>
            <div class="d-flex justify-content-between">
              <div class="rounded p-3 bg-danger-subtle">
                <svg
xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path
stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <div>
                <span>{{ $t('widgetchart.orders_received') }}</span>
              </div>
            </div>
            <div class="text-center">
              <h2>
                <Vue3autocounter
ref="counter" :start-amount="0" :end-amount="15.5" duration="3" decimal-separator="."
                  :decimals="1" />K
              </h2>
              <div>
                <span class="text-danger">
                  <svg
xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" viewBox="0 0 20 20"
                    fill="currentColor">
                    <path
fill-rule="evenodd"
          ...
          <apexchart height="80" type="area" :series="chart4.series" :options="chart4.options" />
        </b-card>
      </b-col>
    </b-row>
    <b-row>
...
fill="currentColor"
          ...
          <div class="d-flex justify-content-between align-items-center">
            <h6>
              <b>$
                <Vue3autocounter ref="counter" :start-amount="0" :end-amount="18378" />
              </b>
            </h6>
            <div id="iq-chart-box1">
              <apexchart height="70" width="100" type="area" :series="box1.series" :options="box1.options" />
            </div>
...
fill="currentColor"
          ...
          <div class="d-flex justify-content-between align-items-center">
            <h6>
              <b>$
                <Vue3autocounter ref="counter" :start-amount="0" :end-amount="190" />
              </b>
            </h6>
            <div id="iq-chart-box2">
              <apexchart height="70" width="100" type="area" :series="box2.series" :options="box2.options" />
            </div>
...
fill="currentColor"
            ...
            <div>
              <span>{{ $t('widgetchart.total_classon') }}</span>
            </div>
          </div>
          <div class="d-flex justify-content-between align-items-center">
            <h6>
            ...
            <div id="iq-chart-box3">
              <apexchart height="70" width="100" type="area" :series="box3.series" :options="box3.options" />
            </div>
      ...
      <b-col lg="3">
        <b-card>
          <div class="d-flex justify-content-between">
            <div class="rounded p-3 bg-danger-subtle">
              <svg
xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path
stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div id="iq-chart-box4">
              <apexchart height="70" width="100" type="area" :series="box4.series" :options="box4.options" />
            </div>
...
fill-rule="evenodd"
          ...
          <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
              <div class="border rounded p-3 bg-primary-subtle me-3">
...
fill="currentColor"
              ...
              <h2>
                <Vue3autocounter ref="counter" :start-amount="0" :end-amount="352" />
              </h2>
            </div>
            <div class="pt-3">
...
fill="currentColor"
              ...
              <h2>$
                <Vue3autocounter ref="counter" :start-amount="0" :end-amount="37" />K
              </h2>
            </div>
            <div class="pt-3">
...
fill-rule="evenodd"
          ...
          <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
              <div class="border rounded p-3 bg-success-subtle me-3">
                <svg width="24px" height="24px" viewBox="0 0 24 24">
                  <path
fill="currentColor"
              ...
              <h2>
                <Vue3autocounter ref="counter" :start-amount="0" :end-amount="32" />%
              </h2>
            </div>
            <div class="pt-3">
...
fill="currentColor"
    ...
    <b-row>
      <b-col class="col-sm-6 col-lg-6 col-xl-3">
        <b-card body-class="iq-box-relative">
          <div class="iq-service d-flex align-items-center justify-content-between" style="position: relative">
            <div class="service-data">
              <h3>
                <Vue3autocounter ref="counter" :start-amount="0" :end-amount="24" />%
              </h3>
              <p class="mb-0">{{ $t('widgetchart.service_used') }}</p>
            </div>
            <apexchart height="65" width="140" type="area" :series="service1.series" :options="service1.options" />
          </div>
        </b-card>
      </b-col>
      <b-col class="col-sm-6 col-lg-6 col-xl-3">
        <b-card body-class="iq-box-relative">
          <div class="iq-service d-flex align-items-center justify-content-between" style="position: relative">
            <div class="service-data">
              <h3>2.5</h3>
              <p class="mb-0">{{ $t('widgetchart.gb_stored') }}</p>
            </div>
            <apexchart height="65" width="140" type="area" :series="service2.series" :options="service2.options" />
          </div>
        </b-card>
      </b-col>
      <b-col class="col-sm-6 col-lg-6 col-xl-3">
        <b-card body-class="iq-box-relative">
          <div class="iq-service d-flex align-items-center justify-content-between" style="position: relative">
            <div class="service-data">
              <h3>351</h3>
              <p class="mb-0">{{ $t('widgetchart.user_collect') }}</p>
            </div>
            <apexchart height="65" width="140" type="area" :series="service3.series" :options="service3.options" />
          </div>
        </b-card>
      </b-col>
      <b-col class="col-sm-6 col-lg-6 col-xl-3">
        <b-card body-class="iq-box-relative">
          <div class="iq-service d-flex align-items-center justify-content-between" style="position: relative">
            <div class="service-data">
              <h3>4,852</h3>
              <p class="mb-0">{{ $t('widgetchart.visitors') }}</p>
            </div>
            <apexchart height="65" width="140" type="area" :series="service4.series" :options="service4.options" />
          </div>
        </b-card>
      </b-col>
      <b-col class="col-lg-12 row m-0 p-0 iq-duration-block">
        <b-col class="col-sm-6 col-md-6 col-lg-2">
          <b-card>
...
fill="currentColor"
            ...
            <apexchart height="80" type="area" :series="ethernet1.series" :options="ethernet1.options" />
          </b-card>
        </b-col>
...
fill="currentColor"
            ...
            <apexchart height="80" type="area" :series="ethernet2.series" :options="ethernet2.options" />
          </b-card>
        </b-col>
        <b-col sm="6" md="6" lg="2">
          <b-card>
...
fill="currentColor"
            ...
            <apexchart height="80" type="area" :series="ethernet3.series" :options="ethernet3.options" />
          </b-card>
        </b-col>
        <b-col sm="6" md="6" lg="2">
          <div class="card">
...
fill="currentColor"
              ...
              <apexchart height="80" type="area" :series="ethernet4.series" :options="ethernet4.options" />
            </div>
          </div>
        </b-col>
        <div class="col-md-12 col-lg-4">
          <div class="card">
            <div class="card-body">
              <h4 class="text-uppercase mb-0">{{ $t('widgetchart.session') }}</h4>
              <div class="d-flex justify-content-between align-items-center mt-2">
                <h2 class=" ">12</h2>
                <div class="text-left">
                  <p class="m-0 text-uppercase">{{ $t('widgetchart.hours') }}</p>
                  <div class="mb-1">
                    1500
                    <span class="text-danger">
                      <svg
class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
d="M12.2744 19.75V4.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round"></path>
                        <path
d="M18.299 13.7002L12.275 19.7502L6.25 13.7002" stroke="currentColor" stroke-width="1.5"
                          stroke-linecap="round" stroke-linejoin="round"></path>
                      </svg>
                      3.25%
                    </span>
                  </div>
                  <p class="m-0 text-uppercase">{{ $t('widgetchart.day') }}</p>
                  <div class="mb-1">
                    1890
                    <span class="text-success">
                      <svg
class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
d="M11.7261 4.25L11.7261 19.25" stroke="currentColor" stroke-width="1.5"
                          stroke-linecap="round" stroke-linejoin="round"></path>
                        <path
d="M5.70149 10.2998L11.7255 4.2498L17.7505 10.2998" stroke="currentColor"
                          stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      </svg>
                      1.00%
                    </span>
                  </div>
                  <p class="m-0 text-uppercase">{{ $t('widgetchart.week') }}</p>
                  <div>
                    1260
                    <span class="text-danger">
                      <svg
...
d="M18.299 13.7002L12.275 19.7502L6.25 13.7002" stroke="currentColor" stroke-width="1.5"
              ...
              <apexchart width="140" height="65" type="area" :series="chart9.series" :options="chart9.options" />
            </div>
          </div>
        </div>
      </b-col>
        ...
        <b-card>
          <div class="d-flex flex-column">
            <div class="mb-3">
              ...
              <span class="text-primary">{{ $t('widgetchart.status') }}</span>
            </div>
            <div class="border rounded">
              <apexchart
height="250" type="bar" :series="extrachart.series" :options="extrachart.options"
                :color-opt="true" />
            </div>
          </div>
        </b-card>
        ...
        <b-card no-body>
          <b-card-header class="d-flex justify-content-between">
            <div class="header-title">
              <h4 class="card-title">{{ $t('widgetchart.upcoming') }}</h4>
            </div>
          </b-card-header>
          <b-card-body>
            <div class="d-flex justify-content-between align-items-center flex-wrap mb-5 mb-lg-2">
              <div>
                <h5>{{ $t('widgetchart.psychology_exam') }}</h5>
                <p>{{ $t('widgetchart.carry_writing') }}</p>
              </div>
              <div>
                <span class="text-danger">{{ $t('widgetchart.jan_19') }}</span>
                <p>{{ $t('widgetchart.minutes_45') }}</p>
              </div>
              <b-button tag="button" variant="outline-danger btn-sm">
...
stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap mb-5 mb-lg-2">
              <div>
                <h5>{{ $t('widgetchart.mathematics_theory') }}</h5>
                <p>{{ $t('widgetchart.carry_writing') }}</p>
              </div>
              <div>
                <span class="text-danger">{{ $t('widgetchart.jan_20') }}</span>
...
stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap mb-5 mb-lg-2">
              ...
              <div>
                <span class="text-danger">{{ $t('widgetchart.jan_21') }}</span>
...
stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap">
              ...
              <div>
                <span class="text-danger">{{ $t('widgetchart.jan_22') }}</span>
