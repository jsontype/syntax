  ...
  <div class="bd-example">
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
          <ul class="mb-2 navbar-nav me-auto mb-lg-0">
            ...
            <li class="nav-item dropdown">
              <a id="navbarDropdown1" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Dropdown </a>
      ...
      <div class="container-fluid">
        ...
        <div id="navbar-1" class="collapse navbar-collapse">
          <ul class="mb-2 navbar-nav ms-auto mb-lg-0">
            ...
            <li class="nav-item dropdown">
              <a id="navbarDropdown2" class="nav-link dropdown-toggle white" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Dropdown </a>
    ...
    <nav class="mt-4 navbar navbar-expand-lg navbar-dark bg-danger rounded">
      <div class="container-fluid">
        ...
        <div id="navbar-22" class="collapse navbar-collapse">
          <ul class="mb-2 navbar-nav ms-auto mb-lg-0">
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              <a id="navbarDropdown3" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
