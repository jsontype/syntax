...
const RelatedMerchandisePage = memo(() => {
  ...
  return (
    <Fragment>
      ...
      <MoviesRecommendedForYou viewAll={false} title="ott_home.recommended" paddingY="pt-2 my-4" slides={5} />
      <RelatedMovies viewAll={false} paddingY="pt-2 my-4" />
      <RelatedVideos viewAll={false} paddingY="pt-2 my-4" />
      <UpcomingMovies viewAll={false} paddingY="pt-2 my-4" slides={5} title="home.upcoming" />
          ...
          <div className="overflow-hidden">
            <div className="d-flex align-items-center justify-content-between px-3 my-4">
              <h5 className="main-title text-capitalize mb-0">
                {t("merchandise.related_products")}
              </h5>
              <Link
                to="/all-products"
