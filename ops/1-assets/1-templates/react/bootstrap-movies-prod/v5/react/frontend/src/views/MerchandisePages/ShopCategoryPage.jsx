...
const ShopCategoryPage = memo((props) => {
  ...
  const options = [
    { value: `${t("shop.default_sorting")}`, label: `${t("shop.default_sorting")}` },
    { value: `${t("shop.sort_by_popularity")}`, label: `${t("shop.sort_by_popularity")}` },
    { value: `${t("shop.sort_by_rating")}`, label: `${t("shop.sort_by_rating")}` },
    { value: `${t("shop.sort_by_latest")}`, label: `${t("shop.sort_by_latest")}` },
    { value: `${t("shop.price_low_to_high")}`, label: `${t("shop.price_low_to_high")}` },
    { value: `${t("shop.price_high_to_low")}`, label: `${t("shop.price_high_to_low")}` },
  ];
  // selector
  ...
  return (
    <Fragment>
      <BreadCrumbWidget title={t("header.shop")} />
