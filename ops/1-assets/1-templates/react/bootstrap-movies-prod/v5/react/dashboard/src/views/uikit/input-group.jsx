...
// React-bootstrap
import { Form, Nav, Tab, InputGroup, Button } from "react-bootstrap";
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/input-group"
                  target="_blank"
                >
                  <svg
                    width="20"
            ...
            <Tab.Content>
              ...
              >
                <div className="bd-example">
                  ...
                  <Form.Label htmlFor="basic-url" className="form-label">
                    Your vanity URL
                  </Form.Label>
                  <InputGroup className=" mb-3">
