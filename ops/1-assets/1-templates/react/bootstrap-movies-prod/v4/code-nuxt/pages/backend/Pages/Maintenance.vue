    ...
    <div class="container mt-3">
      <div class="row">
        <div class="col-lg-4">
          <div class="iq-card text-center mb-0">
            <div class="iq-card-body">
              <i class="ri-window-line ri-4x line-height text-primary" />
        ...
        <div class="col-lg-4">
          <div class="iq-card text-center mb-0">
            <div class="iq-card-body">
              <i class="ri-time-line ri-4x line-height text-primary" />
              <h5 class="card-title mt-1">
        ...
        <div class="col-lg-4">
          <div class="iq-card text-center mb-0">
            <div class="iq-card-body">
              <i class="ri-information-line ri-4x line-height text-primary" />
              <h5 class="card-title mt-1">
                Do you need Support?
              </h5>
              <p class="mb-0">
