...
if (language == "ko") {
  ...
  item0HrefList.push(
    "https://docs.google.com/spreadsheets/d/1ZOXp3H-WgG1jefS84cdoNge9uwsUY5yF/edit#gid=214401444"
  )
  // 아이템1: 아코디언 내용 텍스트
  ...
  item1ContentList.push(
    "안녕하세요! 웹 프로그래머로 활동하고 있는 필명 「Azuma」라고 합니다. 한국으로부터 왔습니다. 현재는 도쿄에서 개발자로 근무하고 있습니다."
  )
  item1ContentList.push(
    "저는 어렸을 때부터 프로그래머가 되고 싶다는 꿈이 있었습니다. 또, 해외의 생활에도 동경을 계속 안고 있었습니다. 자신이 하고 싶은 것을 추구하면서도, 보다 더 사회에 공헌하는, 즉 인간을 이롭게 하는 프로그램을 만들고자 프로그래머에 대한 진로를 결정하였습니다."
  )
  item1ContentList.push(
    "저의 강점은 다음과 같습니다. ・코딩 : EC, B2C, B2B Saas 솔루션 등 다양한 분야의 프로젝트 경험 ・어학 : 영어 수능 1등급, 무역영어 1급 외 어학자격증 4개 소지 ・교육 : 유명과외강사, 6년간 고교교사경력"
  )
  item1ContentList.push(
    "이 홈페이지의 주 목적은 저의 포트폴리오를 전시해 보여드리는 것입니다."
  )
  item1ContentList.push(
    "TOEIC 955, 정보처리기사, 영어정교사, 스노우보드지도사, 영한번역사"
  )
...
if (language == "ja") {
  ...
  item1ContentList.push(
    "私は幼い頃からプログラマーになりたいという夢がありました。また、海外の生活にも憧れを抱いていました。自分がやりたいことを追求しながらも、より社会に貢献し、つまり人間の生活を便利にするプログラムを作ろうと思っております。"
  )
  item1ContentList.push(
    "私の強みは次のとおりです。・コーディング：EC、B2C、B2B Saasソリューションなど多様な分野のプロジェクト経験"
  )
  item1ContentList.push(
    "このホームページの主な目的は私のポートフォリオを展示してお見せする為に作っております。"
  )
  item1ContentList.push(
    "TOEIC 955・情報処理記事・英語精教師・スノーボードマップ・英訳"
  )
...
item2NameList.push("Typescript")
item2NameList.push("ReactJS")
item2NameList.push("VueJS")
item2ContentList.push("100%")
item2ContentList.push("95%")
item2ContentList.push("95%")
item2ContentList.push("90%")
document.querySelector("#circle").setAttribute("data-value", "1.00")
document.querySelector("#circle2").setAttribute("data-value", "0.95")
document.querySelector("#circle3").setAttribute("data-value", "0.95")
document.querySelector("#circle4").setAttribute("data-value", "0.90")
// 아이템3: 마일스톤 수치 데이터
item3ContentList.push(new Date().getFullYear() + "y") // 기준연도
item3ContentList.push(new Date().getFullYear() - 1986 - 1 + "y") // 나이 계산
item3ContentList.push(new Date().getFullYear() - startYear + "y") // 개발연차 계산
// 개발개월 계산
today = new Date()
