      ...
      <div class="row justify-content-center">
        <div class="col-sm-9 text-center">
          <div class="iq-comingsoon-info">
            ...
            <ul id="clockdiv" class="countdown d-flex align-items-center list-inline" data-date="Feb 02 2022 20:20:22">
        ...
        <div class="col-lg-4">
          <form class="iq-comingsoon-form mt-5">
            <div class="form-group">
              <input id="exampleInputEmail1" type="email" class="form-control mb-0 email-color" aria-describedby="emailHelp" placeholder="Enter email address">
