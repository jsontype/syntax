...
&lt;b-button v-b-modal.modal-5 variant="primary"&gt;Small modal&lt;/b-button&gt;
...
&lt;/b-modal&gt;
            ...
            <b-button v-b-modal.modal-3 variant="primary" class="mr-1 mt-1">
              Extra large modal
            </b-button>
            <b-button v-b-modal.modal-4 variant="primary" class="mr-1 mt-1">
              Large modal
            </b-button>
            <b-button v-b-modal.modal-5 variant="primary" class="mr-1 mt-1">
              Small modal
            </b-button>
            <b-modal id="modal-3" size="xl" title="Modal title" ok-title="Save Changes" cancel-title="Close">
              <p>Modal body text goes here.</p>
...
&lt;/b-modal&gt;
            ...
            <b-button v-b-modal.modal-6 variant="primary">
              Launch demo modal
            </b-button>
            <b-modal id="modal-6" title="Modal title" ok-title="Save Changes" cancel-title="Close">
              <p>Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.</p>
...
&lt;/b-modal&gt;
            ...
            <b-button v-b-modal.modal-7 variant="primary" class="mr-1 mt-1">
              Launch demo modal
            </b-button>
            <b-button v-b-modal.modal-8 variant="primary" class="mr-1 mt-1">
...
&lt;/b-modal&gt;
            ...
            <b-button v-b-modal.modal-9 variant="primary">
              Launch demo modal
            </b-button>
            <b-modal id="modal-9" centered title="Modal title" ok-title="Save Changes" cancel-title="Close">
              <div class="iq-example-row">
