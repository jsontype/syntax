<x-layouts.dashboard :assets="$assets ?? []">
   <div>
      <?php
         $id = $id ?? null;
      ?>
            ...
            <div class="card">
               ...
               <div class="card-body">
                     <div class="form-group">
                        ...
                        <img src="{{asset('dashboard/images/user/1.jpg')}}" alt="User-Profile" class="profile-pic rounded-circle avatar-100">
                     ...
                     <div class="form-group">
                        ...
                        <div class="d-flex flex-column" style="--bs-gap: 1rem">
                            <div class="custom-control custom-radio custom-control-inline">
                                {{ Form::radio('status', 'active',old('status') || true, ['class' => 'custom-control-input', 'id' => 'status-active']); }}
                                <label class="custom-control-label" for="status-active">
                                    Active
                                </label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                {{ Form::radio('status', 'pending',old('status'), ['class' => 'custom-control-input', 'id' => 'status-pending']); }}
                                <label class="custom-control-label" for="status-pending">
                                    Pending
                                </label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                {{ Form::radio('status', 'banned',old('status'), ['class' => 'custom-control-input', 'id' => 'status-banned']); }}
                                <label class="custom-control-label" for="status-banned">
                                    Banned
                                </label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                {{ Form::radio('status', 'inactive',old('status'), ['class' => 'custom-control-input', 'id' => 'status-inactive']); }}
                                <label class="custom-control-label" for="status-inactive">
                                    Inactive
                                </label>
                            </div>
                        </div>
