        ...
        <b-row>
          <b-col sm="12" class=" overflow-hidden">
              ...
              <div class="trending-contens">
                <Slick id="trending-slider-nav" class="list-inline p-0 mb-0 row align-items-center iq-rtl-direction"  :option="trendingOption1">
                ...
                <Slick id="trending-slider" class="list-inline p-0 m-0  d-flex align-items-center iq-rtl-direction" :option="trendingOption">
                    ...
                    <div class="tranding-block position-relative"  :style="{backgroundImage:`url(${require('../../../../assets/images/frontend/trending/'+item.backgroudImage)})`}">
                      <div  class="trending-custom-tab">
                        <div class="tab-title-info position-relative">
                            <div class="tab-title-info position-relative">
                              <tab-nav class="trending-pills tranding-tab-nav text-center align-items-center d-flex iq-ltr-direction" :pills="true" align="center" role="tablist">
                                <tab-nav-items ariaControls="trending-data1" :active="true" title="Overview" dataToggle="pill" role="tab" :ariaSelected="true"/>
                                <tab-nav-items ariaControls="trending-data2"  title="Episodes" dataToggle="pill" role="tab" :ariaSelected="false"/>
                                <tab-nav-items ariaControls="trending-data3"  title="Trailers" dataToggle="pill" role="tab" :ariaSelected="false"/>
                                <tab-nav-items ariaControls="trending-data4"  title="Similar Like This" dataToggle="pill" role="tab" :ariaSelected="false"/>
                              </tab-nav>
                            </div>
                            <tab-content class="trending-content">
                              <tab-content-item id="trending-data1" class="overview-tab-pane" :active="true">
                                <div class="trending-info align-items-center w-100 animated fadeInUp iq-ltr-direction">
                                    ...
                                    <div class="d-flex align-items-center text-white text-detail">
                                      ...
                                      <span class="ml-3">{{item.session}}</span>
                                    ...
                                    <div class="d-flex align-items-center series mb-4">
                                      ...
                                      <span class="text-gold ml-3">{{item.series}}</span>
                                    </div>
                                    <p class="trending-dec">{{item.text}}
                                    </p>
                                    <div class="p-btns">
                              ...
                              <tab-content-item id="trending-data2" class="overview-tab-pane" >
                                <div
                                    class="trending-info align-items-center w-100 animated fadeInUp iq-ltr-direction">
                                    <router-link :to="{ name: 'landing-page.category-detail' }" tabindex="0">
                                      <div class="channel-logo">
                                    ...
                                    <h1 class="trending-text big-title text-uppercase">the hero camp</h1>
                                     <div class="d-flex align-items-center text-white text-detail mb-4 iq-ltr-direction">
                                    ...
                                    <div class="iq-custom-select  d-inline-block sea-epi">
                                      <V-select :options="sessonOption" v-model="selected"></V-select>
                                    </div>
                                      ...
                                      <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 mb-0 iq-rtl-direction">
                                          <div class="e-item">
                                            <div class="block-image position-relative">
                                                ...
                                                <img src="../../../../assets/images/frontend/episodes/01.jpg" class="img-fluid" alt="">
                                                </router-link >
                                                <div class="episode-play-info">
                                                  <div class="episode-play">
                                                      <a :to="{ name: 'landing-page.category-detail' }" tabindex="0"><i
                                            ...
                                            <div class="episodes-description text-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <router-link  :to="{ name: 'landing-page.category-detail' }">Episode 1</router-link >
                                          ...
                                          <div class="e-item">
                                            <div class="block-image position-relative">
                                                <router-link  :to="{ name: 'landing-page.category-detail' }">
                                                <img src="../../../../assets/images/frontend/episodes/02.jpg" class="img-fluid" alt="">
                                                </router-link >
                                                <div class="episode-play-info">
                                                  <div class="episode-play">
                                                      <a :to="{ name: 'landing-page.category-detail' }" tabindex="0"><i
                                            ...
                                            <div class="episodes-description text-body ">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <a :to="{ name: 'landing-page.category-detail' }">Episode 2</a>
                                          ...
                                          <div class="e-item">
                                            <div class="block-image position-relative">
                                                <router-link  :to="{ name: 'landing-page.category-detail' }">
                                                <img src="../../../../assets/images/frontend/episodes/03.jpg" class="img-fluid" alt="">
                                                </router-link >
                                                <div class="episode-play-info">
                                                  <div class="episode-play">
                                                      <a :to="{ name: 'landing-page.category-detail' }" tabindex="0"><i
                                            ...
                                            <div class="episodes-description text-body ">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <router-link  :to="{ name: 'landing-page.category-detail' }">Episode 3</router-link >
                                          ...
                                          <div class="e-item">
                                            <div class="block-image position-relative">
                                                <router-link  :to="{ name: 'landing-page.category-detail' }">
                                                <img src="../../../../assets/images/frontend/episodes/04.jpg" class="img-fluid" alt="">
                                                </router-link >
                                                <div class="episode-play-info">
                                                  <div class="episode-play">
                                                      <router-link  :to="{ name: 'landing-page.category-detail' }" tabindex="0"><i
                                            ...
                                            <div class="episodes-description text-body ">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <a :to="{ name: 'landing-page.category-detail' }">Episode 4</a>
                                          ...
                                          <div class="e-item">
                                            <div class="block-image position-relative">
                                                <router-link  :to="{ name: 'landing-page.category-detail' }">
                                                <img src="../../../../assets/images/frontend/episodes/05.jpg" class="img-fluid" alt="">
                                                </router-link >
                                                <div class="episode-play-info">
                                                  <div class="episode-play">
                                                      <router-link  :to="{ name: 'landing-page.category-detail' }" tabindex="0"><i
                                            ...
                                            <div class="episodes-description text-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <a :to="{ name: 'landing-page.category-detail' }">Episode 5</a>
                              ...
                              <tab-content-item id="trending-data3" class="overview-tab-pane" >
                                <div
                                    class="trending-info align-items-center w-100 animated fadeInUp iq-ltr-direction">
                                    <a href="javascript:void(0);" tabindex="0">
                                      <div class="channel-logo iq-ltr-direction">
                                          <img src="../../../../assets/images/logo-full.png" class="c-logo" alt="stramit">
                                      </div>
                                    </a>
                                    <h1 class="trending-text big-title text-uppercase">{{item.title}}</h1>
                                    <div class="episodes-contens mt-4">
                                        <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 mb-0 iq-rtl-direction">
                                          <div class="e-item">
                                            ...
                                            <div class="episodes-description text-body ">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <router-link  :to="{ name: 'landing-page.category-detail' }">Trailer 1</router-link >
                                                  <span class="text-primary">2.25 m</span>
                                                </div>
                                                <p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.
                                                </p>
                                          ...
                                          <div class="e-item">
                                            ...
                                            <div class="episodes-description text-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <router-link  :to="{ name: 'landing-page.category-detail' }">Trailer 2</router-link >
                                                  <span class="text-primary">3.23 m</span>
                                                </div>
                                                <p class="mb-0">
                                                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.
                                          ...
                                          <div class="e-item">
                                            ...
                                            <div class="episodes-description text-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <router-link  :to="{ name: 'landing-page.category-detail' }">Trailer 3</router-link >
                                                  <span class="text-primary">2 m</span>
                                                </div>
                                                <p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.
                                                </p>
                                          ...
                                          <div class="e-item">
                                            ...
                                            <div class="episodes-description text-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <router-link  :to="{ name: 'landing-page.category-detail' }">Trailer 4</router-link >
                                                  <span class="text-primary">1.12 m</span>
                                                </div>
                                                <p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.
                                                </p>
                                          ...
                                          <div class="e-item">
                                            ...
                                            <div class="episodes-description text-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <router-link  :to="{ name: 'landing-page.category-detail' }">Trailer 5</router-link >
                                                  <span class="text-primary">2.54 m</span>
                                                </div>
                                                <p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.
                                                </p>
                              ...
                              <tab-content-item id="trending-data4" class="overview-tab-pane" >
                                <div
                                    class="trending-info align-items-center w-100 animated fadeInUp iq-ltr-direction">
                                    <a href="javascript:void(0);" tabindex="0">
                                      <div class="channel-logo">
                                    ...
                                    <div class="episodes-contens mt-4">
                                       <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 mb-0 iq-rtl-direction">
                                          ...
                                          <div class="e-item">
                                            ...
                                            <div class="episodes-description text-body ">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <router-link  :to="{ name: 'landing-page.category-detail' }">Episode 2</router-link >
                                                  <span class="text-primary">3.23 m</span>
                                                </div>
                                                <p class="mb-0">
                                                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.
                                          ...
                                          <div class="e-item">
                                            ...
                                            <div class="episodes-description text-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <router-link  :to="{ name: 'landing-page.category-detail' }">Episode 4</router-link >
                                                  <span class="text-primary">1.12 m</span>
                                                </div>
                                                <p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.
                                                </p>
                                          ...
                                          <div class="e-item">
                                            ...
                                            <div class="episodes-description text-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                  <router-link  :to="{ name: 'landing-page.category-detail' }">Episode 5</router-link >
                                                  <span class="text-primary">2.54 m</span>
                                                </div>
                                                <p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard.
                                                </p>
