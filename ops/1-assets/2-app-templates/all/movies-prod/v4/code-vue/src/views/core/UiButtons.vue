...
&lt;input class="btn btn-info" type="reset" value="Reset"&gt;
            ...
            <b-button variant="primary" class="mr-1 mb-2" type="button">Link</b-button>
            <b-button variant="success" class="mr-1 mb-1" type="button">Button</b-button>
            <b-button variant="danger" class="mr-1 mb-1" type="button">Input</b-button>
            <b-button variant="warning" class="mr-1 mb-1" type="button">Submit</b-button>
            <b-button variant="info" class="mr-1 mb-1" type="button">Reset</b-button>
          </template>
        </iq-card>
      </b-col>
      <b-col lg="6" sm="12">
...
&lt;b-button size="lg" variant="info"&gt;Large Button&lt;/b-button&gt;
            ...
            <b-button size="sm" variant="primary" class="mr-2 mb-1">Small Button</b-button>
            <b-button variant="success" class="mr-2 mb-1">Button</b-button>
            <b-button size="lg" class="mr-1 mb-1" variant="info">Large Button</b-button>
          </template>
        </iq-card>
      </b-col>
    </b-row>
