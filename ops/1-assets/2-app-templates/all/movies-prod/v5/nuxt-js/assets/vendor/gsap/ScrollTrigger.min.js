    ...
    ((ScrollTrigger.prototype.init = function init(S, M) {
      if (((this.progress = this.start = 0), this.vars && this.kill(1), Ue)) {
        ...
        (we.media = Ve),
          ...
          (l.tweenScroll = l.tweenScroll || { top: pb(he, ot), left: pb(he, nt) }),
          ...
          pe &&
            ...
            'scrollBehavior' in Pe.style && Se.set(ve ? [Pe, _e] : he, { scrollBehavior: 'auto' }),
            (f = W(pe.snapTo)
              ? pe.snapTo
              : 'labels' === pe.snapTo
            ...
            (y = Se.delayedCall(pe.delay || o / 2 || 0.1, function () {
              if (Math.abs(we.getVelocity()) < 10 && !Ie && Oe !== we.scroll()) {
                var e = M && !ge ? M.totalProgress() : we.progress,
                  t = ((e - x) / (He() - Ae)) * 1e3 || 0,
                  r = Se.utils.clamp(-we.progress, 1 - we.progress, (Je(t / 2) * t) / 0.185),
                ...
                if (i <= A && E <= i && a !== i) {
                  ...
                  !1 === pe.inertia && (r = o - we.progress),
                    d(
                      a,
                      {
                        duration: p(Je((0.185 * Math.max(Je(n - e), Je(o - e))) / t / 0.05 || 0)),
                        ease: pe.ease || 'power3',
                        data: Math.abs(a - i),
          ...
          (we.revert = function (e) {
            var t = !1 !== e || !we.enabled,
              r = Be;
            t !== we.isReverted &&
              (t && (we.scroll.rec || (we.scroll.rec = we.scroll()), (ee = Math.max(we.scroll(), we.scroll.rec || 0)), (G = we.progress), (te = M && M.progress())),
              B &&
          ...
          (we.refresh = function (e, t) {
            if ((!Be && we.enabled) || t)
              if (ae && e && je) Ca(ScrollTrigger, 'scrollEnd', Va);
                ...
                for (E = mb(x, ie, p, re, we.scroll(), B, L, we, d, ye, me, g) || (ae ? -0.001 : 0), W(m) && (m = m(we)), V(m) && !m.indexOf('+=') && (~m.indexOf(' ') ? (m = (V(x) ? x.split(' ')[0] : '') + m) : ((h = Ha(m.substr(2), p)), (m = V(x) ? x : E + h), (b = ie))), A = Math.max(E, mb(m || (b ? '100% 0' : g), b, p, re, we.scroll() + h, I, R, we, d, ye, me, g)) || -0.001, z = A - E || ((E -= 0.01) && 0.001), h = 0, C = w; C--; ) (l = (s = lt[C]).pin) && s.start - s._pinPush < E && ((r = s.end - s.start), (l !== ie && l !== y) || (h += r), l === ae && (v += r));
                if (((E += h), (A += h), (we._pinPush = v), B && h && (((r = {})[re.a] = '+=' + h), y && (r[re.p] = '-=' + we.scroll()), Se.set([B, I], r)), ae))
                  (r = ta(ae)),
                    (i = re === ot),
                    (o = we.scroll()),
                    ...
                    (n = it(ae, !0)),
                    (c = me && P(he, i ? nt : ot)()),
                    se && ((($ = [se + re.os2, z + v + rt]).t = j), (C = se === Ge ? xa(ae, re) + z + v : 0) && $.push(re.d, C + rt), ft($), me && we.scroll(ee)),
                    me &&
                      (((a = { top: n.top + (i ? o - E : c) + rt, left: n.left + (i ? c : o - E) + rt, boxSizing: 'border-box', position: 'fixed' })[Xe] = a.maxWidth = Math.ceil(n.width) + rt),
                      (a[Ze] = a.maxHeight = Math.ceil(n.height) + rt),
                    ...
                    M ? ((u = M._initted), ze(1), M.render(M.duration(), !0, !0), (q = U(re.a) - Z + z + v), z !== q && F.splice(F.length - 2, 2), M.render(0, !0, !0), u || M.invalidate(), ze(0)) : (q = z);
                else if (ie && we.scroll()) for (n = ie.parentNode; n && n !== Pe; ) n._pinOffset && ((E -= n._pinOffset), (A -= n._pinOffset)), (n = n.parentNode);
                f &&
                  ...
                  G !== we.progress && (K && M.totalProgress(G, !0), (we.progress = G), we.update()),
                  ae && se && (j._pinOffset = Math.round(we.progress * q)),
                  oe && oe(we);
              }
          }),
          ...
          (we.update = function (e, t) {
            ...
            if ((t && ((_ = k), (k = s), pe && ((x = b), (b = M && !ge ? M.totalProgress() : c))), ce && !c && ae && !Be && !De && je && E < s + ((s - _) / (He() - Ae)) * ce && (c = 1e-4), c !== u && we.enabled)) {
              ...
              !pe || d.tween || Be || De || y.restart(!0),
                ...
                !w || ge || e || w(we),
                i && !Be ? ((n = c && !u ? 0 : 1 === c ? 1 : 1 === u ? 2 : 3), ge && ((o = (!a && 'none' !== xe[n + 1] && xe[n + 1]) || xe[n]), M && ('complete' === o || 'reset' === o || o in M) && ('complete' === o ? M.pause().totalProgress(1) : 'reset' === o ? M.restart(!0).pause() : 'restart' === o ? M.restart(!0) : M[o]()), w && w(we)), (!a && We) || (ne && a && ne(we), be[n] && be[n](we), fe && (1 === c ? we.kill(!1, 1) : (be[n] = 0)), a || (be[(n = 1 === c ? 1 : 3)] && be[n](we)))) : ge && w && !Be && w(we);
            }
