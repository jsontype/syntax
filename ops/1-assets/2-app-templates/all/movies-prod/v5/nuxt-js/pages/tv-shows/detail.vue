<template>
  <div class="tv-show-detail">
    <b-container fluid>
      <div
        class="overlay-wrapper iq-main-slider"
        style="
          background: url(/assets/images/tv-show/episodes/main-banner.webp);
          background-repeat: no-repeat;
        "
      >
        <div class="banner-caption">
          <div class="trending-info p-0">
            <h1 class="texture-text big-font text-uppercase mt-2">
              {{ $t("episode_page.zombie_world") }}
            </h1>
            <div
              class="slider-ratting d-flex align-items-center gap-3"
            ...
            <ul class="p-0 mt-2 list-inline d-flex flex-wrap movie-tag">
              <li class="trending-list">
                <nuxt-link
                  class="text-primary text-uppercase font-size-18"
                  :to="{ name: 'view-all' }"
                  >{{ $t("episode_page.comedy") }}</nuxt-link
                >
              </li>
              <li class="trending-list">
                <nuxt-link
                  class="text-primary text-uppercase font-size-18"
                  :to="{ name: 'view-all' }"
                  >{{ $t("episode_page.drama") }}</nuxt-link
                >
              </li>
            </ul>
            <div
              class="d-flex flex-wrap align-items-center gap-3 font-size-20 mb-3 fw-500 text-white"
            >
              <span>{{ $t("episode_page.seasons") }} 1 </span>
              <span>Feb 2019</span>
            </div>
            <p class="line-count-2 my-3">
              {{ $t("episode_page.travels_lone") }}
            </p>
          </div>
          <div class="position-relative my-4">
            <nuxt-link
              :to="{ name: 'tv-shows-episode' }"
          ...
          <div class="d-flex align-items-center flex-wrap gap-4 mb-4">
            <ul
              class="list-inline p-0 m-0 share-icons music-play-lists mb-n2 mx-n2"
            >
              <li class="share">
            ...
            <div class="movie-detail-select">
              <select name="movieselect" class="form-control movie-select">
          ...
          <ul
            class="iq-blogtag list-unstyled d-flex flex-wrap align-items-center gap-3 p-0"
          >
            ...
            <li>
              <nuxt-link class="title" :to="{ name: 'view-all' }"
                >4K {{ $t("detail_page.ultra") }} </nuxt-link
            ...
            <li>
              <nuxt-link class="title" :to="{ name: 'view-all' }">{{
                $t("detail_page.brother_relationship")
              }}</nuxt-link
              ><span class="text-secondary">,</span>
            </li>
            <li>
      ...
      <div class="show-movie-section">
        <div class="iq-custom-select d-inline-block">
          <select class="form-control">
            <option value="season1">{{ $t("detail_page.season") }} 1</option>
            <option value="season1">{{ $t("detail_page.season") }} 2</option>
          </select>
        </div>
        <div class="show-custom-tab">
          <ul
            class="iq-custom-tab tab-bg-fill nav nav-pills text-center list-inline my-4"
            role="tablist"
          >
            <li class="nav-item" role="presentation">
              <a
                class="nav-link active show m-0"
                data-bs-toggle="pill"
                href="#episodes"
                role="tab"
                aria-selected="true"
                >{{ $t("detail_page.episode") }}</a
              >
            </li>
            <li class="nav-item" role="presentation">
              <a
                  ...
                  <div class="comment-respond">
                    ...
                    <form class="comment-form">
                      <p class="comment-notes">
                        <span>
                          {{ $t("detail_page.published_email") }}
                        </span>
                        <span>
                          {{ $t("detail_page.required_fields_are_marked") }}
                          <span class="required"> * </span>
                        </span>
                      </p>
                      <div class="d-flex align-items-center mb-4">
                        <label>{{ $t("detail_page.your_rating") }}</label>
  ...
  <div class="cast-tabs">
    <b-container fluid>
      <div class="content-details trending-info g-border iq-rtl-direction">
        <ul
          class="iq-custom-tab tab-bg-fill d-flex nav nav-pills mb-5 list-inline"
          role="tablist"
        >
          <li class="nav-item" role="presentation">
            <a
        ...
        <div class="tab-content">
          ...
          >
            <swiper
              :slides-per-view="5"
              tag="ul"
              class="position-relative swiper-card"
              :breakpoints="{
                '0': {
                  slidesPerView: 1,
                  spaceBetween: 0,
            ...
            >
              <swiper-slide tag="li">
                ...
                >
                  <div class="col-4 p-0 img-box">
                    <img
                      src="/assets/images/genre/g1.webp"
                      class="img-fluid"
                      alt="image"
                      loading="lazy"
                    />
                  ...
                  <div class="col-8 block-description">
                    <h6 class="iq-title">
                      <nuxt-link :to="{ name: 'cast-detail' }" tabindex="0"
                        >{{ $t("detail_page.james_chinlund") }}
                      </nuxt-link>
                    </h6>
                    <div class="video-time d-flex align-items-center my-2">
                      <small class="text-white">{{
                        $t("detail_page.as_james")
                      }}</small>
                    </div>
                  </div>
                </div>
              ...
              <swiper-slide>
                ...
                >
                  <div class="col-4 p-0 img-box">
                    <img
                      src="/assets/images/genre/g2.webp"
                      class="img-fluid"
                      alt="image"
                      loading="lazy"
                    />
                  ...
                  <div class="col-8 block-description">
                    <h6 class="iq-title">
                      <nuxt-link :to="{ name: 'cast-detail' }" tabindex="0"
                        >{{ $t("detail_page.james_earl") }}
                      </nuxt-link>
                    </h6>
                    <div class="video-time d-flex align-items-center my-2">
                      <small class="text-white">{{
                        $t("detail_page.as_jones")
                      }}</small>
                    </div>
                  </div>
                </div>
            ...
            >
              <swiper-slide tag="li">
                ...
                >
                  <div class="col-4 p-0 img-box">
                    <img
                      src="/assets/images/genre/g3.webp"
                      class="img-fluid"
                      alt="image"
                      loading="lazy"
                    />
                  ...
                  <div class="col-8 block-description starring-desc">
                    <h6 class="iq-title">
                      <nuxt-link :to="{ name: 'cast-detail' }" tabindex="0">
                        {{ $t("detail_page.jeff_nathanson") }}
                      </nuxt-link>
                    </h6>
                    <div class="video-time d-flex align-items-center my-2">
                      <small class="text-white">{{
                        $t("detail_page.writing")
                      }}</small>
                    </div>
                  </div>
                </div>
              ...
              <swiper-slide>
                ...
                >
                  <div class="col-4 p-0 img-box">
                    <img
                      src="/assets/images/genre/g5.webp"
              ...
              <swiper-slide>
                ...
                >
                  <div class="col-4 p-0 img-box">
                    <img
                      src="/assets/images/genre/g4.webp"
                      class="person__poster--image img-fluid"
                      alt="image"
                      loading="lazy"
                    />
                  ...
                  <div class="col-8 block-description starring-desc">
                    <h6 class="iq-title">
                      <nuxt-link :to="{ name: 'cast-detail' }" tabindex="0">
                        {{ $t("detail_page.karan_gilchrist") }}
                      </nuxt-link>
                    </h6>
                    <div class="video-time d-flex align-items-center my-2">
                      <small class="text-white">{{
                        $t("detail_page.production")
                      }}</small>
                    </div>
                  </div>
                </div>
...
const breadcrumb = useStremit();

onMounted(() => {
  breadcrumb.breadcrumbSet({ show: false, name: "" });
});
