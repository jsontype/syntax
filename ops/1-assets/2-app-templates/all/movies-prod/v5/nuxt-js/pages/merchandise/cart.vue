      ...
      <b-row>
        <b-col lg="8">
          <div class="table-responsive">
            <table class="table cart-table" cellspacing="0">
              <thead class="border-bottom">
                <tr>
                  <th scope="col" class="font-size-18 fw-500">
                    {{ $t("shop.product") }}
                  </th>
                  <th scope="col" class="font-size-18 fw-500">
                    {{ $t("shop.price") }}
          ...
          >
            ...
            <div class="button-primary">
              <div class="iq-button">
                <a href="#" class="btn text-uppercase position-relative">
                  <span class="button-text">{{ $t("shop.update_cart") }}</span>
                  <i class="fa-solid fa-play"></i>
                </a>
              </div>
            </div>
        ...
        <b-col lg="4">
          <div class="cart_totals p-4">
            <h5 class="mb-3 font-size-18 fw-500">{{ $t("shop.total") }}</h5>
            <div class="css_prefix-woocommerce-cart-box table-responsive">
              <table
                v-for="data in myCart"
                :key="data"
                cellspacing="0"
                class="table"
              >
