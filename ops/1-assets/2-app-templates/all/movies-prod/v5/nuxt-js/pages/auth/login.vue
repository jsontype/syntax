<template>
  <section
    class="sign-in-page vh-100"
    :style="`background: url(${generateImgPath(
      '/assets/images/pages/01.webp'
    )}); background-size: cover; background-repeat: no-repeat; position: relative;min-height:500px;`"
  >
    <div class="container">
      <div
        class="row justify-content-center align-items-center height-self-center vh-100"
      >
        <div class="col-lg-5 col-md-12 align-self-center">
          <div class="user-login-card bg-body">
            ...
            <form action="post">
              <div class="mb-3">
                <label class="text-white fw-500 mb-2">{{
              ...
              <div class="text-end mb-3">
                <nuxt-link
                  :to="{ name: 'auth-lost-password' }"
                  class="text-primary fw-semibold fst-italic"
                  >{{ $t("form.forgot_password") }}</nuxt-link
                >
              </div>
              <label
                class="list-group-item d-flex align-items-center mb-3 font-size-14 text-white fw-500"
            ...
            <p class="my-4 text-center fw-500 text-white">
              {{ $t("form.new_to_streamit") }}
              <nuxt-link
                :to="{ name: 'auth-sign-up' }"
                class="text-primary ms-1"
                >{{ $t("shop.register") }}</nuxt-link
              >
            </p>
            <div
              class="seperator d-flex justify-content-center align-items-center"
            >
            ...
            <ul
              class="p-0 pt-4 m-0 list-unstyled widget_social_media text-center"
            >
              <li class="">
