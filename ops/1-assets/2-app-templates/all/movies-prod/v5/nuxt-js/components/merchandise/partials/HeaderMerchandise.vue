          ...
          <b-col md="9">
            <ul class="d-flex align-items-center justify-content-end gap-3 list-inline mb-0">
                  ...
                  <span class="btn-icon rounded-pill user-icons">
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none">
                      ...
                      <path
                        ...
                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      <path d="M9.1983 7.4013H9.16779" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round"></path>
                      <path d="M5.3106 7.4013H5.28009" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round"></path>
                    </svg>
                  </span>
                </a>
              ...
              <li id="itemdropdown1" class="dropdown">
                <a id="navbarDropdown" class="text-white d-flex align-items-center" href="#" role="button"
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-user border-0 p-0 m-0"
                  ...
                  <li class="user-info d-flex align-items-center gap-3 mb-3">
                    ...
                    <span class="font-size-14 fw-500 text-capitalize text-white">{{ $t("header.jenny") }}</span>
                  </li>
                  <li>
                    <nutx-link to="/merchandise/account" class="iq-sub-card d-flex align-items-center gap-3">
                  ...
                  <li>
                    <a href="" class="iq-sub-card d-flex align-items-center gap-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <path d="M6.425 13.75V7.575H0.25V6.425H6.425V0.25H7.575V6.425H13.75V7.575H7.575V13.75H6.425Z"
                          fill="white"></path>
                      </svg>
                      <h6 class="mb-0 font-size-14 fw-normal">
                        {{ $t("header.watchlist") }}
        ...
        <div class="container-fluid navbar-inner">
          <div class="d-flex align-items-center justify-content-between w-100 landing-header">
            ...
            <nav id="navbar_main"
              ...
              <div class="container-fluid p-lg-0">
                ...
                <ul id="header-menu" class="navbar-nav iq-nav-menu list-unstyled">
                  <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="collapse" href="#homePages" role="button"
                      aria-expanded="false" aria-controls="homePages">
                      <span class="item-name">{{ $t("header.home") }}</span>{{ " " }}
                    ...
                    <ul id="homePages" class="sub-nav collapse list-unstyled">
                      <li class="nav-item">
                        <nuxt-link :class="`nav-link ${IS_MEGA ? 'p-0' : ''}`" :to="{ name: 'index' }">
                          <img v-if="IS_MEGA" src="/assets/images/mega-menu/new-home.webp" alt="img"
                            class="img-fluid d-xl-block d-none" loading="lazy" />
                          <span class="d-inline-block">{{ $t("header.ott_home") }}
                          </span>
                        </nuxt-link>
                      </li>
                      <li class="nav-item">
                        <nuxt-link :class="`nav-link ${IS_MEGA ? 'p-0' : ''}`" :to="{ name: 'home' }">
              ...
              $t("header.home")
                      ...
                      <li class="nav-item">
                        <nuxt-link :class="`nav-link ${IS_MEGA ? 'p-0' : ''}`" :to="{ name: 'movies' }">
              ...
              $t("header.movie")
                      ...
                      <li class="nav-item">
                        <nuxt-link :class="`nav-link ${IS_MEGA ? 'p-0' : ''}`" :to="{ name: 'tv-shows' }">
              ...
              $t("header.tv_show")
                      ...
                      <li class="nav-item">
                        <nuxt-link :class="`nav-link ${IS_MEGA ? 'p-0' : ''}`" :to="{ name: 'videos' }">
              ...
              $t("header.video")
                      ...
                      <li class="nav-item">
                        <nuxt-link :class="`nav-link ${IS_MEGA ? 'p-0' : ''}`" :to="{ name: 'merchandise-home' }">
              ...
              $t("header.merchandise_store")
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#features" role="button" aria-expanded="false"
                      ...
                      <span class="item-name">{{ $t("header.features") }}</span>{{ " " }}
                      <span class="menu-icon">
                        <i class="fa fa-caret-down toggledrop-desktop right-icon" aria-hidden="true"></i>
                        <span class="toggle-menu">
                          <i class="fa fa-plus arrow-active text-white" aria-hidden="true"></i>
                    ...
                    <ul id="features" class="sub-nav collapse list-unstyled">
                      ...
                      <li class="nav-item">
                        <nuxt-link class="nav-link" :to="{ name: 'movies-related' }">
                          {{ $t("header.related_merchandise") }}</nuxt-link>
                      </li>
                      <li class="nav-item">
                        <nuxt-link class="nav-link" :to="{ name: 'play-list' }">
                          {{ $t("header.playlist") }}</nuxt-link>
                      </li>
                      <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#pages" role="button" aria-expanded="false"
                      aria-controls="homePages">
                      <span class="item-name">{{ $t("header.pages") }}</span>{{ " " }}
                      <span class="menu-icon">
                        <i class="fa fa-caret-down toggledrop-desktop right-icon" aria-hidden="true"></i>
                        <span class="toggle-menu">
                          <i class="fa fa-plus arrow-active text-white" aria-hidden="true"></i>
                    ...
                    <ul id="pages" class="sub-nav collapse list-unstyled">
                      ...
                      <li class="nav-item">
                        <nuxt-link class="nav-link" to="extra-contact-us">
                          {{ $t("header.contact_us") }}
                        </nuxt-link>
                      </li>
                      <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" to="#error-page" role="button"
                          aria-expanded="false" aria-controls="error-page">
              ...
              $t("header.error_page")
                        ...
                        <ul id="error-page" class="sub-nav collapse list-unstyled">
                          <li class="nav-item">
                          ...
                          <li class="nav-item">
                            <nuxt-link class="nav-link" :to="{ name: 'extra-error-page-two' }">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" to="#blog" role="button" aria-expanded="false"
                      aria-controls="blog">
                      <span class="item-name">{{ $t("header.blog") }}</span>{{ " " }}
                      <span class="menu-icon">
                        <i class="fa fa-caret-down toggledrop-desktop right-icon" aria-hidden="true"></i>
                        <span class="toggle-menu">
                          <i class="fa fa-plus arrow-active text-white" aria-hidden="true"></i>
                    ...
                    <ul id="blog" class="sub-nav collapse list-unstyled">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" to="#blog-grid" role="button"
                          aria-expanded="false" aria-controls="blog-grid">
                          <span class="item-name">{{
              $t("header.blog_grid")
            }}</span>
                          <span class="menu-icon">
              ...
              params: { type: 'four-column' },
                      ...
                      <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" to="#blog-sidebar" role="button"
              ...
              $t("header.blog_single")
                        ...
                        <ul id="blog-single" class="sub-nav collapse list-unstyled">
                          <li class="nav-item">
                            <nuxt-link class="nav-link" :to="{ name: 'blogs-template' }">
                              {{ $t("header.blog_template") }}
                            </nuxt-link>
                          </li>
                          <li class="nav-item">
                            <nuxt-link class="nav-link" :to="{ name: 'blogs-detail' }">
                              {{ $t("header.standard") }}
                            </nuxt-link>
                          </li>
                          <li class="nav-item">
              ...
              params: { type: 'gallery' },
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#shop" role="button" aria-expanded="false"
                      aria-controls="shop">
                      <span class="item-name">{{ $t("header.shop") }}</span>{{ " " }}
                      <span class="menu-icon">
                        <i class="fa fa-caret-down toggledrop-desktop right-icon" aria-hidden="true"></i>
                        <span class="toggle-menu">
                          <i class="fa fa-plus arrow-active text-white" aria-hidden="true"></i>
            ...
            <div class="right-panel">
              ...
              <div id="navbarSupportedContent" class="collapse navbar-collapse p-3">
                <div class="iq-meta-menu-container d-xl-block d-none">
                  <ul class="d-flex align-items-center m-0 list-inline iq-meta-menu">
                    ...
                    <li>
                      <nuxt-link to="https://iqonic.desky.support/">{{
