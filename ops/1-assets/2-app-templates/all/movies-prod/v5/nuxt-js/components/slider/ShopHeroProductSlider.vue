<template>
  <b-container fluid>
    <b-row>
      <b-col sm="12" class="overflow-hidden">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <nuxt-link
            :to="{ name: props.viewLink }"
            class="text-primary iq-view-all"
    ...
    <div class="favourite-slider">
      <Swiper
        class="pt-2 pt-md-4 pt-lg-4 iq-rtl-direction"
        v-if="render"
        :dir="rtl"
        :loop="true"
        :slides-per-view="4"
      ...
      >
        <SwiperSlide
          v-for="data in props.sliderData"
          :key="data"
          tag="li"
          class="slide-item"
        >
          <shop-card
            ...
            :time="data.duration"
            :likes="data.likes"
            :route-name="props.detailViewLink"
          ></shop-card>
        </SwiperSlide>
      </Swiper>
    </div>
