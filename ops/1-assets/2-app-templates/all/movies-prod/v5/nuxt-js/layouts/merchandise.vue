<template>
  ...
  <FooterMerchandise></FooterMerchandise>
  <!-- Footer Component End -->

  <div
    id="offcanvasCart"
    class="offcanvas offcanvas-end sidebar-cart border-0 on-rtl end"
    tabindex="-1"
    aria-modal="true"
    role="dialog"
  >
    <div class="offcanvas-header py-4">
      <h5 class="offcanvas-title">{{ $t("shop.shopping_cart") }} (3)</h5>
      <button
        type="button"
        class="btn-close"
    ...
    <div class="offcanvas-body py-5">
      <div
        class="sidebar-cart-content d-flex flex-column justify-content-between"
      >
          ...
          <ul class="cart-items-list m-0 list-inline">
            <li class="cart-item mb-4 pb-4 border-bottom">
              <div class="cart-item-block d-flex gap-3">
                ...
                <div
                  class="cart-block-content position-relative flex-grow-1 pe-5"
                >
                  <h6 class="mb-36 text-capitalize">
                    {{ $t("shop.believe_mask") }}
                  </h6>
                  ...
                  <div class="position-absolute top-0 end-0">
                    <a
                      ...
                      class="text-white delete-btn text-capitalize"
                      >{{ $t("shop.delete") }}</a
                    >
                  </div>
                </div>
            ...
            <li class="cart-item">
              <div class="cart-item-block d-flex gap-3">
                <div class="image flex-shrink-0">
                  <img
                    src="/assets/images/shop/product/05.webp"
                    width="90"
                    alt="product-image"
                    class="img-fluid object-cover"
                  />
        ...
        <div class="cart-progress-container mt-5 pt-5 border-top">
          ...
          >
            <h5 class="m-0 fw-bold">{{ $t("shop.subtotal") }}</h5>
            <h5 class="m-0 fw-bold">$49.00</h5>
          </div>
          <div class="d-grid gap-3 mt-4">
            <nuxt-link
              to="/merchandise/checkout"
              class="btn bg-primary text-uppercase fw-medium w-100 text-white"
            >
              <span class="button-text small">{{ $t("shop.checkout") }}</span>
            </nuxt-link>
            ...
            >
              <span class="button-text small">{{ $t("shop.view_cart") }}</span>
            </nuxt-link>
          </div>
        </div>
      </div>
