...
// React-bootstrap
import { Button, Nav, Toast, Tab } from "react-bootstrap";
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/toasts"
                  target="_blank"
                >
                  <svg
                    width="20"
              ...
              >
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-Toasts-prv"
                    type="button"
                    role="tab"
                ...
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    className=" d-flex align-items-center"
                    data-bs-toggle="tab"
                    data-bs-target="#content-Toasts-code"
                    type="button"
                    role="tab"
