...
//React-bootstrap
import { Form, Nav, Tab, Button, Container } from 'react-bootstrap'

// components
import Card from '../../components/bootstrap/card'

const AFormControls = memo(() => {
    return (
        <Fragment>
            <Container>
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <div className="d-flex align-items-center mt-2">
                                    <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/alternate-input" target="_blank">
                    ...
                    <Card className=" iq-document-card">
                        <Tab.Container defaultActiveKey="first">
                            <div className="d-flex justify-content-end">
                                <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab" role="tablist">
                                    <Nav.Item as="li" className="" role="presentation">
                                        <Nav.Link as="button" eventKey="first" className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-alternet-prv" type="button" role="tab" aria-controls="output" aria-selected="true">
                                            <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <Nav.Item as="li" className="" role="presentation">
                                        <Nav.Link as="button" eventKey="second" className=" d-flex align-items-center" data-bs-toggle="tab" data-bs-target="#content-alternet-code" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                            <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <Tab.Content className="">
                                <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-alternet-prv" role="tabpanel" aria-labelledby="typo-output">
                                    <div className="bd-example">
                                        <Form.Group className="form-group form-group-alt">
                                            <Form.Control type="text" className="" placeholder="Enter Text" />
                                        </Form.Group>
                                        <Form.Group className=" input-group form-group-alt form-group">
                                        ...
                                        <Form.Group className=" form-group-alt form-group">
                                ...
                                <Tab.Pane eventKey="second" className="tab-pane bd-heading-1 fade show" id="content-alternet-code" role="tabpanel" aria-labelledby="typo-output">
...
AFormControls.displayName = "AFormControls"
export default AFormControls;