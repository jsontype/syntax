      ...
      <div class="trending-info mt-4 pt-0 pb-4">
        <b-row>
          <div class="col-md-9 col-12 mb-auto">
            <div class="d-md-flex">
              <h2 class="trending-text fw-bold texture-text text-uppercase mt-0 fadeInLeft animated" data-animation-in="fadeInLeft" data-delay-in="0.6" style="opacity: 1; animation-delay: 0.6s">{{ $t('episode_page.football') }} 3</h2>
              <div class="slider-ratting d-flex align-items-center gap-2 ms-md-3 ms-0">
                ...
                <span class="text-white">3.3 <img src="/assets/images/movies/imdb-logo.svg" alt="imdb logo" loading="lazy" class="img-fluid ms-2" /></span>
              </div>
            </div>
      ...
      <div class="content-details trending-info">
        <ul class="iq-custom-tab tab-bg-gredient-center d-flex nav nav-pills align-items-center text-center mb-5 justify-content-center list-inline" role="tablist">
          <li class="nav-item" role="presentation">
            <a class="nav-link active show" data-bs-toggle="pill" href="#description-01" role="tab" aria-selected="true"> {{ $t('episode_page.description') }} </a>
          </li>
          <li class="nav-item" role="presentation">
            <a class="nav-link" data-bs-toggle="pill" href="#review-01" role="tab" aria-selected="false" tabindex="-1"> {{ $t('episode_page.rate') }} &amp; {{ $t('episode_page.review') }} </a>
          </li>
          <li class="nav-item" role="presentation">
        ...
        <div class="tab-content">
          <div id="description-01" class="tab-pane animated fadeInUp active show" role="tabpanel">
            <div class="description-content">
              <p>{{ $t('episode_page.episod_desc') }}</p>
            </div>
          </div>
            ...
            <div class="streamit-reviews">
              ...
              <div class="review_form">
                <div class="comment-respond">
                  <h3 class="fw-500 my-2">{{ $t('episode_page.first_review') }}</h3>
                  <b-row>
                    <b-col md="12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="comment" cols="5" rows="8"></textarea>
                      </div>
                    </b-col>
                    <b-col md="6">
                      <div class="form-group">
                    ...
                    <b-col md="12">
                      <div class="mt-3 mt-3 d-flex gap-2 align-items-center">
                        ...
                        <label class="form-check-label" for="check1"> {{ $t('episode_page.save_name') }} </label>
                      </div>
                    </b-col>
                    <b-col md="12">
                      <div class="form-submit mt-4">
                        <div class="iq-button">
                          <button name="submit" type="submit" class="btn text-uppercase position-relative" value="Submit">
                            <span class="button-text">{{ $t('episode_page.submit') }}</span>
                            {{ '' }}
    ...
    <b-container fluid>
      <div class="overflow-hidden">
        <div class="d-flex align-items-center justify-content-between px-3 pt-2 my-4">
          <h5 class="main-title text-capitalize mb-0">{{ $t('episode_page.latest_episodes') }}</h5>
        </div>
        <Swiper  :loop="true" :space-between="0" :slides-per-view="4" :modules="modules" :navigation="{ prevEl: '.swiper-button-prev', nextEl: '.swiper-button-next' }" class="position-relative wrapper-class" >
          <SwiperSlide>
            <div class="episode-block">
              <div class="block-image position-relative">
                <router-link :to="{ name: 'landing-page.episode' }">
                ...
                <div class="episode-play">
                  <router-link :to="{ name: 'landing-page.episode' }" tabindex="0"><i class="fa-solid fa-play"></i></router-link>
                </div>
              </div>
              <div class="epi-desc p-3">
                ...
                <router-link :to="{ name: 'landing-page.episode' }">
                  <h5 class="epi-name text-white mb-0">{{ $t('episode_page.zombie_island') }} 1</h5>
                </router-link>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div class="episode-block">
              ...
              <div class="epi-desc p-3">
                ...
                <router-link :to="{ name: 'landing-page.episode' }">
                  <h5 class="epi-name text-white mb-0">{{ $t('episode_page.zombie_island') }} 2</h5>
                </router-link>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div class="episode-block">
              ...
              <div class="epi-desc p-3">
                ...
                <router-link :to="{ name: 'landing-page.episode' }">
                  <h5 class="epi-name text-white mb-0">{{ $t('episode_page.zombie_island') }} 3</h5>
                </router-link>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div class="episode-block">
              ...
              <div class="epi-desc p-3">
                ...
                <router-link :to="{ name: 'landing-page.episode' }">
                  <h5 class="epi-name text-white mb-0">{{ $t('episode_page.zombie_island') }} 4</h5>
                </router-link>
              </div>
            </div>
          </SwiperSlide>
