        ...
        <b-card no-body>
          <b-card-header class="d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Simple Wizard</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
            <b-form id="form-wizard1" class="text-center mt-3">
              <ul id="top-tab-list" class="p-0 row list-inline">
                <li id="account" :class="`${currentindex == 1 ? 'active' : ''} ${currentindex > 1 ? 'done active' : ''} col-lg-3 col-md-6 mb-2 text-start `">
                ...
                <li id="personal" :class="`${currentindex == 2 ? 'active' : ''} ${currentindex > 2 ? 'done active' : ''} col-lg-3 col-md-6 mb-2 text-start `">
                  <a href="javascript:void(0);">
                    <div class="iq-icon me-3">
                      <svg class="icon-20 svg-icon" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li id="payment" :class="`${currentindex == 3 ? 'active' : ''} ${currentindex > 3 ? 'done active' : ''} col-lg-3 col-md-6 mb-2 text-start `">
                  <a href="javascript:void(0);">
                    <div class="iq-icon me-3">
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon-20 svg-icon" width="20" viewBox="0 0 24 24" fill="none">
                ...
                <li id="confirm" :class="`${currentindex == 4 ? 'active' : ''} ${currentindex > 4 ? 'done' : ''} col-lg-3 col-md-6 mb-2 text-start `">
                  <a href="javascript:void(0);">
                    <div class="iq-icon me-3">
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon-20 svg-icon" height="20" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div :class="`${currentindex == 1 ? 'show' : 'd-none'}`">
                <account-component @on-click="changeTab"></account-component>
              </div>
              <div :class="`${currentindex == 2 ? 'show' : 'd-none'}`">
                <personal-component @on-click="changeTab"></personal-component>
              </div>
              <div id="payment" :class="`${currentindex == 3 ? 'show' : 'd-none'}`">
                <image-component @on-click="changeTab"></image-component>
              </div>
              <div id="confirm" :class="`${currentindex == 4 ? 'show' : 'd-none'}`">
                <finish-component @on-click="changeTab"></finish-component>
              </div>
            </b-form>
          </b-card-body>
        </b-card>
