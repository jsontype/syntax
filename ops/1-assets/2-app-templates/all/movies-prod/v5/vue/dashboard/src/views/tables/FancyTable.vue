            ...
            <table class="table table-striped mb-0">
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/avatars/01.png" alt=""
                        loading="lazy" />
                  ...
                  <td>
                    <div class="d-flex gap-2 align-items-center">
                      <a v-b-tooltip="{ title: 'View' }" class="btn btn-sm btn-soft-warning rounded" href="#"><i
                          class="fa-solid fa-eye"></i></a>
                      <a v-b-tooltip="{ title: 'Edit' }" class="btn btn-sm btn-soft-success rounded" href="#"><i
                          class="fa-solid fa-pen"></i></a>
                      <a v-b-tooltip="{ title: 'Delete' }" class="btn btn-sm btn-soft-danger rounded" href="#"><i
                ...
                <tr>
                  ...
                  <td class="text-dark">256</td>
                  <td>
                    <span class="badge bg-soft-warning p-2 text-warning">Pending</span>
                  </td>
                  <td>
                    <div class="d-flex gap-2 align-items-center">
                      <a v-b-tooltip="{ title: 'View' }" class="btn btn-sm btn-soft-warning rounded" href="#"><i
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/avatars/02.png" alt=""
                        loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/avatars/03.png" alt=""
                        loading="lazy" />
                      <div class="media-support-info">
                  ...
                  <td class="text-dark">324</td>
                  <td>
                    <span class="badge bg-soft-success p-2 text-success">Complete</span>
                  </td>
                  <td>
                    <div class="d-flex gap-2 align-items-center">
                      <a v-b-tooltip="{ title: 'View' }" class="btn btn-sm btn-soft-warning rounded" href="#"><i
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/avatars/04.png" alt=""
                        loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/avatars/05.png" alt=""
                        loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/avatars/06.png" alt=""
                        loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/avatars/07.png" alt=""
                        loading="lazy" />
                      <div class="media-support-info">
                        <h5 class="iq-sub-label">Anne Teak</h5>
                        <p class="mb-0">@musk</p>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/avatars/08.png" alt=""
                        loading="lazy" />
                      <div class="media-support-info">
                        <h5 class="iq-sub-label">Anne Teak</h5>
                        <p class="mb-0">@musk</p>
