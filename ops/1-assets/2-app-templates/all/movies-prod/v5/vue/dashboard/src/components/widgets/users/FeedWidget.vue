      ...
      <div class="header-title float-start">
        <div class="d-flex flex-wrap">
          <div class="media-support-user-img me-3">
            <img
class="rounded-pill img-fluid avatar-60 bg-soft-danger p-1 ps-2" src="/assets/images/avatars/02.png "
              alt="" loading="lazy" />
          </div>
      ...
      <b-dropdown
text="29 mins " variant="none px-0" menu-class="dropdown-menu-end custom-dropdown"
        toggle-class="custom-toggle">
...
src="/assets/images/pages/03-page.jpg" alt="post-image" class="img-fluid"
            loading="lazy" /></a>
      </div>
...
fill="currentColor"
          ...
          <div class="share-block d-flex align-items-center feather-icon">
            <a
v-b-modal.share-btn href="javascript:void(0);" data-bs-toggle="offcanvas" data-bs-target="#share-btn"
...
fill="currentColor"
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non, feugiat
          non
          nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus</p>
        <hr />
        <ul class="list-inline p-0 m-0">
          <li class="mb-2">
            <div class="d-flex">
              <img
src="/assets/images/avatars/03.png" alt="userimg"
                class="avatar-50 p-1 pt-2 bg-soft-primary rounded-pill img-fluid" loading="lazy" />
              <div class="ms-3">
                <h6 class="mb-1">{{ person1 }}</h6>
...
fill="currentColor"
          ...
          <li>
            <div class="d-flex">
              <img
src="/assets/images/avatars/04.png" alt="userimg"
                class="avatar-50 p-1 pt-2 bg-soft-primary rounded-pill img-fluid" loading="lazy" />
              <div class="ms-3">
                <h6 class="mb-1">{{ person2 }}</h6>
                <p class="mb-1">Lorem ipsum dolor sit amet</p>
    ...
    <div class="card-header d-flex align-items-center justify-content-between pb-4">
      <div class="header-title float-start">
        <div class="d-flex flex-wrap">
          <div class="media-support-user-img me-3">
            <img
class="rounded-pill img-fluid avatar-60 p-1 bg-soft-info" src="/assets/images/avatars/05.png" alt=""
              loading="lazy" />
          </div>
          <div class="media-support-info mt-2">
      ...
      <b-dropdown
text="1 Hr " variant="none px-0" menu-class="dropdown-menu-end custom-dropdown"
        toggle-class="custom-toggle">
        <b-dropdown-item href="javascript:void(0);">Action</b-dropdown-item>
        <b-dropdown-item href="javascript:void(0);">Another action</b-dropdown-item>
        <b-dropdown-item href="javascript:void(0);">Something else here</b-dropdown-item>
    ...
    <div class="card-body p-0">
      <p class="p-3 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo
        non, feugiat non nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus</p>
      <div class="comment-area p-3">
        <hr class="mt-0" />
        <div class="d-flex flex-wrap justify-content-between align-items-center">
          <div class="d-flex align-items-center">
...
fill="currentColor"
          ...
          <div class="share-block d-flex align-items-center feather-icon">
            <a
v-b-modal.share-btn href="javascript:void(0);" data-bs-toggle="offcanvas"
...
<script>
import ShareOffcanvas from '../ShareOffcanvas.vue';
