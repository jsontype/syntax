  ...
  function H(t, b, o) {
    ...
    function D(t, e) {
      ...
      return (
        ...
        0 === e ? mt(n, b.cssClasses.handleLower) : e === b.handles - 1 && mt(n, b.cssClasses.handleUpper),
        r
      );
    }
    function M(t, e) {
    ...
    function H() {
      z(),
        (i = u.map(r)),
        $('update' + bt.tooltips, function (t, e, r) {
          if (i[e]) {
            var n = t[e];
    ...
    function j(e, i, o) {
      ...
      return (
        mt(s, b.cssClasses.pips),
        mt(s, 0 === b.ort ? b.cssClasses.pipsHorizontal : b.cssClasses.pipsVertical),
    ...
    function _(n, i, o, s) {
      var e = function (t) {
          return (
            ...
            !(O() && !s.doNotReject) &&
            ((e = h), (r = b.cssClasses.tap), !((e.classList ? e.classList.contains(r) : new RegExp('\\b' + r + '\\b').test(e.className)) && !s.doNotReject) && !(n === f.start && void 0 !== t.buttons && 1 < t.buttons) && (!s.hover || !t.buttons) && (d || t.preventDefault(), (t.calcPoint = t.points[b.ort]), void o(t, s)))
          );
          var e, r;
        },
        r = [];
    ...
    function Y(t, e) {
      e.handle && (gt(e.handle, b.cssClasses.active), (g -= 1)),
        e.listeners.forEach(function (t) {
          E.removeEventListener(t[0], t[1]);
        }),
        0 === g && (gt(h, b.cssClasses.drag), et(), t.cursor && ((C.style.cursor = ''), C.removeEventListener('selectstart', pt))),
    ...
    function I(t, e) {
      ...
      n.push.apply(n, i.concat(o, s)),
        t.cursor && ((C.style.cursor = getComputedStyle(t.target).cursor), 1 < u.length && mt(h, b.cssClasses.drag), C.addEventListener('selectstart', pt, !1)),
        e.handleNumbers.forEach(function (t) {
          J('start', t);
        });
    }
    ...
    function ot(t, e, r) {
      var n = ht(t),
        i = void 0 === S[0];
      (e = void 0 === e || !!e),
        b.animate && !i && ft(h, b.cssClasses.tap, b.animationDuration),
        m.forEach(function (t) {
          rt(t, it(n[t], t), !0, !1, r);
        });
    ...
    return (
      mt((e = h), b.cssClasses.target),
      0 === b.dir ? mt(e, b.cssClasses.ltr) : mt(e, b.cssClasses.rtl),
      0 === b.ort ? mt(e, b.cssClasses.horizontal) : mt(e, b.cssClasses.vertical),
      mt(e, 'rtl' === getComputedStyle(e).direction ? b.cssClasses.textDirectionRtl : b.cssClasses.textDirectionLtr),
      ...
      b.tooltips && H(),
      G('update' + bt.aria),
      $('update' + bt.aria, function (t, e, s, r, a) {
        m.forEach(function (t) {
          var e = u[t],
            r = K(S, t, 0, !0, !0, !0),
            n = K(S, t, 100, !0, !0, !0),
