                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    <div class="d-flex flex-wrap align-items-center">
                        <div class="profile-img position-relative me-3 mb-3 mb-lg-0 profile-logo profile-logo1">
                            ...
                            <img src="{{ asset('dashboard/images/avatars/06.png') }}" alt="User-Profile"
            ...
            <div class="card-body">
                <ul class="list-inline m-0 p-0">
                    <li class="d-flex mb-2">
                        ...
                        <p class="news-detail mb-0">there is a meetup in your city on fryday at 19:00. <a href="#">see
                                details</a></p>
                    </li>
                    <li class="d-flex">
                        <div class="news-icon me-3">
            ...
            <div class="card-body">
                <div class="d-grid gap-card grid-cols-3">
                    <a data-fslightbox="gallery" href="{{ asset('dashboard/images/icon/04.png') }}">
                        <img src="{{ asset('dashboard/images/icon/04.png') }}" class="img-fluid bg-soft-info rounded"
                            alt="profile-image" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="{{ asset('dashboard/images/shapes/02.png') }}">
                        <img src="{{ asset('dashboard/images/shapes/02.png') }}"
                            class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="{{ asset('dashboard/images/icon/08.png') }}">
                        <img src="{{ asset('dashboard/images/icon/08.png') }}" class="img-fluid bg-soft-info rounded"
                            alt="profile-image" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="{{ asset('dashboard/images/shapes/04.png') }}">
                        <img src="{{ asset('dashboard/images/shapes/04.png') }}"
                            class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="{{ asset('dashboard/images/shapes/03.png') }}">
                        <img src="{{ asset('dashboard/images/shapes/03.png') }}"
                            class="img-fluid bg-soft-warning rounded" alt="profile-image" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="{{ asset('dashboard/images/shapes/06.png') }}">
                        <img src="{{ asset('dashboard/images/shapes/06.png') }}"
                            class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="{{ asset('dashboard/images/shapes/05.png') }}">
                        <img src="{{ asset('dashboard/images/shapes/05.png') }}"
                            class="img-fluid bg-soft-danger rounded" alt="profile-image" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="{{ asset('dashboard/images/shapes/04.png') }}">
                        <img src="{{ asset('dashboard/images/shapes/04.png') }}"
                            class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy">
                    ...
                    <a data-fslightbox="gallery" href="{{ asset('dashboard/images/icon/01.png') }}">
                        <img src="{{ asset('dashboard/images/icon/01.png') }}" class="img-fluid bg-soft-success rounded"
                            alt="profile-image" loading="lazy">
                    </a>
                </div>
            </div>
                ...
                <div class="twit-feed">
                    <div class="d-flex align-items-center mb-2">
                        <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-danger ps-2"
                            src="{{ asset('dashboard/images/avatars/03.png') }}" alt="" loading="lazy">
                ...
                <div class="twit-feed">
                    <div class="d-flex align-items-center mb-2">
                        <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-primary"
                            src="{{ asset('dashboard/images/avatars/04.png') }}" alt="" loading="lazy">
                        <div class="media-support-info">
                ...
                <div class="twit-feed">
                    <div class="d-flex align-items-center mb-2">
                        <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-warning pt-2"
                            src="{{ asset('dashboard/images/avatars/02.png') }}" alt="" loading="lazy">
                        <div class="mt-2">
            ...
            <div id="profile-feed" class="tab-pane fade active show">
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <div class="user-post">
                            <a href="javascript:void(0);"><img src="{{ asset('dashboard/images/pages/03-page.jpg') }}"
                        ...
                        <div class="comment-area p-3">
                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                ...
                                <div class="share-block d-flex align-items-center feather-icon me-3">
                                    <a href="javascript:void(0);" data-bs-toggle="offcanvas" data-bs-target="#share-btn"
                            ...
                            <ul class="list-inline p-0 m-0">
                                <li class="mb-2">
                                    <div class="d-flex">
                                        <img src="{{ asset('dashboard/images/avatars/03.png') }}" alt="userimg"
                                ...
                                <li>
                                    <div class="d-flex">
                                        <img src="{{ asset('dashboard/images/avatars/04.png') }}" alt="userimg"
                                            class="avatar-50 p-1 bg-soft-danger rounded-pill img-fluid" loading="lazy">
                                        <div class="ms-3">
                ...
                <div class="card">
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="media-support-user-img me-3">
                                    <img class="rounded-pill img-fluid avatar-60 p-1 bg-soft-info"
                                        src="{{ asset('dashboard/images/avatars/05.png') }}" alt="" loading="lazy">
                                </div>
                                <div class="media-support-info mt-2">
                    ...
                    <div class="card-body p-0">
                        <p class="p-3 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor,
                            ornare at commodo non, feugiat non nisi. Phasellus faucibus mollis pharetra. Proin blandit
                            ac massa sed rhoncus</p>
                        <div class="comment-area p-3">
                            <hr class="mt-0">
                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                    ...
                    <div class="card-body">
                        <ul class="list-inline m-0 p-0">
                            <li class="d-flex mb-4 align-items-center">
                                <img src="{{ asset('dashboard/images/avatars/01.png') }}" alt="story-img"
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <img src="{{ asset('dashboard/images/avatars/05.png') }}" alt="story-img"
                                    class="rounded-pill avatar-40" loading="lazy">
                                <div class="ms-3 flex-grow-1">
                                    <h6>Paul Molive</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <img src="{{ asset('dashboard/images/avatars/02.png') }}" alt="story-img"
                                    class="rounded-pill avatar-40" loading="lazy">
                                <div class="ms-3 flex-grow-1">
                                    <h6>Anna Mull</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <img src="{{ asset('dashboard/images/avatars/03.png') }}" alt="story-img"
                                    class="rounded-pill avatar-40" loading="lazy">
                                <div class="ms-3 flex-grow-1">
                                    <h6>Paige Turner</h6>
                                    <p class="mb-0">trainee</p>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <img src="{{ asset('dashboard/images/avatars/04.png') }}" alt="story-img"
                                    class="rounded-pill avatar-40" loading="lazy">
                                <div class="ms-3 flex-grow-1">
                                    <h6>Barb Ackue</h6>
                                    <p class="mb-0">Web Designer</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div>
                                <img src="{{ asset('dashboard/images/avatars/01.png') }}" alt="profile-img"
                                    class="rounded-pill avatar-130 img-fluid" loading="lazy">
                            </div>
                            <div class="mt-3">
            ...
            <div class="card-body">
                <ul class="list-inline m-0 p-0">
                    <li class="d-flex mb-4 align-items-center active">
                        <img src="{{ asset('dashboard/images/shapes/02.png') }}" alt="story-img"
                            class="rounded-pill avatar-70 p-1 border bg-soft-light img-fluid" loading="lazy">
                        <div class="ms-3">
                            <h5>Web Design</h5>
                    ...
                    <li class="d-flex mb-4 align-items-center">
                        <img src="{{ asset('dashboard/images/shapes/04.png') }}" alt="story-img"
                            class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger" loading="lazy">
                        <div class="ms-3">
                            <h5>App Design</h5>
                    ...
                    <li class="d-flex align-items-center">
                        <img src="{{ asset('dashboard/images/shapes/06.png') }}" alt="story-img"
                            class="rounded-pill avatar-70 p-1 border bg-soft-primary img-fluid" loading="lazy">
                        <div class="ms-3">
                ...
                <ul class="list-inline m-0 p-0">
                    <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-warning rounded-pill"><img
                                src="{{ asset('dashboard/images/avatars/02.png') }}" alt="story-img"
                    ...
                    <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-danger rounded-pill"><img
                                src="{{ asset('dashboard/images/avatars/03.png') }}" alt="story-img"
                                class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                            <h6>Robert Fox</h6>
                            <p class="mb-0">4 mutual friends</p>
                    ...
                    <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-dark rounded-pill"><img
                                src="{{ asset('dashboard/images/avatars/04.png') }}" alt="story-img"
                                class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                            <h6>Jenny Wilson</h6>
                    ...
                    <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-primary rounded-pill"><img
                                src="{{ asset('dashboard/images/avatars/05.png') }}" alt="story-img"
                                class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                            <h6>Cody Fisher</h6>
                    ...
                    <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-info rounded-pill"><img
                                src="{{ asset('dashboard/images/avatars/06.png') }}" alt="story-img"
                                class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                            <h6>Bessie Cooper</h6>
                    ...
                    <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-warning rounded-pill"><img
                                src="{{ asset('dashboard/images/avatars/07.png') }}" alt="story-img"
                                class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                            <h6>Wade Warren</h6>
                    ...
                    <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-success rounded-pill"><img
                                src="{{ asset('dashboard/images/avatars/08.png') }}" alt="story-img"
                                class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                            <h6>Guy Hawkins</h6>
                    ...
                    <li class="d-flex align-items-center">
                        <div class="img-fluid bg-soft-info rounded-pill"><img
                                src="{{ asset('dashboard/images/avatars/09.png') }}" alt="story-img"
                                class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                            <h6>Floyd Miles</h6>
