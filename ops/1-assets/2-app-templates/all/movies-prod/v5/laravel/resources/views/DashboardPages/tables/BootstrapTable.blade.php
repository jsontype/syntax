       ...
       <div class="card">
          <div class="card-header d-flex justify-content-between">
             <div class="header-title">
                <h4 class="card-title">{{__('table.basic_table')}}</h4>
             </div>
          </div>
                   ...
                   <tbody>
                      <tr>
                         <td>
                            <div class="d-flex align-items-center">
                               <img class="rounded img-fluid avatar-40 me-3 bg-soft-primary" loading="lazy"
                                              src="{{ asset('dashboard/images/shapes/01.png') }}" alt="profile">
                      ...
                      <tr>
                         <td>
                            <div class="d-flex align-items-center">
                               <img class="rounded img-fluid avatar-40 me-3 bg-soft-primary" loading="lazy"
                                              src="{{ asset('dashboard/images/shapes/02.png') }}" alt="profile">
                      ...
                      <tr>
                         <td>
                            <div class="d-flex align-items-center">
                                <img class="rounded img-fluid avatar-40 me-3 bg-soft-primary" loading="lazy"
                                              src="{{ asset('dashboard/images/shapes/03.png') }}" alt="profile">
                      ...
                      <tr>
                         <td>
                            <div class="d-flex align-items-center">
                               <img class="rounded img-fluid avatar-40 me-3 bg-soft-primary" loading="lazy"
                                              src="{{ asset('dashboard/images/shapes/04.png') }}" alt="profile">
                      ...
                      <tr>
                         <td>
                            <div class="d-flex align-items-center">
                               <img class="rounded img-fluid avatar-40 me-3 bg-soft-primary" loading="lazy"
                                              src="{{ asset('dashboard/images/shapes/06.png') }}" alt="profile">
