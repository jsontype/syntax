          ...
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between">
                   ...
                   <div>
                      <span>{{__('widgets.Net_Worth')}}</span>
                   </div>
                </div>
                <div class="text-center">
                   ...
                   <div>
                      ...
                      <span>{{__('widgets.Increased')}}</span>
                   </div>
                </div>
             </div>
             <div id="chart-1"></div>
          ...
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between">
                   ...
                   <div>
                      <span>{{__('widgets.Todays_Gains')}}</span>
                   </div>
                </div>
                <div class="text-center">
                      <h2 class="counter">65M</h2>
          ...
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between">
                   ...
                   <div>
                      <span>{{__('widgets.Total_Users')}}</span>
                   </div>
                </div>
                <div class="text-center">
          ...
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between">
                   ...
                   <div>
                      <span>{{__('widgets.Orders_Received')}}</span>
                   </div>
                </div>
                <div class="text-center">
          ...
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between">
                   ...
                   <div>
                      <span>{{__('widgets.Total_Sales')}}</span>
                   </div>
                </div>
          ...
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between">
                   ...
                   <div>
                      <span>{{__('widgets.Sales_Today')}}</span>
                   </div>
                </div>
                <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between">
                   ...
                   <div>
                      <span>{{__('widgets.Total_Classon')}}</span>
                   </div>
                </div>
                <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between">
                   ...
                   <div>
                      <span>{{__('widgets.Total_Profit')}}</span>
                   </div>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                   <div>
          ...
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                   <div>
                      <span>{{__('widgets.Invoice_Sent')}}</span>
                   </div>
                   <div>
       ...
       <div class="col-lg-3">
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                   <div>
                      <span>{{__('widgets.Credited_From_Accounts')}}</span>
                   </div>
                   <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
                         <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
       ...
       <div class="col-lg-3">
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                   <div>
                      <span>{{__('widgets.AVG_Employee_Costs')}}</span>
                   </div>
                   <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
                         <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
       ...
       <div class="col-lg-3">
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                   <div>
                      <span>{{__('widgets.Average_payment_delay')}}</span>
                   </div>
                   <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
                         <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
    ...
    <div class="row">
             ...
             <div class="card-body iq-box-relative">
                <div class="iq-service d-flex align-items-center justify-content-between" style="position: relative;">
                   <div class="service-data">
                      ...
                      <p class="mb-0">{{__('widgets.Service_used')}}</p>
                   </div>
          ...
          <div class="card">
             <div class="card-body iq-box-relative">
                <div class="iq-service d-flex align-items-center justify-content-between" style="position: relative;">
                   <div class="service-data">
                      <h3>2.5</h3>
                      <p class="mb-0">{{__('widgets.GB_Stored')}}</p>
                   </div>
          ...
          <div class="card">
             <div class="card-body iq-box-relative">
                <div class="iq-service d-flex align-items-center justify-content-between" style="position: relative;">
                   <div class="service-data">
                      <h3>351</h3>
                      <p class="mb-0">{{__('widgets.user_collect')}}</p>
                   </div>
          ...
          <div class="card">
             <div class="card-body iq-box-relative">
                <div class="iq-service d-flex align-items-center justify-content-between" style="position: relative;">
                   <div class="service-data">
                      <h3>4,852</h3>
                      <p class="mb-0">{{__('widgets.Visitors')}}</p>
                   </div>
       ...
       <div class="col-lg-12 row m-0 p-0 iq-duration-block">
          ...
          <div class="col-sm-6 col-md-6 col-lg-2">
             <div class="card">
                <div class="card-body">
                   ...
                   <div class="mt-4">
                      <h2>3.07s</h2>
                      <p>{{__('widgets.Processing_time')}}</p>
                   </div>
          ...
          <div class="col-md-12 col-lg-4">
             <div class="card">
                <div class="card-body">
                   <h4 class="text-uppercase  mb-0">{{__('widgets.SESSION_NOW')}}</h4>
                   <div class="d-flex justify-content-between align-items-center mt-2">
                      <h2 class=" ">12</h2>
                      <div class="text-start">
                         <p class="m-0 text-uppercase">1 {{__('widgets.HOURS_AGO')}}</p>
                         <div class="mb-1 ">1500<span class="text-danger">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                               <path d="M12.2744 19.75V4.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                               <path d="M18.299 13.7002L12.275 19.7502L6.25 13.7002" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                            3.25%</span>
                         </div>
                         <p class="m-0 text-uppercase">1 {{__('widgets.DAY_AGO')}}</p>
                         <div class="mb-1 ">1890<span class="text-success">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                               <path d="M11.7261 4.25L11.7261 19.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                               <path d="M5.70149 10.2998L11.7255 4.2498L17.7505 10.2998" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                            1.00%</span>
                         </div>
                         <p class="m-0 text-uppercase">1 {{__('widgets.WEEK_AGO')}}</p>
                         <div  >1260<span class="text-danger">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                               <path d="M12.2744 19.75V4.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                               <path d="M18.299 13.7002L12.275 19.7502L6.25 13.7002" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
          ...
          <div class="card">
             <div class="card-body">
                <div class="d-flex flex-column">
                   <div class="mb-3">
                      <h2>{{__('widgets.Analytics')}}</h2>
                      <span class="text-primary">{{__('widgets.Status')}}</span>
                   </div>
          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                   <h4 class="card-title">{{__('widgets.Upcoming')}}</h4>
                </div>
             </div>
             <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
                   <div>
                      <h5>{{__('widgets.Psychology_Exam')}}</h5>
                      <p>{{__('widgets.carry_out_writing_exam_in_school')}}</p>
                   </div>
                   <div>
                      <span class="text-danger">19 jan</span>
                      <p>45 {{__('widgets.Minutes')}}</p>
                   </div>
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
                   <div>
                      <h5>{{__('widgets.Mathematics_Toory')}}</h5>
                      <p>{{__('widgets.carry_out_writing_exam_in_school')}}</p>
                   </div>
                   <div>
                      <span class="text-danger">20 Jan</span>
                      <p>35 {{__('widgets.Minutes')}}</p>
                   </div>
                   <button type="button" class="btn btn-outline-danger btn-sm">
                      <span class="btn-inner">
                         <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
                   <div>
                      <h5>{{__('widgets.Literature_Exam')}}</h5>
                      <p>{{__('widgets.carry_out_writing_exam_in_school')}}</p>
                   </div>
                   <div>
                      <span class="text-danger">21 Jan</span>
                      <p>50 {{__('widgets.Minutes')}}</p>
                   </div>
                   <button type="button" class="btn btn-outline-danger btn-sm">
                      <span class="btn-inner">
                         <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                   <div>
                      <h5>{{__('widgets.Mathematics_Exam')}}</h5>
                      <p>{{__('widgets.carry_out_writing_exam_in_school')}}</p>
                   </div>
                   <div>
                      <span class="text-danger">22 jan</span>
                      <p>60 {{__('widgets.Minutes')}}</p>
                   </div>
                   <button type="button" class="btn btn-outline-danger btn-sm">
                      <span class="btn-inner">
                         <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
