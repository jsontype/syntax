                            ...
                            <div class="w-full lg:w-1/2">
                                <div class="py-16 md:py-24" data-aos="fade-up">
                                    ...
                                    <div class="flex flex-wrap items-center gap-5 pt-12 md:pt-20 md:gap-12">
                                        ...
                                        <div class="space-y-3 text-center">
                                            <p class="text-2xl font-semibold" data-vanilla-counter data-start-at="0" data-end-at="590" data-time="1000" data-delay="0" data-format="{}+">
                                                <count-to :startVal='0' :endVal='590' :duration='3000'></count-to>+
                                            </p>
                                            <p class="text-gray">Project Done</p>
                                        </div>
                                        <div class="space-y-3 text-center">
                                            <p class="text-2xl font-semibold" data-vanilla-counter data-start-at="0" data-end-at="12" data-time="1000" data-delay="0" data-format="{}+">
