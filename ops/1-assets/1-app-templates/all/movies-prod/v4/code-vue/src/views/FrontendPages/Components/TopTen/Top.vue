      ...
      <b-row>
         <b-col sm="12" class="overflow-hidden">
            ...
            <div class="topten-contens">
               ...
               <Slick id="top-ten-slider"  class="list-inline p-0 m-0  d-flex align-items-center iq-rtl-direction" :option="sliderOption1">
                  <li class="slick-bg"  v-for="(slider,index) in topTenSlider" :key="index">
                        <img :src="slider" class="img-fluid w-100" alt="">
                  </li>
               </Slick>
               <div class="vertical_s">
                  <Slick class="list-inline p-0 m-0  d-flex align-items-center iq-rtl-direction" id="top-ten-slider-nav" :option="sliderOption2">
                        ...
                        <div class="block-images position-relative">
                           ...
                           <div class="block-description">
                              ...
                              <div class="hover-buttons">
                                 <router-link :to="{ name: 'landing-page.movie-detail' }" class="btn btn-hover" tabindex="0">
