        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-1" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="breadcrumb-1" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-2" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="breadcrumb-icon-1" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-3" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="breadcrumb-2" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-4" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="breadcrumb-icon-2" class="text-white">
                    <code>
&#x3C;nav aria-label=&#x22;breadcrumb&#x22;&#x3E;
  &#x3C;ol class=&#x22;breadcrumb bg-primary&#x22;&#x3E;
...
&#x3C;/nav&#x3E;
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-primary">
                <li class="breadcrumb-item">
                  <a href="#" class="text-white"><i class="ri-home-4-line mr-1 float-left" />Home</a>
                </li>
                <li class="breadcrumb-item active text-white" aria-current="page">
                  Library
                </li>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-5" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="breadcrumb-icon-3" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-6" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="breadcrumb-icon-4" class="text-white">
                    <code>
&#x3C;nav aria-label=&#x22;breadcrumb&#x22;&#x3E;
  ...
  &#x3C;/nav&#x3E;
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb iq-bg-danger">
                <li class="breadcrumb-item">
                  <a href="#" class="text-danger"><i class="ri-home-4-line mr-1 float-left" />Home</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">
                  Library
                </li>
