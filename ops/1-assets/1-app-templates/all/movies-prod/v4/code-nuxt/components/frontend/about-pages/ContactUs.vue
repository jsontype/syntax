          ...
          <div class="col-md-6">
            <div class="text-center">
              <img
                width="497"
                height="477"
                src="@/assets/images/frontend/about-us/06.jpg"
          ...
          <div class="col-md-6">
            <div class=" text-left iq-title-box iq-title-default">
              ...
              <p class="iq-title-desc">
                Streamit is located in Los Angeles city and you can contact us at <a href="#">hello@streamit.com</a> for any tech-related support and assistance. We love to hear from our Streamit users.
              </p>
