...
class UserController extends Controller
{
    ...
    {
        $pageTitle = trans('global.global-message.list_form_title',['form' => trans('users.title')] );
        $auth_user = AuthHelper::authSession();
        $assets = ['data-table'];
        $headerAction = '<a href="'.route('users.create').'" class="btn btn-sm btn-primary" role="button">Add User</a>';
        return $dataTable->render('dashboard.global.datatable', compact('pageTitle','auth_user','assets', 'headerAction'));
    }
    ...
    public function show($id)
    {
        ...
        return view('dashboard.users.profile', compact('data', 'profileImage'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.users.form', compact('data','id', 'roles', 'profileImage'));
    }
    ...
    public function update(UserRequest $request, $id)
    {
        ...
        if(auth()->check()){
            return redirect()->route('users.index')->withSuccess(trans('users.update'));
        }
