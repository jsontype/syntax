      ...
      <div class="row justify-content-center align-items-center height-self-center vh-100">
        <div class="col-lg-5 col-md-12 align-self-center">
          <div class="user-login-card bg-body">
            ...
            <form action="post">
              <div class="mb-3">
                <label class="text-white fw-500 mb-2">{{ $t('form.username_or_email') }}</label>
              ...
              <div class="text-end mb-3">
                <router-link :to="{ name: 'landing-page.lost-password' }" class="text-primary fw-semibold fst-italic">{{ $t('form.forgot_password?') }}</router-link>
              </div>
              <label class="list-group-item d-flex align-items-center mb-3 font-size-14 text-white fw-500"><input class="form-check-input m-0 me-2" type="checkbox" />{{ $t('shop.remember_me') }}</label>
            ...
            <p class="my-4 text-center fw-500 text-white">
              {{ $t('form.new_to_streamit') }} <router-link :to="{ name: 'landing-page.sing-up-page' }" class="text-primary ms-1">{{ $t('shop.register') }}</router-link>
            </p>
