...
<div>
    <div class="row">
       <div class="col-lg-3 col-md-6">
          <div class="card">
             <div class="card-body">
                <div class="text-center">{{__('widgets.AVG_Impressions')}}</div>
       ...
       <div class="col-lg-3 col-md-6">
          <div class="card">
             <div class="card-body">
                <div class="text-center">{{__('widgets.AVG_Engagements_Rate')}}</div>
                <div class="d-flex align-items-center justify-content-between mt-3">
                   <div>
                         <h2 class="counter">2.648</h2>
                      26.84%
       ...
       <div class="col-lg-3 col-md-6">
          <div class="card">
             <div class="card-body">
                <div class="text-center">{{__('widgets.AVG_Reach')}}</div>
                <div class="d-flex align-items-center justify-content-between mt-3">
                   <div>
                         <h2 class="counter">2.648</h2>
                      26.84%
       ...
       <div class="col-lg-3 col-md-6">
          <div class="card">
             <div class="card-body">
                <div class="text-center">{{__('widgets.AVG_Transport')}}</div>
                <div class="d-flex align-items-center justify-content-between mt-3">
                   <div>
                         <h2 class="counter">2.648</h2>
                      26.84%
       ...
       <div class="col-lg-3 col-md-6">
          <div class="card border-bottom border-4 border-0 border-primary">
             <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                   <div>
                      <span>{{__('widgets.Worked_Today')}}</span>
                   </div>
                   <div>
                      <span>08:00 Hr</span>
                   </div>
       ...
       <div class="col-lg-3 col-md-6">
          <div class="card border-bottom border-4 border-0 border-info">
             <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                   <div>
                      <span>{{__('widgets.Worked_Week')}}</span>
                   </div>
                   <div>
                      <span>40:00 Hr</span>
                   </div>
       ...
       <div class="col-lg-3 col-md-6">
          <div class="card border-bottom border-4 border-0 border-danger">
             <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                   <div>
                      <span>{{__('widgets.Worked_Issue')}}</span>
                   </div>
                   <div>
       ...
       <div class="col-lg-3 col-md-6">
          <div class="card border-bottom border-4 border-0 border-warning">
             <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                   <div>
                      <span>{{__('widgets.Worked_Income')}}</span>
                   </div>
                   <div>
          ...
          <div class="card">
             <div class="card-body">
                <div class="d-flex justify-content-between align-itmes-center">
                   ...
                   <div>
                      <h1>21K</h1>
                      <p class="mb-0">{{__('widgets.Order_Served')}}</p>
                   </div>
                   <div>
             ...
             <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                   ...
                   <div>
                      ...
                      <p class="text-success mb-0">{{__('widgets.Total_Earning')}}</p>
                   </div>
                </div>
             </div>
          </div>
          ...
          <div class="card">
             <div class="card-body">
                <div class="d-flex align-items-center">
                   ...
                   <div class="ms-4">
                      <h5 class="mb-1">{{__('widgets.Positive_Reviews')}}</h5>
                      <div>
       ...
       <div class="col-lg-4">
          <div class="card">
             <div class="card-body">
                ...
                <p class="mb-2">{{__('widgets.Your_Current_Balance')}}</p>
                <h6>20% ($520)</h6>
                <a href="#" class="mt-4 btn btn-danger d-block rounded">{{__('widgets.Add_credit')}}</a>
                <div class="mt-3">
                   <div class="pb-3">
                      <div class="d-flex align-items-center justify-content-between mb-2">
                         <p class="mb-0">{{__('widgets.Insurance')}}</p>
                         <h4>18</h4>
                      </div>
                   ...
                   <div class="pb-3">
                      <div class="d-flex align-items-center justify-content-between mb-2">
                         <p class="mb-0">{{__('widgets.Savings')}}</p>
                         <h4>124</h4>
                      </div>
                   ...
                   <div class="pb-3">
                      <div class="d-flex align-items-center justify-content-between mb-2">
                         <p class="mb-0">{{__('widgets.Investment')}}</p>
                         <h4>74</h4>
                      </div>
                      <div class="progress bg-primary-subtle shadow-none w-100" style="height: 10px">
                         <div class="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="74" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                   </div>
                   <div>
                      <div class="d-flex align-items-center justify-content-between mb-2">
                         <p class="mb-0">{{__('widgets.Progress')}}</p>
                         <h4>89</h4>
                      </div>
                      <div class="progress bg-success-subtle shadow-none w-100" style="height: 10px">
       ...
       <div class="col-lg-4">
          ...
          <div class="card">
             <div class="card-body p-3">
                <h5>{{__('widgets.Working_Capital')}}</h5>
                <div class="text-center">
                ...
                <div class="card">
                   <div class="card-body">
                      <div class="d-flex justify-content-between">
                         <div>
                            <span><b>{{__('widgets.Revenue')}}</b></span>
                            <div class="mt-2">
                               <h2 class="counter">$35000</h2>
                            </div>
                         </div>
                         <div>
                            <span class="badge bg-primary">{{__('widgets.Monthly')}}</span>
                         </div>
                      </div>
                      <div class="d-flex justify-content-between mt-2">
                         <div>
                            <span>{{__('widgets.Total_Revenue')}}</span>
                         </div>
                         <div>
                            <span>35%</span>
                         </div>
             ...
             <div class="col-md-6">
                <div class="card">
                   <div class="card-body">
                      <div class="d-flex justify-content-between">
                         <div>
                            <span><b>{{__('widgets.Orders')}}</b></span>
                            <div class="mt-2">
                               <h2 class="counter">2500</h2>
                            </div>
                         </div>
                         <div>
                            <span class="badge bg-warning">{{__('widgets.Anual')}}</span>
                         </div>
                      </div>
                      <div class="d-flex justify-content-between mt-2">
                         <div>
                            <span>{{__('widgets.New_Orders')}}</span>
                         </div>
                         <div>
                            <span>24%</span>
                         </div>
             ...
             <div class="col-md-6">
                <div class="card">
                   <div class="card-body">
                      <div class="d-flex justify-content-between">
                         <div>
                            <span><b>{{__('widgets.Leads')}}</b></span>
                            <div class="mt-2">
                               <h2 class="counter">$35000</h2>
                            </div>
                         </div>
                         <div>
                            <span class="badge bg-danger">{{__('widgets.Today')}}</span>
                         </div>
                      </div>
                      <div class="d-flex justify-content-between mt-2">
                         <div>
                            <span>{{__('widgets.New_Leads')}}</span>
                         </div>
                         <div>
                            <span>50%</span>
                         </div>
             ...
             <div class="col-md-6">
                <div class="card">
                   <div class="card-body">
                      <div class="d-flex justify-content-between">
                         <div>
                            <span><b>{{__('widgets.Conversion')}}</b></span>
                            <div class="mt-2">
                               <h2 class="counter">35%</h2>
                            </div>
                         </div>
                         <div>
                            <span class="badge bg-info">{{__('widgets.This_Month')}}</span>
                         </div>
                      </div>
                      <div class="d-flex justify-content-between mt-2">
                         <div>
                            <span>{{__('widgets.This_Month')}}</span>
                         </div>
                         <div>
          ...
          <div class="card">
             <div class="card-body">
                <div class="border-bottom text-center pb-3">
                  <img src="{{ asset('dashboard/images/avatars/01.png') }}" alt="User-Profile" loading="lazy"
                                 class="theme-color-default-img img-fluid avatar-80 mb-4">
                             <img src="{{ asset('dashboard/images/avatars/avtar_1.png') }}" alt="User-Profile" loading="lazy"
                                 class="theme-color-purple-img img-fluid avatar-80 mb-4">
                             <img src="{{ asset('dashboard/images/avatars/avtar_2.png') }}" alt="User-Profile" loading="lazy"
                                 class="theme-color-blue-img img-fluid avatar-80 mb-4">
                             <img src="{{ asset('dashboard/images/avatars/avtar_4.png') }}" alt="User-Profile" loading="lazy"
                                 class="theme-color-green-img img-fluid avatar-80 mb-4">
                             <img src="{{ asset('dashboard/images/avatars/avtar_5.png') }}" alt="User-Profile" loading="lazy"
                                 class="theme-color-yellow-img img-fluid avatar-80 mb-4">
                             <img src="{{ asset('dashboard/images/avatars/avtar_3.png') }}" alt="User-Profile" loading="lazy"
                                 class="theme-color-pink-img img-fluid avatar-80 mb-4">
                   <div>
                      <h5 class="mb-3">{{__('widgets.Bini_Jets')}}</h5>
                   </div>
                   <p>{{__('widgets.Lorem_ipsum_dolor_sit_amet_consectetur_adipiscing_elit')}}</p>
                   <button type="button" class="btn btn-info mb-2">{{__('widgets.Assign')}}</button>
                </div>
                <div class="d-flex justify-content-between mt-3">
                   <div>
                         <h2 class="mb-0 counter">4500</h2>
                      <div>{{__('widgets.Operations')}}</div>
                   </div>
                   <div>
                         <h2 class="mb-0">3.9</h2>
                      <div>{{__('widgets.Medical_Rating')}}</div>
                   </div>
                </div>
             </div>
          </div>
