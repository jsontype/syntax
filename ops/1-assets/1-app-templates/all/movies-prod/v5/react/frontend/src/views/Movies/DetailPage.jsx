...
const MovieDetail = memo(() => {
  ...
  return (
    <Fragment>
                ...
                <Row>
                  <Col md="9" className="mb-auto">
                    ...
                    <div className="d-flex flex-wrap align-items-center text-white text-detail flex-wrap mb-4">
                      <span className="badge bg-secondary">{t('home.horror')}</span>
      ...
      <MoviesRecommendedForYou slides={5} viewAll={false} slideMedium={2} paddingY="my-4 pt-2" />
      <RelatedMovies viewAll={false} slideMedium={2} paddingY="my-4 pt-2" />
      <RelatedVideos viewAll={false} slideMedium={2} paddingY="my-4 pt-2" />
      <UpcomingMovies viewAll={false} title="home.upcoming" slideMedium={2} slides={5} paddingY="my-4 pt-2" />
      <FsLightbox
