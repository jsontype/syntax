...
// React-bootstrap
import { Button, Nav, Tab, Spinner } from "react-bootstrap";

// components
import Card from "../../components/bootstrap/card";

const Spinners = React.memo(() => {
  return (
    <Fragment>
      <article id="spinners">
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/spinners"
                  target="_blank"
                >
                  <svg
                    width="20"
              ...
              >
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-Spinners-prv"
                    type="button"
                    role="tab"
                ...
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    className=" d-flex align-items-center"
                    data-bs-toggle="tab"
                    data-bs-target="#content-Spinners-code"
                    type="button"
                    role="tab"
