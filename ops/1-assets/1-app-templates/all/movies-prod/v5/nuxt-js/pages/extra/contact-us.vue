      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="contact-box d-flex gap-3 rounded mb-3 mb-lg-0">
            ...
            <div style="z-index: 1">
              <h6 class="font-size-18 fw-500 mb-4">
                {{ $t("contact_us.general_enquiries") }}
              </h6>
              <p class="mb-1 font-size-14">
                {{ $t("contact_us.call_on") }}
                <span class="text-primary">(144) 1234 4567</span>
              </p>
              <p class="mb-0">
                {{ $t("contact_us.mail") }}
                <a href="mailto:info@medyapim.com" class="text-white fw-500"
                  >info@enquiries.com</a
                >
              </p>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="contact-box d-flex gap-3 rounded mb-3 mb-lg-0">
            ...
            <div style="z-index: 1">
              ...
              <p class="mb-1 font-size-14">
                {{ $t("contact_us.call_on") }}
                <span class="text-primary">(144) 4321 4567</span>
              </p>
              <p class="mb-0">
                {{ $t("contact_us.mail") }}
                <a href="mailto:info@medyapim.com" class="text-white fw-500"
                  >support@enquiries.com</a
                >
              </p>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="contact-box d-flex gap-3 rounded">
            ...
            <div style="z-index: 1">
              ...
              <p class="mb-1 font-size-14">
                {{ $t("contact_us.call_on") }}:
                <span class="text-primary">(144) 1234 1234</span>
              </p>
              <p class="mb-0">
                {{ $t("contact_us.mail") }}:
                <a href="mailto:info@medyapim.com" class="text-white fw-500"
                  >user@enquiries.com</a
                >
              </p>
            </div>
          </div>
