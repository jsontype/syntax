<template>
  <div class="rtl-box">
    <a
      id="settingbutton"
      class="btn btn-fixed-end btn-icon btn-setting"
    ...
    >
      <div class="offcanvas-header">
        ...
        <div class="d-flex gap-1 align-items-center">
          ...
          <button
            type="button"
            class="btn btn-icon btn-close px-0 text-reset shadow-none text-dark"
        ...
        <div class="modes row row-cols-2 gx-2">
          <div class="col">
            <div
              ...
              @click="store.theme_scheme_direction('ltr')"
            >
              <input
                ...
                data-prop="dir"
                :checked="store.theme_scheme_direction_value == 'ltr'"
              />
              <label
                class="btn dir-btn cutomizer-button w-100"
          ...
          <div class="col">
            <div
              data-setting="attribute"
              class="text-center w-100"
              @click="store.theme_scheme_direction('rtl')"
            >
              <input
                ...
                name="theme_scheme_direction"
                data-prop="dir"
                :checked="store.theme_scheme_direction_value == 'rtl'"
              />
              <label
                class="btn dir-btn cutomizer-button w-100"
          ...
          <div class="row row-cols-2 gx-2">
            <div class="col mb-3">
              <div
                data-setting="attribute"
                class="text-center w-100"
                @click="store.theme_style_appearance('dark')"
              >
                <input
                ...
                <label
                  class="btn dir-btn cutomizer-button w-100"
                  for="theme-scheme-color-netflix"
                >
                  {{ $t("setting.netflix") }}</label
                >
              </div>
            </div>
            <div class="col mb-3">
              <div
                data-setting="attribute"
                class="text-center w-100"
                @click="store.theme_style_appearance('hotstar')"
              >
                <input
                ...
                <label
                  class="btn dir-btn cutomizer-button w-100"
                  for="theme-scheme-color-hotstar"
                >
                  {{ $t("setting.hotstar") }}
                </label>
              </div>
            ...
            <div class="col">
              <div
                data-setting="attribute"
                class="text-center w-100"
                @click="store.theme_style_appearance('hulu')"
              >
                <input
