    ...
    <div class="slider">
      <div class="slider-flex position-relative">
        <div class="slider--col position-relative">
          <div
            class="vertical-slider-prev swiper-button"
            tabindex="0"
            role="button"
          ...
          <div
            class="vertical-slider-next swiper-button"
            tabindex="0"
            role="button"
            ...
            >
              ...
              <div class="description">
                <div class="block-description">
                  ...
                  <p class="mt-0 mb-3 line-count-2">
