...
if (language == "ko") {
  ...
  item1ContentList.push(
    "저의 강점은 다음과 같습니다. ・코딩 : EC, B2C, B2B Saas 솔루션 등 다양한 분야의 프로젝트 경험 ・어학 : 영어 수능 1등급, 무역영어 1급 외 어학자격증 4개 소지 ・교육 : 유명과외강사, 고교교사 경력"
  )
  item1ContentList.push(
  ...
  item4ContentList.push(`초등학생 때 나는 프로그래머가 되고 싶었다.
    ...
    그렇게 영혼없이 중고등학교 때, 대충 공부하고, 군대를 다녀오고, 대학을 졸업하고, 공부못하는 사립학교에서 영어교사를 마지못해 수년,
