        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-1" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="image-1" class="text-white">
                    <code>
&lt;b-img :src="require('../../../assets/images/small/img-1.jpg')" fluid alt="Responsive image"&gt;&lt;/b-img&gt;
            ...
            <b-img :src="require('../../../assets/images/small/img-1.jpg')" fluid alt="Responsive image" />
          </template>
        </iq-card>
        <iq-card>
          <template v-slot:headerTitle>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-2" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="image-2" class="text-white">
                    <code>
&lt;b-media&gt;
  &lt;template v-slot:aside&gt;
    &lt;b-img :src="require('../../../assets/images/page-img/15.jpg')" class="mr-3 avatar-80" alt="#"&gt;&lt;/b-img&gt;
  &lt;/template&gt;
  &lt;b-media-body&gt;
...
&lt;b-media&gt;
    &lt;template v-slot:aside&gt;
    &lt;b-img :src="require('../../../assets/images/page-img/16.jpg')" class="mr-3 avatar-80" alt="#"&gt;&lt;/b-img&gt;
  &lt;/template&gt;
  &lt;b-media-body&gt;
    &lt;h5 class="mt-0"&gt;Media heading&lt;/h5&gt;
    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
    &lt;b-media no-body class="mt-3"&gt;
      &lt;b-media-aside class="mr-3" tag="a"&gt;
        &lt;b-img :src="require('../../../assets/images/page-img/17.jpg')" class="avatar-80" alt="#"&gt;&lt;/b-img&gt;
      &lt;/b-media-aside&gt;
      &lt;b-media-body&gt;
        &lt;h5 class="mt-0"&gt;Media heading&lt;/h5&gt;
        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
...
&lt;/b-media&gt;
            ...
            <b-media>
              <template v-slot:aside>
                <b-img :src="require('../../../assets/images/page-img/15.jpg')" class="mr-3 avatar-80" alt="#" />
              </template>
              <b-media-body>
                <h5 class="mt-0">
                  Media heading
            ...
            <b-media>
              <template v-slot:aside>
                <b-img :src="require('../../../assets/images/page-img/16.jpg')" class="mr-3 avatar-80" alt="#" />
              </template>
              <b-media-body>
                <h5 class="mt-0">
                  Media heading
                ...
                <b-media no-body class="mt-3">
                  <b-media-aside class="mr-3" tag="a">
                    <b-img :src="require('../../../assets/images/page-img/17.jpg')" class="avatar-80" alt="#" />
                  </b-media-aside>
                  <b-media-body>
                    <h5 class="mt-0">
                      Media heading
        ...
        <iq-card>
          ...
          <template v-slot:headerAction>
            <a v-b-toggle.collapse- class="text-primary float-right" role="button">
              <i class="ri-code-s-slash-line" />
            </a>
          </template>
          <template v-slot:body>
            ...
            <b-collapse id="collapse-" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="images-3" class="text-white">
                    <code>
&lt;b-media right-align class="mb-5"&gt;
  &lt;template v-slot:aside&gt;
    &lt;b-img :src="require('../../../assets/images/page-img/18.jpg')" class="ml-3 avatar-80" alt="#"&gt;&lt;/b-img&gt;
  &lt;/template&gt;
  &lt;b-media-body&gt;
...
&lt;b-media right-align vertical-align="center" class="mb-5"&gt;
  &lt;template v-slot:aside&gt;
    &lt;b-img :src="require('../../../assets/images/page-img/19.jpg')" class="mr-3 avatar-80" alt="#"&gt;&lt;/b-img&gt;
  &lt;/template&gt;
  &lt;b-media-body&gt;
...
&lt;b-media right-align vertical-align="end"&gt;
  &lt;template v-slot:aside&gt;
    &lt;b-img :src="require('../../../assets/images/page-img/20.jpg')" class="mr-3 avatar-80" alt="#"&gt;&lt;/b-img&gt;
  &lt;/template&gt;
  &lt;b-media-body&gt;
...
&lt;/b-media&gt;
            ...
            <b-media right-align class="mb-5">
              <template v-slot:aside>
                <b-img :src="require('../../../assets/images/page-img/18.jpg')" class="ml-3 avatar-80" alt="#" />
              </template>
              <b-media-body>
                <h5 class="mt-0 mb-1">
                  Top-aligned media
            ...
            <b-media right-align vertical-align="center" class="mb-5">
              <template v-slot:aside>
                <b-img :src="require('../../../assets/images/page-img/19.jpg')" class="mr-3 avatar-80" alt="#" />
              </template>
              <b-media-body>
                <h5 class="mt-0 mb-1">
            ...
            <b-media right-align vertical-align="end">
              <template v-slot:aside>
                <b-img end :src="require('../../../assets/images/page-img/20.jpg')" class="mr-3 avatar-80" alt="#" />
              </template>
              <b-media-body>
                <h5 class="mt-0 mb-1">
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-4" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="image-4" class="text-white">
                    <code>
...
&lt;b-img rounded class="ml-3" :src="require('../../../assets/images/page-img/12.jpg')" alt="Responsive image"&gt;&lt;/b-img&gt;
</code></pre>
                </kbd>
              </div>
            </b-collapse>
            <b-img thumbnail class="ml-3" :src="require('../../../assets/images/page-img/10.jpg')" alt="Responsive image" />
            <b-img rounded class="ml-3" :src="require('../../../assets/images/page-img/11.jpg')" alt="Responsive image" />
            <b-img rounded class="ml-3" :src="require('../../../assets/images/page-img/12.jpg')" alt="Responsive image" />
          </template>
        </iq-card>
        <iq-card>
          <template v-slot:headerTitle>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-5" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="image-5" class="text-white">
                    <code>
...
&lt;b-img right :src="require('../../../assets/images/page-img/11.jpg')" alt="Responsive image"&gt;&lt;/b-img&gt;
            ...
            <b-img :src="require('../../../assets/images/page-img/13.jpg')" alt="Responsive image" />
            <b-img right :src="require('../../../assets/images/page-img/14.jpg')" alt="Responsive image" />
          </template>
        </iq-card>
        <iq-card>
          <template v-slot:headerTitle>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-6" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="image-6" class="text-white">
                    <code>
&lt;b-media class="mb-4"&gt;
  &lt;template v-slot:aside&gt;
    &lt;b-img :src="require('../../../assets/images/page-img/21.jpg')" class="mr-3 avatar-80" alt="#"&gt;&lt;/b-img&gt;
  &lt;/template&gt;
  &lt;b-media-body&gt;
...
&lt;b-media vertical-align="center" class="mb-4"&gt;
  &lt;template v-slot:aside&gt;
    &lt;b-img :src="require('../../../assets/images/page-img/22.jpg')" class="mr-3 avatar-80" alt="#"&gt;&lt;/b-img&gt;
  &lt;/template&gt;
  &lt;b-media-body&gt;
    &lt;h5 class="mt-0 mb-1"&gt;Center-aligned media&lt;/h5&gt;
    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
...
&lt;b-media vertical-align="end"&gt;
  &lt;template v-slot:aside&gt;
    &lt;b-img :src="require('../../../assets/images/page-img/23.jpg')" class="mr-3 avatar-80" alt="#"&gt;&lt;/b-img&gt;
  &lt;/template&gt;
  &lt;b-media-body&gt;
    &lt;h5 class="mt-0 mb-1"&gt;Bottom-aligned media&lt;/h5&gt;
    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
...
&lt;/b-media&gt;
            ...
            <b-media class="mb-4">
              <template v-slot:aside>
                <b-img :src="require('../../../assets/images/page-img/21.jpg')" class="mr-3 avatar-80" alt="#" />
              </template>
              <b-media-body>
                <h5 class="mt-0">
                  Top-aligned media
            ...
            <b-media vertical-align="center" class="mb-4">
              <template v-slot:aside>
                <b-img :src="require('../../../assets/images/page-img/22.jpg')" class="mr-3 avatar-80" alt="#" />
              </template>
              <b-media-body>
                <h5 class="mt-0 mb-1">
                  Center-aligned media
            ...
            <b-media vertical-align="end">
              <template v-slot:aside>
                <b-img :src="require('../../../assets/images/page-img/23.jpg')" class="mr-3 avatar-80" alt="#" />
              </template>
              <b-media-body>
                <h5 class="mt-0 mb-1">
                  Bottom-aligned media
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-7" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="image-7" class="text-white">
                    <code>
...
&lt;/ul&gt;
            ...
            <ul class="list-unstyled">
              <b-media tag="li">
                <template v-slot:aside>
                  <b-img :src="require('../../../assets/images/page-img/24.jpg')" class="mr-3 avatar-80" alt="#" />
                </template>
                <b-media-body>
                  <h5 class="mt-0">
