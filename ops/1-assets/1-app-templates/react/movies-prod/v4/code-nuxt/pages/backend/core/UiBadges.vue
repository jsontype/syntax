        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-1" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="badges" class="text-white">
                    <code>
...
&lt;h6 class="mb-0"&gt;Example heading &lt;b-badge variant="info"&gt;New&lt;/b-badge&gt;&lt;/h6&gt;
            ...
            <h1 class="mb-3">
              Example heading <b-badge variant="primary">
                New
              </b-badge>
            </h1>
            <h2 class="mb-3">
              Example heading <b-badge variant="secondary">
                New
              </b-badge>
            </h2>
            <h3 class="mb-3">
              Example heading <b-button variant="success">
                Notifications <b-badge variant="light" class="ml-2">
                  4
                </b-badge>
              </b-button>
            </h3>
            <h4 class="mb-3">
              Example heading <b-badge variant="danger">
                New
              </b-badge>
            </h4>
            <h5 class="mb-3">
              Example heading <b-badge variant="warning">
                New
              </b-badge>
            </h5>
            <h6 class="mb-0">
              Example heading <b-badge variant="info">
                New
              </b-badge>
            </h6>
          </template>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-2" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="button-badges" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-3" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="button-light-background-badges" class="text-white">
                    <code>
...
&lt;/b-button&gt;
            ...
            <b-button variant="outline-primary" class="mb-1 mr-1">
              Notifications <b-badge variant="primary" class="ml-2">
                4
              </b-badge>
            </b-button>
            <b-button variant="outline-success" class="mb-1 mr-1">
              Notifications<b-badge variant="success" class="ml-2">
                4
              </b-badge>
            </b-button>
            <b-button variant="outline-danger" class="mb-1 mr-1">
              Notifications<b-badge variant="danger" class="ml-2">
                4
              </b-badge>
            </b-button>
          </template>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-4" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="button-border-badges" class="text-white">
                    <code>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-5" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="contextual-variations" class="text-white">
                    <code>
...
&lt;b-badge href="#" variant="dark"&gt;Dark&lt;/b-badge&gt;
            ...
            <b-badge pill variant="warning" class="mr-1">
              Warning
            </b-badge>
            ...
            <p>Using the contextual <code>.badge-*</code> classes on an <code>&lt;a&gt;</code> element quickly provide <em>actionable</em> badges with hover and focus states.</p>
            <b-badge href="#" variant="primary" class="mr-1">
              Primary
            </b-badge>
            <b-badge href="#" variant="secondary" class="mr-1">
              Secondary
            </b-badge>
            <b-badge href="#" variant="success" class="mr-1">
              Success
            </b-badge>
            <b-badge href="#" variant="danger" class="mr-1">
              Danger
            </b-badge>
            <b-badge href="#" variant="warning" class="mr-1">
              Warning
            </b-badge>
            <b-badge href="#" variant="info" class="mr-1">
              Info
            </b-badge>
            <b-badge href="#" variant="light" class="mr-1">
              Light
            </b-badge>
            <b-badge href="#" variant="dark" class="mr-1">
              Dark
            </b-badge>
          </template>
        </iq-card>
        <iq-card>
          ...
          <template v-slot:body>
            ...
            <b-collapse id="collapse-6" class="mb-2">
              <div class="card">
                <kbd class="bg-dark">
                  <pre id="contextual-variations-border" class="text-white">
                    <code>
...
&lt;b-badge href="#" class="border border-dark text-dark" variant="none"&gt;Dark&lt;/b-badge&gt;
            ...
            <b-badge class="border border-primary text-primary mr-1" variant="none">
              Primary
            </b-badge>
            <b-badge class="border border-secondary text-secondary mr-1" variant="none">
              Secondary
            </b-badge>
            <b-badge class="border border-success text-success mr-1" variant="none">
              Success
            </b-badge>
            <b-badge class="border border-danger text-danger mr-1" variant="none">
              Danger
            </b-badge>
            <b-badge class="border border-warning text-warning mr-1" variant="none">
              Warning
            </b-badge>
            <b-badge class="border border-info text-info mr-1" variant="none">
              Info
            </b-badge>
            <b-badge class="border border-light text-light mr-1" variant="none">
              Light
            </b-badge>
            <b-badge class="border border-dark text-dark mr-1" variant="none">
              Dark
            </b-badge>
            <h5 class="card-title mt-4">
              Pill badges
            ...
            <p>Use the <code>.badge-pill</code> modifier class to make badges more rounded (with a larger <code>border-radius</code> and additional horizontal <code>padding</code>). Useful if you miss the badges from v3.</p>
            <b-badge class="border border-primary text-primary mr-1" pill variant="none">
              Primary
            </b-badge>
            <b-badge class="border border-secondary text-secondary mr-1" pill variant="none">
              Secondary
            </b-badge>
            <b-badge class="border border-success text-success mr-1" pill variant="none">
              Success
            </b-badge>
            <b-badge class="border border-danger text-danger mr-1" pill variant="none">
              Danger
            </b-badge>
            <b-badge class="border border-warning text-warning mr-1" pill variant="none">
              Warning
            </b-badge>
            <b-badge class="border border-info text-info mr-1" pill variant="none">
              Info
            </b-badge>
            <b-badge class="border border-light text-light mr-1" pill variant="none">
              Light
            </b-badge>
            <b-badge class="border border-dark text-dark mr-1" pill variant="none">
              Dark
            </b-badge>
            <h5 class="card-title mt-4">
              Links
            ...
            <p>Using the contextual <code>.badge-*</code> classes on an <code>&lt;a&gt;</code> element quickly provide <em>actionable</em> badges with hover and focus states.</p>
            <b-badge href="#" class="border border-primary text-primary mr-1" variant="none">
              Primary
            </b-badge>
            <b-badge href="#" class="border border-secondary text-secondary mr-1" variant="none">
              Secondary
            </b-badge>
            <b-badge href="#" class="border border-success text-success mr-1" variant="none">
              Success
            </b-badge>
            <b-badge href="#" class="border border-danger text-danger mr-1" variant="none">
              Danger
            </b-badge>
            <b-badge href="#" class="border border-warning text-warning mr-1" variant="none">
              Warning
            </b-badge>
            <b-badge href="#" class="border border-info text-info mr-1" variant="none">
              Info
            </b-badge>
            <b-badge href="#" class="border border-light text-light mr-1" variant="none">
              Light
            </b-badge>
            <b-badge href="#" class="border border-dark text-dark mr-1" variant="none">
              Dark
            </b-badge>
          </template>
        </iq-card>
