<template>
      ...
      <div class="footer-top">
        <div class="row">
          <div class="col-xl-3 col-lg-6 mb-5 mb-lg-0">
            ...
            <p class="mb-4 font-size-14">
              {{ $t("footer.email_us") }}:
              <span class="text-white">customer@streamit.com</span>
            </p>
          ...
          <div class="col-xl-2 col-lg-6 mb-5 mb-lg-0">
            <h4 class="footer-link-title">{{ $t("footer.quick_links") }}</h4>
            <ul class="list-unstyled footer-menu">
              <li class="mb-3">
                <nuxt-link class="ms-3" :to="{ name: 'extra-about-us' }">
                  {{ $t("header.about_us") }}
                </nuxt-link>
              </li>
              <li class="mb-3">
                <nuxt-link class="ms-3" :to="{ name: 'blogs' }">
                  {{ $t("header.blog") }}
                </nuxt-link>
              </li>
              <li class="mb-3">
                <nuxt-link class="ms-3" :to="{ name: 'pricing-plan' }">
                  {{ $t("header.pricing_plan") }}
                </nuxt-link>
              </li>
              <li>
                <nuxt-link class="ms-3" :to="{ name: 'extra-faq' }">
                  {{ $t("header.faq") }}
                </nuxt-link>
              </li>
            </ul>
          ...
          <div class="col-xl-2 col-lg-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled footer-menu">
              <li class="mb-3">
                <nuxt-link class="ms-3" :to="{ name: 'view-all' }">
                  {{ $t("footer.top_trending") }}</nuxt-link>
              </li>
              <li class="mb-3">
                <nuxt-link class="ms-3" :to="{ name: 'view-all' }">
          ...
          <div class="col-xl-2 col-lg-6 mb-5 mb-lg-0">
            <h4 class="footer-link-title">{{ $t("footer.about_company") }}</h4>
            <ul class="list-unstyled footer-menu">
              <li class="mb-3">
                <nuxt-link class="ms-3" :to="{ name: 'extra-contact-us' }">{{ $t("header.contact_us") }}
                </nuxt-link>
              </li>
              <li class="mb-3">
                <nuxt-link class="ms-3" :to="{ name: 'extra-privacy-policy' }">
                  {{ $t("header.privacy_policy") }}
                </nuxt-link>
              </li>
              <li>
                <nuxt-link class="ms-3" :to="{ name: 'extra-terms-of-use' }">
          ...
          <div class="col-xl-3 col-lg-6">
            ...
            <div class="mailchimp mailchimp-dark">
              <div class="input-group mb-3 mt-4">
                <input type="text" class="form-control mb-0 font-size-14" :placeholder="$t('footer.email')"
        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            <ul class="menu list-inline p-0 d-flex flex-wrap align-items-center">
              <li class="menu-item">
                <nuxt-link :to="{ name: 'extra-terms-of-use' }">{{ $t("footer.terms_of_use") }}
                </nuxt-link>
              </li>
              <li id="menu-item-7316" class="menu-item">
                <nuxt-link :to="{ name: 'extra-privacy-policy' }">{{ $t("footer.privacy-policy") }}
                </nuxt-link>
              </li>
              <li class="menu-item">
                <nuxt-link :to="{ name: 'extra-faq' }">{{ $t("header.faq") }}
                </nuxt-link>
              </li>
              <li class="menu-item">
                <nuxt-link :to="{ name: 'play-list' }">{{ $t("footer.watch_list") }}
                </nuxt-link>
              </li>
            </ul>
            <p class="font-size-14">
              © <span class="currentYear">2024 </span>
              <span class="text-primary">STREAMIT</span>.{{ $t("footer.desc") }}
            </p>
          </div>
          <div class="col-md-3"></div>
          <div class="col-md-3">
            <h6 class="font-size-14 pb-1">
  ...
  <div id="back-to-top" style="display: none" class="animate__animated" :class="animationClass" @click="scrollToTop">
    <a id="top" class="p-0 btn bg-primary btn-sm position-fixed top border-0 rounded-circle" href="#top">
