  ...
  <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar header-hover-menu">
    <div class="container-fluid navbar-inner">
      ...
      <div class="d-flex align-items-center">
        <button id="navbar-toggle" v-b-toggle.navbarSupportedContent class="navbar-toggler" type="button"
      ...
      <b-collapse id="navbarSupportedContent" class="navbar-collapse" @show="emit('menuOpen')"
        @hide="emit('menuClose')">
        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-xl-0">
          ...
          <li ref="dropdown" class="nav-item dropdown">
            <a id="search-drop" href="#" class="nav-link" :aria-expanded="isDropdownOpen" @click="toggleDropdown">
            ...
            <ul class="p-0 sub-drop dropdown-menu dropdown-menu-end" :class="{ show: isDropdownOpen }">
              <li>
                    ...
                    <div class="iq-search-bar device-search position-relative">
                      <form action="#" class="searchbox">
                        ...
                        <a class="d-lg-none d-flex" href="javascript:void(0);">
                          <span class="material-symbols-outlined">{{ $t('header.search') }}</span>
                        </a>
                      </form>
                    </div>
                  </div>
                ...
                <div class="p-0 card-body all-notification">
                  <div class="d-flex align-items-center border-bottom search-hover py-2 px-3">
                    ...
                    <div class="d-flex flex-column ms-3 w-100">
                      <a href="javascript:void(0);" class="h5">{{ $t('header.paige_turner') }}</a>
                      <span>{{ $t('header.paige') }}</span>
                    </div>
                  </div>
                  <div class="d-flex align-items-center border-bottom search-hover py-2 px-3">
                    <div class="flex-shrink-0">
                    ...
                    <div class="d-flex flex-column ms-3 w-100">
                      <a href="javascript:void(0);" class="h5">{{ $t('header.monty_carlo') }}</a>
                      <span>{{ $t('header.carlo_m') }}</span>
                    </div>
                  </div>
                  <div class="d-flex align-items-center search-hover py-2 px-3 border-bottom">
                    ...
                    <div class="d-flex flex-column ms-3 w-100">
                      <a href="javascript:void(0);" class="h5">{{ $t('header.paul_molive') }}</a>
                      <span>{{ $t('header.paul') }}</span>
                    </div>
                  </div>
                  <div class="d-flex align-items-center border-bottom search-hover py-2 px-3">
                    <div class="flex-shrink-0">
          ...
          <li class="nav-item theme-scheme-dropdown">
            <!-- <a id="mode-drop" href="#" class="nav-link"> -->
            <MenuThemeDirection />
            <!-- </a> -->
          </li>
          <li id="itemdropdown1" class="nav-item dropdown">
            <select v-model="$i18n.locale" class="form-select py-1">
          ...
          <li class="nav-item dropdown">
            <a href="#" class="nav-link" :aria-expanded="isDropdownOpen1" @click="toggleDropdown1">
            ...
            <ul class="p-0 sub-drop dropdown-menu dropdown-menu-end" :class="{ show: isDropdownOpen1 }">
              <li>
                <div class="p-3 card-header d-flex justify-content-between bg-primary rounded-top">
                  <div class="header-title">
                    <h5 class="mb-0 text-white">{{ $t('header.all_notifications') }}</h5>
                  </div>
                </div>
                <div class="p-0 card-body all-notification">
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-3 w-100">
                        <h6 class="mb-0">{{ $t('header.emma_watson_bni') }}</h6>
                        <div class="d-flex justify-content-between align-items-center">
                          <p class="mb-0">95 {{ $t('header.mb') }}</p>
                          <small class="float-end font-size-12">{{ $t('header.just_now') }}</small>
                        </div>
                      </div>
                    </div>
                  </a>
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      <div>
                        <img class="p-1 avatar-40 rounded-pill bg-primary-subtle" src="/assets/images/shapes/02.png"
                          alt="" loading="lazy" />
                      </div>
                      <div class="ms-3 w-100">
                        <h6 class="mb-0">{{ $t('header.new_customer_is_join') }}</h6>
                        <div class="d-flex justify-content-between align-items-center">
                          <p class="mb-0">{{ $t('header.cyst_bni') }}</p>
                          <small class="float-end font-size-12">5 {{ $t('header.days_ago') }}</small>
                        </div>
                      </div>
                    </div>
                  </a>
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      <img class="p-1 avatar-40 rounded-pill bg-primary-subtle" src="/assets/images/shapes/03.png"
                        alt="" loading="lazy" />
                      <div class="ms-3 w-100">
                        <h6 class="mb-0">{{ $t('header.two_customer_is_left') }}</h6>
                        <div class="d-flex justify-content-between align-items-center">
                          <p class="mb-0">{{ $t('header.cyst_bni') }}</p>
                          <small class="float-end font-size-12">2 {{ $t('header.days_ago') }}</small>
                        </div>
                      </div>
                    </div>
                  </a>
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 ms-3">
                        <h6 class="mb-0">{{ $t('header.new_mail_from_fenny') }}</h6>
                        <div class="d-flex justify-content-between align-items-center">
                          <p class="mb-0">{{ $t('header.cyst_bni') }}</p>
                          <small class="float-end font-size-12">3 {{ $t('header.days_ago') }}</small>
                        </div>
                      </div>
                    </div>
                  </a>
          ...
          <!-- Theme Scheme start-->
          <b-dropdown variant="none px-0 py-0" class="nav-item theme-scheme-dropdown"
            menu-class="list-unstyled dropdown-menu dropdown-content custom-dropdown" no-caret>
            <template #button-content>
              <a href="#" class="nav-link" :aria-expanded="isDropdownOpen1" @click="toggleDropdown3">
                <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <!-- <li data-setting="radio" @click="updateThemeRadio('light')"> -->
            <b-dropdown-item variant="none" class="d-flex align-items-center" @click="updateThemeRadio('light')">
              <input id="color-mode-light" type="radio" value="light" class="btn-check" name="theme_scheme" />
              <label class="d-block" for="color-mode-light">
                ...
                <span class="ms-3 mb-0">{{ $t('header.light') }}</span>
              </label>
            </b-dropdown-item>
            <!-- </li> -->
            <!-- <li data-setting="radio" @click="updateThemeRadio('dark')"> -->
            <b-dropdown-item variant="none" class="d-flex align-items-center" @click="updateThemeRadio('dark')">
              <input id="color-mode-dark" type="radio" value="dark" class="btn-check" name="theme_scheme" />
              <label class="d-block" for="color-mode-dark">
                ...
                <span class="ms-3 mb-0">{{ $t('header.dard') }}</span>
              </label>
            </b-dropdown-item>
            <!-- </li> -->
            <!-- <li data-setting="radio" @click="updateThemeRadio('auto')"> -->
            <b-dropdown-item variant="none" class="d-flex align-items-center" @click="updateThemeRadio('auto')">
              <input id="color-mode-auto" type="radio" value="auto" class="btn-check" name="theme_scheme" checked />
              <label class="d-block" for="color-mode-auto">
                ...
                <span class="ms-3 mb-0">{{ $t('header.auto') }}</span>
              </label>
            </b-dropdown-item>
            <!-- </li> -->
            <!-- </ul> -->
          </b-dropdown>
          <li id="fullscreen-item" class="nav-item iq-full-screen d-none d-xl-block border-end">
            <a id="btnFullscreen" href="#" class="nav-link pe-3" @click="openFullScreen">
              <svg :class="fullScreen ? 'normal-screen d-none' : 'normal-screen icon-24'" width="24" height="24"
                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18.5528 5.99656L13.8595 10.8961" stroke="currentColor" stroke-width="1.5"
                  stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M14.8016 5.97618L18.5524 5.99629L18.5176 9.96906" stroke="currentColor" stroke-width="1.5"
                  stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M5.8574 18.896L10.5507 13.9964" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                  stroke-linejoin="round"></path>
                <path d="M9.60852 18.9164L5.85775 18.8963L5.89258 14.9235" stroke="currentColor" stroke-width="1.5"
                  stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
              <svg :class="fullScreen ? 'full-normal-screen icon-24' : 'full-normal-screen d-none'" width="24"
                height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M13.7542 10.1932L18.1867 5.79319" stroke="currentColor" stroke-width="1.5"
                  stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M17.2976 10.212L13.7547 10.1934L13.7871 6.62518" stroke="currentColor" stroke-width="1.5"
                  stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M10.4224 13.5726L5.82149 18.1398" stroke="currentColor" stroke-width="1.5"
                  stroke-linecap="round" stroke-linejoin="round"></path>
          ...
          <b-dropdown id="profilesetting" variant="none px-0 py-0 me-4 me-lg-0" end class="nav-item" no-caret
            menu-class="mt-0 mt-lg-2">
            <template #button-content>
              <a class="py-0 nav-link d-flex align-items-center ps-3"
                :class="themeSchemeDirection !== 'ltr' ? 'flex-row-reverse' : ''" href="#" role="button"
                :aria-expanded="isDropdownOpen2">
                <img src="/assets/images/avatars/01.png" alt="User-Profile"
                  class="img-fluid avatar avatar-50 avatar-rounded" loading="lazy" />
                <div class="caption ms-3 d-none d-md-block">
                  <h6 class="mb-0 caption-title text-start">{{ $t('header.austin_robertson') }}</h6>
                  <p class="mb-0 caption-sub-title">{{ $t('header.marketing_administrator') }}</p>
                </div>
              </a>
            </template>
            <b-dropdown-item class="none" :to="{ name: 'user.user-profile' }"> {{ $t('header.profile')
              }}</b-dropdown-item>

            <b-dropdown-item class="none" :to="{ name: 'user.user-privacy-setting' }"> {{ $t('header.privacy_setting')
              }}
            </b-dropdown-item>

            <b-dropdown-divider> </b-dropdown-divider>
            <b-dropdown-item class="none" :to="{ name: 'auth.login' }"> {{ $t('header.logout') }} </b-dropdown-item>
          </b-dropdown>
...
import MenuThemeDirection from '@/components/customizer/MenuThemeDirection.vue';
import { computed } from 'vue';
import { useSetting } from '@/store/pinia';

export default {
  components: { MenuThemeDirection },
  props: {
