      ...
      <b-card no-body>
        ...
        <b-card-body>
          ...
          <div class="d-flex flex-wrap justify-content-around">
            <div class="toast fade show bg-primary text-white border-0 mt-3" role="alert" aria-live="assertive" aria-atomic="true">
              <div class="toast-header bg-primary text-white">
                ...
                <small>11 mins ago</small>
                <button type="button" class="ms-2 mb-1 btn-close btn-close-white text-white" data-dismiss="toast" aria-label="Close"></button>
              </div>
              <div class="toast-body">Hello, world! This is a toast message.</div>
            </div>
