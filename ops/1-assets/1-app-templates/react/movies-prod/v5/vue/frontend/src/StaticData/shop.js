...
export const products = [
  ...
  },
  {
    ...
    descriptio:
      "There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don’t look even slightly believable.",
    stock_status: "shop.out_of_stock",
...
export const shopBannerSlider = [filterCategory('activeman'), filterCategory('avengers'), filterCategory('disney-world'), filterCategory('fantasia'), filterCategory('galaxy-heaven'), filterCategory('ghost-spider'), filterCategory('harry-david'), filterCategory('haunted-halloween'), filterCategory('marvel-studios'), filterCategory('monster-house'), filterCategory('quid-game'), filterCategory('the-flashv'), filterCategory('the-madrid'), filterCategory('the-champion'), filterCategory('uptight-birds'), filterCategory('warner-bros-films')];
...
export const myWishlist = [filterProduct('bag-pack'), filterProduct('believe-mask'), filterProduct('black-bow')];
