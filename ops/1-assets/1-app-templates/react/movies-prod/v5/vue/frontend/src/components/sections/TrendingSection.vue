      ...
      <b-row class="m-0 p-0">
        <div id="iq-trending" class="s-margin iq-tvshow-tabs iq-trending-tabs overflow-hidden">
          <div class="d-flex align-items-center justify-content-between px-0 px-md-3">
            <h5 class="main-title text-capitalize mb-0 pb-4">{{ $t('home.trending') }}</h5>
          </div>
          <div class="trending-contens position-relative">
            <div id="gallery-top" class="swiper gallery-thumbs swiper-initialized swiper-horizontal swiper-pointer-events" data-swiper="gallery-top">
              <Swiper v-if="render" :dir="rtl" :loop="true" :slides-per-view="5" :modules="modules" :touch-ratio="0.2" :slide-to-clicked-slide="true" :centered-slides="true" class="list-inline p-0 m-0 trending-slider-nav align-items-center" :thumbs="{ swiper: thumbsSwiper }">
                ...
                <div class="tranding-block position-relative">
                  <div class="trending-custom-tab">
                    <div class="tab-title-info position-relative">
                      <b-tabs class="trending-custom-tab" content-class="trending-content" pills nav-class="trending-pills iq-custom-tab d-flex nav nav-pills justify-content-center align-items-center text-center list-inline">
                        <b-tab :title="$t('home.overview')" active>
                          <div class="trending-info align-items-center w-100 animated fadeInUp iq-ltr-direction">
                            <h1 class="trending-text big-title text-uppercase texture-text">{{ $t('home.hero_camp') }}</h1>
                            ...
                            <div class="d-flex align-items-center flex-wrap series mb-4 gap-3">
                              <router-link to="#"><img src="/assets/images/movies/trending-label.webp" class="img-fluid" alt="" loading="lazy" /></router-link>
                              <span class="text-gold">#2 {{ $t('home.series_today') }}</span>
                            </div>
                            <p class="trending-dec line-count-3">{{ $t('ott_home.content_here') }}</p>
                            <div class="p-btns">
                              <div class="iq-button">
                                <router-link :to="{ name: 'landing-page.tv-show-detail' }" class="btn text-uppercase position-relative">
                            ...
                            <div class="trending-list mt-4">
                              <div class="text-primary title">
                                {{ $t('home.starring') }}: <span class="text-body">{{ $t('home.wagner_moura') }} </span>
                              </div>
                              <div class="text-primary title">
                                {{ $t('ott_home.genres') }}: <span class="text-body">{{ $t('home.crime_action') }}</span>
                              </div>
                              <div class="text-primary title">
                                This Is: <span class="text-body">{{ $t('home.violent_forceful') }}</span>
                              </div>
                            </div>
                          </div>
                        </b-tab>
                        <b-tab :title="$t('home.episodes')">
                          <div class="trending-info align-items-center w-100 animate__animated animate__fadeInUp iq-ltr-direction">
                            <h1 class="trending-text big-title text-uppercase texture-text">{{ $t('home.hero_camp') }}</h1>
                            <div class="d-flex align-items-center text-white text-detail flex-wrap mb-4">
                              <span class="season_date ms-2"> 2 {{ $t('episode_page.seasons') }} </span>
                            ...
                            <div class="iq-custom-select d-inline-block sea-epi mb-4">
                              <select ref="selectElement1" class="form-control movie-select" :tabindex="tabindex">
                                <option value="season1">{{ $t('episode_page.seasons') }} 1</option>
                                <option value="season2">{{ $t('episode_page.seasons') }} 2</option>
                                <option value="season3">{{ $t('episode_page.seasons') }} 3</option>
                              </select>
                            </div>
                            <div class="position-relative swiper swiper-card streamit-block" data-slide="4" data-laptop="3" data-tab="2" data-mobile="2" data-mobile-sm="1" data-autoplay="false" data-loop="false" data-navigation="true" data-pagination="true">
                              <Swiper v-if="render" :dir="rtl" class="p-0 swiper-wrapper m-0 list-inline" :slides-per-view="4">
                                <SwiperSlide v-for="dataEP in episode" :key="dataEP.episodTitle" tag="li" class="swiper-slide">
                                  <episode-card :link="dataEP.link" :image="dataEP.image" :show-episod="dataEP.showEpisod" :episod-date="dataEP.episodDate" :episod-time="dataEP.episodTime" :episod-title="dataEP.episodTitle"></episode-card>
                                </SwiperSlide>
                              </Swiper>
                        ...
                        <b-tab :title="$t('home.trailerss')">
                          <div class="trending-info align-items-center w-100 animate__animated animate__fadeInUp iq-ltr-direction text-center">
                            ...
                            <div class="episodes-contens mt-5">
                              <div class="tab-watch-trailer-container d-inline-block rounded-3 overflow-hidden">
                                <div class="tab-watch-trailer position-relative rounded-3 overflow-hidden">
                                  <img src="/assets/images/tv-show/season/01.webp" class="trailer-image" alt="trailer-image" loading="lazy" />
                                  <a href="/assets/images/video/trailer.mp4" class="video-open playbtn text-decoration-none" tabindex="0">
                                    ...
                                    {{ '' }}
                                    <span class="w-trailor text-uppercase"> {{ $t('home.watch_trailer') }} </span>
                                  </a>
                                </div>
                              </div>
                            </div>
                        ...
                        <b-tab :title="$t('home.similar_like')">
                          <div class="trending-info align-items-center w-100 animate__animated animate__fadeInUp iq-ltr-direction">
                            <h3 class="trending-text big-title text-uppercase texture-text mb-5">
                              {{ $t('ott_home.recommended_for_you') }}
                            </h3>
                            <div class="position-relative swiper swiper-card streamit-block" data-slide="4" data-laptop="3" data-tab="2" data-mobile="1" data-mobile-sm="1" data-autoplay="false" data-loop="false" data-navigation="true" data-pagination="true">
                              <Swiper v-if="render" :dir="rtl" class="p-0 swiper-wrapper m-0 list-inline" :slides-per-view="4">
                                <SwiperSlide v-for="dataEP1 in episode" :key="dataEP1.title" tag="li" class="swiper-slide">
                                  <episode-card :link="dataEP1.link" :image="dataEP1.image" :show-episod="dataEP1.showEpisod" :episod-date="dataEP1.episodDate" :episod-time="dataEP1.episodTime" :episod-title="dataEP1.episodTitle"></episode-card>
                                </SwiperSlide>
                              </Swiper>
                              <div class="swiper-button swiper-button-next"></div>
                              <div class="swiper-button swiper-button-prev"></div>
