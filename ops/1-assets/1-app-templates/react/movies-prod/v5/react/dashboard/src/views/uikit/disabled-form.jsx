...
// React-bootstrap
import { Form, Nav, Tab, FormCheck, Button, Container } from "react-bootstrap";

// components
import Card from "../../components/bootstrap/card";

const DisabledForms = React.memo(() => {
  return (
    <Fragment>
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/disable-forms"
                  target="_blank"
                >
                  <svg
                    width="20"
                ...
                <div className="bd-example">
                  <Form>
                    ...
                    >
                      ...
                      <div className="mb-3">
                        <Form.Label htmlFor="disabledSelect" className="">
                          Disabled select menu
                        </Form.Label>
                        <Form.Select id="disabledSelect" disabled className="">
                      ...
                      <div className="mb-3">
                        <Form.Label className="" htmlFor="disabledCustomFile">
                          Upload
                        </Form.Label>
                        <Form.Control
                          type="file"
                      ...
                      <div className="mb-3">
                        <Form.Label htmlFor="disabledRange" className="">
                          Disabled range
                        </Form.Label>
