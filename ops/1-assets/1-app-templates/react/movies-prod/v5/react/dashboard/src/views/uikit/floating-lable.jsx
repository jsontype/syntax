          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/floating-lable"
                  target="_blank"
                >
                  <svg
                    width="20"
        ...
        <Card className=" iq-document-card">
          <Tab.Container defaultActiveKey="first">
            ...
            <Tab.Content>
              ...
              <Tab.Pane
                eventKey="second"
                className="e bd-heading-1 fade show"
...
FloatingLables.displayName = "FloatingLables";
