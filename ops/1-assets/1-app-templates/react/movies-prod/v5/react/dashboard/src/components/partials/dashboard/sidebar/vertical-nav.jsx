  ...
  return (
    <Fragment>
      <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        >
          <Link
            className={`${location.pathname === "/" ? "active" : ""} nav-link align-items-center`}
            aria-current="page"
            to="/"
          >
            <OverlayTrigger
        ...
        <Accordion.Item
          as="li"
          bsPrefix={`nav-item ${active === "rating-page" ? "active nav-link" : ""
            } `}
        >
          <Link
            className={`${location.pathname === "/rating-page" ? "active" : ""
        ...
        <Accordion.Item
          as="li"
          bsPrefix={`nav-item ${active === "comment-list" ? "active nav-link" : ""
            } `}
        >
          <Link
            className={`${location.pathname === "/comment-list" ? "active" : ""
              } nav-link align-items-center`}
            aria-current="page"
            to="/comment-list"
          >
        ...
        >
          <Link
            className={`${location.pathname === "/tv-shows/movielist" ? "active" : ""
              } nav-link align-items-center`}
            aria-current="page"
        ...
        >
          ...
          <Accordion.Collapse eventKey="sidebar-tvshows">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${location.pathname === "/tv-shows/showlist" ? "active" : ""
                    } nav-link`}
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-film icon-20" ></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                <Link
                  className={`${location.pathname === "/tv-shows/seasons" ? "active" : ""
                    } nav-link`}
                  to="/tv-shows/seasons"
                >
                  <OverlayTrigger
                  ...
                  <span className="item-name">{t("sidebar.seasons")}</span>
                </Link>
              </Nav.Item>
              <Nav.Item as="li">
                <Link
                  className={`${location.pathname === "/tv-shows/episodes" ? "active" : ""
                    } nav-link`}
        ...
        >
          <Link
            className={`${location.pathname === "/special-pages/pricing" ? "active" : ""
              } nav-link align-items-center`}
            aria-current="page"
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-right-to-bracket icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-regular fa-registered icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-voicemail icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-regular fa-file icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-fingerprint icon-20"></i>
                  </OverlayTrigger>
                  <span className="item-name">
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-user-xmark icon-20"></i>
                  </OverlayTrigger>
                  <span className="item-name">
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-lock icon-20"> </i>
                  </OverlayTrigger>
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-circle-exclamation icon-20"> </i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-box-archive icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                <Link
                  className={`${location.pathname === "/errors/coming-soon" ? "active" : ""
                    } nav-link`}
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-clock icon-20"></i>
                  </OverlayTrigger>
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-regular fa-user icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-regular fa-bell icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-brands fa-atlassian icon-20"> </i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-bars icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-ticket-simple icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  <OverlayTrigger
                    ...
                    overlay={<Tooltip>Buttons</Tooltip>}
                  >
                    <i className="fa-solid fa-server icon-20"></i>
                  </OverlayTrigger>
                  <span className="item-name">
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-expand icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-palette icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-regular fa-address-card icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-sliders icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-table-cells-large icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-image icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-list-check icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-table-columns icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-bell icon-20"></i>
                  </OverlayTrigger>
                  <span className="item-name">
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-ellipsis icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-eraser icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-keyboard icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-layer-group icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-video icon-20"></i>
                  </OverlayTrigger>
        ...
        >
          ...
          <Accordion.Collapse eventKey="sidebar-Widget">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${location.pathname === "/widgetbasic" ? "active" : ""
                    } nav-link`}
                  to="/widgetbasic"
                >
                  ...
                  >
                    <i className="fa-solid fa-box icon-20"></i>
                  </OverlayTrigger>
                  <span className="item-name">
              ...
              <Nav.Item as="li">
                <Link
                  className={`${location.pathname === "/widgetchart" ? "active" : ""
                    } nav-link`}
                  to="/widgetchart"
                >
              ...
              <Nav.Item as="li">
                <Link
                  className={`${location.pathname === "/widgetcard" ? "active" : ""
                    } nav-link`}
                  to="/widgetcard"
                >
            ...
            <ul className="sub-nav">
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-wand-magic-sparkles icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-pen-to-square icon-20"></i>
                  </OverlayTrigger>
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                ...
                >
                  ...
                  >
                    <i className="fa-brands fa-bootstrap icon-20"></i>
                  </OverlayTrigger>
                  <span className="item-name">
              ...
              <Nav.Item as="li">
                <Link
                  className={`${location.pathname === "/table/Datatable" ? "active" : ""
                    } nav-link`}
                  to="/table/Datatable"
                >
                  ...
                  >
                    <i className="fa-solid fa-table-list icon-20"></i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                <Link
                  className={`${location.pathname === "/table/fixed-table" ? "active" : ""
                    } nav-link`}
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-table-cells icon-20"></i>
                  </OverlayTrigger>
        ...
        <li
          className={`${location.pathname === "/font-awesome" ? "active" : ""
            } nav-item `}
        >
          <Link
            className={`${location.pathname === "/font-awesome" ? "active" : ""
          ...
          >
            ...
            <span className="item-name">{t("sidebar.fontawesome")}</span>
          </Link>
        </li>

        <li
          className={`${location.pathname === "/access-control" ? "active" : ""
            } nav-item `}
        >
          <Link
            className={`${location.pathname === "/access-control" ? "active" : ""
