                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <div className="d-flex align-items-center mt-2">
                                    <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/datepicker" target="_blank">
                                ...
                                <Tab.Pane eventKey="first" className="bd-heading-1 fade show " id="content-Calendar-prv" role="tabpanel" aria-labelledby="typo-output">
                                    <Row>
                                        <Col md="6" className="order-md-1">
                                            ...
                                            <div className="bd-example">
                                                <div className="form-group">
                                                    <Flatpickr options={{ enableTime: true, noCalendar: true, dateFormat: "H:i", }} placeholder="Select Time..." className="form-control time_flatpicker " />
                                                </div>
                                            </div>
