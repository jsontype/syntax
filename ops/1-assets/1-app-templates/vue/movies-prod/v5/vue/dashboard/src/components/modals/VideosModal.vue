<template>
  <div>
    <b-button variant="primary" @click="videoModal = true"><i class="fa-solid fa-square-plus me-2"></i>{{ $t('episodemodal.add_video') }}</b-button>
    <b-modal v-model="videoModal" :title="$t('episodemodal.add_video')" size="md" :ok-title="$t('formelement.save_changes')" :cancel-title="$t('castmodal.close')">
      <b-form>
        <b-row>
          <b-col sm="12">
