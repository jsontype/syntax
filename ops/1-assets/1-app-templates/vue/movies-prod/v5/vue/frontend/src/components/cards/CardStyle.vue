  ...
  <div class="iq-card card-hover">
    <div class="block-images position-relative w-100">
      <div class="img-box w-100">
        <router-link :to="props.link" class="position-absolute top-0 bottom-0 start-0 end-0"></router-link>
        ...
        <div class="cart-content">
          <div class="content-left">
            ...
            <div class="movie-time d-flex align-items-center my-2">
              <span class="movie-time-text font-normal">{{ props.movieTime }}</span>
            </div>
          </div>
          <div class="watchlist">
            <router-link class="watch-list-not" :to="props.watchlistLink">
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-10">
                <path d="M12 4V20M20 12H4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
              <span class="watchlist-label"> {{ $t('ott_home.watchlist') }} </span>
            </router-link>
          </div>
        </div>
      </div>
      <div class="block-social-info align-items-center">
        ...
        <div class="iq-button">
          <router-link :to="{ name: 'landing-page.movies.detail' }" class="btn text-uppercase position-relative rounded-circle">
