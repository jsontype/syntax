          ...
          <Row>
            <Col lg="8" sm="12">
              <div className="blog-box">
                ...
                <h3 className="fw-500">{t(blog.title)}</h3>
                ...
                <ul className="p-0 m-0 list-unstyled gap-2 widget_tags">
                  <li>
                    <i
                      ...
                      aria-hidden="true"
                    ></i>{" "}
                    <span className="font-size-12 fw-semibold text-uppercase">
                      {t("header.tags")}:
                    </span>
                  </li>
