...
// img
import img1 from "/assets/images/movies/movie-banner-1.webp";
import img2 from "/assets/images/movies/movie-banner-2.webp";
import img3 from "/assets/images/movies/movie-banner-3.webp";
        ...
        <div className="movie-banner">
          <div id="banner-detail-slider" className="banner-container">
            <div className="movie-banner tvshows-slider">
              ...
              >
                <SwiperSlide className="movie-banner-1 p-0">
