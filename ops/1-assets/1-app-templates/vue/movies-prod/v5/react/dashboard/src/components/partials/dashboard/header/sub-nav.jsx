...
//component
import CustomToggle from "../../../custom/dropdown";
    ...
    <Fragment>
      ...
      <div className="d-flex align-items-center">
        <Button
          ...
          onClick={() => { props.handleOffcanvas(), setShow1(!show1) }}
        >
      ...
      >
        <ul className="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
          <Dropdown as="li" className="nav-item me-0 me-xl-0 pt-1 me-2">
            ...
            <Dropdown.Menu as="ul" variant="end p-0 sub-drop ">
              <li className="">
                  ...
                  <div className="header-title">
                    <div className="iq-search-bar device-search  position-relative">
                      <form action="#" className="searchbox">
                        <input
                          type="text"
                          className="text search-input form-control bg-primary-subtle w-100"
                ...
                <Card.Body className="p-0 all-notification">
                  <div className="d-flex align-items-center border-bottom search-hover py-2 px-3">
                    ...
                    <div className="ms-3 d-flex flex-column">
                      <Link to="#" className="h5 ">{t("header.paige_turner")}</Link>
                  ...
                  <div className="d-flex align-items-center border-bottom search-hover py-2 px-3">
                    ...
                    <div className="ms-3 d-flex flex-column">
                      <Link to="#" className="h5">{t("header.monty_carlo")}</Link>
                      <div className="d-flex justify-content-between align-items-center">
                  ...
                  <div className="d-flex align-items-center border-bottom search-hover py-2 px-3">
                    ...
                    <div className="ms-3 d-flex flex-column">
                      <Link to="#" className="h5">{t("header.paul_molive")}</Link>
                      <div className="d-flex justify-content-between align-items-center">
          ...
          <Dropdown as="li" className="nav-item theme-scheme-dropdown">
            ...
            <Dropdown.Menu
              variant="end"
              className="list-unstyled dropdown-menu dropdown-content"
            >
              <Dropdown.Item
                to="#"
              ...
              >
                ...
                <span className="ms-2 mb-0"> LTR </span>
              </Dropdown.Item>
              ...
              >
                ...
                <span className="ms-2 mb-0"> RTL </span>
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
          <Dropdown as="li" className="nav-items">
            ...
            >
              <Dropdown.Item to="#" onClick={() => changeLanguage("en")}>
                en
              </Dropdown.Item>
              <Dropdown.Item to="#" onClick={() => changeLanguage("ar")}>
                ar
              </Dropdown.Item>
              <Dropdown.Item to="#" onClick={() => changeLanguage("de")}>
                de
              </Dropdown.Item>
              <Dropdown.Item to="#" onClick={() => changeLanguage("fr")}>
                fr
              </Dropdown.Item>
              <Dropdown.Item to="#" onClick={() => changeLanguage("gr")}>
                gr
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
          <Dropdown as="li" className="nav-item">
            ...
            <Dropdown.Menu variant="end p-0 sub-drop" as="ul">
              <li className="">
                <Card.Header className="p-3 bg-primary">
                  <div className="header-title">
                    <h5 className="mb-0 text-white">
                      {t("header.all_notifications")}
                    </h5>
                  </div>
                </Card.Header>
                <Card.Body className="p-0 all-notification">
                  <div className="iq-sub-card">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-3 w-100">
                        <h6 className="mb-0 ">{t("header.emma_watson_bni")}</h6>
                        <div className="d-flex justify-content-between align-items-center">
                          <p className="mb-0">95 {t("header.mb")}</p>
                  ...
                  <div className="iq-sub-card">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-3 w-100">
                        <h6 className="mb-0 ">
                          {t("header.new_customer_is_join")}
                        </h6>
                        <div className="d-flex justify-content-between align-items-center">
                          <p className="mb-0">{t("header.cyst_bni")}</p>
                          <small className="float-end font-size-12">
                            5 {t("header.days_ago")}
                          </small>
                        </div>
          ...
          <Dropdown as="li" className="nav-item theme-scheme-dropdown">
            ...
            >
              <Dropdown.Item
                to="#"
                className="dropdown-item d-flex align-items-center"
                onClick={() => dispatch(theme_scheme("light"))}
              >
                <svg
                  className="icon-24"
                  width="24"
                ...
                <span className="ms-3 mb-0">{t("header.light")}</span>
              </Dropdown.Item>
              <Dropdown.Item
                to="#"
                className="dropdown-item d-flex align-items-center"
                onClick={() => dispatch(theme_scheme("dark"))}
              >
                <svg
                  className="icon-24"
                  width="24"
                ...
                <span className="ms-3 mb-0">{t("header.dark")}</span>
              </Dropdown.Item>
              <Dropdown.Item
                to="#"
                className="dropdown-item d-flex align-items-center"
                onClick={() => dispatch(theme_scheme("auto"))}
              >
                <svg
                  className="icon-24"
                  width="24"
                ...
                <span className="ms-3 mb-0">{t("header.auto")}</span>
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
          ...
          >
            <Nav.Link id="btnFullscreen" onClick={fullscreen} className="pe-3">
              <span className="btn-inner">
                <svg
                  className={`normal-screen ${show === false ? '' : 'd-none'} icon-24`}
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                  fill="none"
                ...
                <svg
                  className={`full-normal-screen ${show === true ? '' : 'd-none'} icon-32`}
                  width="24"
            ...
            >
              ...
              <div className="caption ms-3 d-none d-md-block ">
                <h6 className="mb-0 caption-title">
                  {t("header.austin_robertson")}
                </h6>
                <p className="mb-0 caption-sub-title">
                  {t("header.marketing_administrator")}
                </p>
              </div>
            </Dropdown.Toggle>
            <Dropdown.Menu variant="end">
              <Dropdown.Item onClick={() => history("/app/user-profile")} href="#">
                {t("header.profile")}
              </Dropdown.Item>
              <Dropdown.Item onClick={() => history("/app/user-privacy-setting")} href="#">
