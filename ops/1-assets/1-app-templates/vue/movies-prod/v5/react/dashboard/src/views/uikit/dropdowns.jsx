  ...
  return (
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/dropdowns"
                  target="_blank"
                >
                  <svg
                    width="20"
          ...
          <Tab.Container defaultActiveKey="first">
              ...
              >
                <Nav.Item as="li" className="" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-dropdown-prv"
                    type="button"
                    role="tab"
                ...
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    className=" d-flex align-items-center"
                    data-bs-toggle="tab"
                    data-bs-target="#content-dropdown-code"
                    type="button"
                    role="tab"
            ...
            <Tab.Content>
              <Tab.Pane
                ...
                id="content-dropdown-prv"
                role="tabpanel"
                aria-labelledby="typo-output"
              >
                <div className="bd-example">
                  <div className="btn-group w-100 align-items-center flex-wrap">
                ...
                <div className="bd-example">
                  <Dropdown
                    drop={"end"}
                    as={ButtonGroup}
                    className=" w-100 align-items-center flex-wrap"
                  >
                    ...
                    <Dropdown drop={"up"} className="me-1">
                      <Dropdown.Toggle
                        as={Button}
                        variant="secondary"
                        type="button"
    ...
    <div className="btn-group w-100 align-items-center justify-content-between flex-wrap">
        ...
        <Dropdown>
            ...
            <Dropdown.Menu aria-labelledby="dropdownMenuButtonLG">
                <li><h6 className="dropdown-header">Dropdown header</h6></li>
                <Dropdown.Item href="#">Action</Dropdown.Item>
                <Dropdown.Item href="#">Another action</Dropdown.Item>
                <Dropdown.Item href="#">Something else here</Dropdown.Item>
...
<div className="bd-example">
    <Dropdown as={ButtonGroup}>
        ...
        <Dropdown.Toggle as={Button} type="button"  split variant="primary">
            <span className="visually-hidden">Toggle Dropdown</span>
        </Dropdown.Toggle>
        <Dropdown.Menu>
            <Dropdown.Item href="#">Action</Dropdown.Item>
    ...
    <div className="bd-example">
        ...
        <Dropdown.Menu aria-labelledby="dropendMenuButton">
            <li><h6 className="dropdown-header">Dropdown header</h6></li>
            <Dropdown.Item href="#">Action</Dropdown.Item>
            <Dropdown.Item href="#">Another action</Dropdown.Item>
            <Dropdown.Item href="#">Something else here</Dropdown.Item>
    ...
    <Dropdown drop={'up'}>
        ...
        <Dropdown.Menu aria-labelledby="dropupMenuButton">
            <li><h6 className="dropdown-header">Dropdown header</h6></li>
            <Dropdown.Item  href="#">Action</Dropdown.Item>
            <Dropdown.Item  href="#">Another action</Dropdown.Item>
            <Dropdown.Item  href="#">Something else here</Dropdown.Item>
    ...
    <Dropdown drop={'start'}>
        ...
        <Dropdown.Menu aria-labelledby="dropstartMenuButton">
            <li><h6 className="dropdown-header">Dropdown header</h6></li>
            <Dropdown.Item  href="#">Action</Dropdown.Item>
            <Dropdown.Item  href="#">Another action</Dropdown.Item>
            <Dropdown.Item  href="#">Something else here</Dropdown.Item>
...
<div className="bd-example">
    <div className="btn-group">
        <Dropdown drop={'end'}>
            ...
            <Dropdown.Menu className="dropdown-menu" aria-labelledby="dropdownRightMenuButton">
                <li><h6 className="dropdown-header">Dropdown header</h6></li>
                <Dropdown.Item  href="#">Action</Dropdown.Item>
                <Dropdown.Item  href="#">Another action</Dropdown.Item>
                <li><hr className="dropdown-divider"/></li>
