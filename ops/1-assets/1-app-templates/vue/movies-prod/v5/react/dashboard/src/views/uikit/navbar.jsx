          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/navbar"
                  target="_blank"
                >
                  <svg
                    width="20"
              ...
              >
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-Navbar-prv"
                    type="button"
                    role="tab"
                ...
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    className=" d-flex align-items-center"
                    data-bs-toggle="tab"
                    data-bs-target="#content-Navbar-code"
                    type="button"
                    role="tab"
            ...
            <Tab.Content className="mt-2">
              ...
              >
                <div className="bd-example">
                    ...
                    <Container fluid>
                      ...
                      >
                        <Nav className=" me-auto mb-2 mb-lg-0">
                          <Nav.Item>
                            <Nav.Link active aria-current="page" h="#">
                              Home
                            </Nav.Link>
                          </Nav.Item>
                          <Nav.Item>
                  ...
                  <Navbar
                    className="navbar-dark rounded-1 mt-4"
                    expand="lg"
                    bg="primary"
                  >
                    <Container fluid>
