                ...
                <article id="accordion">
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <div className="d-flex align-items-center mt-2">
                                    <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/accordion" target="_blank">
                    ...
                    <Card className="iq-document-card iq-doc-head">
                        <div className="d-flex justify-content-end">
                            <ul className="nav nav-tabs nav-tunnel nav-slider" data-toggle="slider-tab" role="tablist">
                                <li className="nav-item" role="presentation">
                                    <button className={`nav-link  d-flex align-items-center ${show === true ? 'active' : ''}`} onClick={() => setShow(true)}>
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li className="nav-item" role="presentation">
                                    <button className={`nav-link d-flex align-items-center ${show === false ? 'active' : ''}`} onClick={() => setShow(false)}>
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="tab-content ">
                            <div className={`tab-pane bd-heading-1 fade show ${show === true ? 'active' : ''}`} id="content-accordion-prv" role="tabpanel">
                            ...
                            <div className={`tab-pane bd-heading-1 fade show ${show === false ? 'active' : ''}`} id="content-accordion-code" role="tabpanel">
