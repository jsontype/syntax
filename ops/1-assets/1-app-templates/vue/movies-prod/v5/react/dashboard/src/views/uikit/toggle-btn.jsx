...
// React-bootstrap
import { Form, FormCheck, Nav, Tab, Button } from "react-bootstrap";

//components
import Card from "../../components/bootstrap/card";

const ToggleBtns = React.memo(() => {
  return (
    <Fragment>
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/toggle-button"
                  target="_blank"
                >
                  <svg
                    width="20"
              ...
              >
                <div className="bd-example">
                  ...
                  <Form.Check className=" form-check-inline">
                    <FormCheck.Input
                      ...
                      disabled
                    />
                    <FormCheck.Label className=" pl-2" htmlFor="customCheck7">
                      Disabled
                    </FormCheck.Label>
                  </Form.Check>
                  <Form.Check className=" form-check-inline">
                    <FormCheck.Input
                      ...
                      disabled
                    />
                    <FormCheck.Label className=" pl-2" htmlFor="customCheck8">
                      Disabled Checked
                    </FormCheck.Label>
                  </Form.Check>
                </div>
                <div className="bd-example">
                  <Form.Check className=" form-check-inline">
                    <FormCheck.Input
                      ...
                      defaultChecked
                    />
                    <FormCheck.Label htmlFor="radio1" className=" pl-2">
                      Active
                    </FormCheck.Label>
                  </Form.Check>
                  <Form.Check className=" form-check-inline">
                    <FormCheck.Input
                      ...
                      id="radio2"
                    />
                    <FormCheck.Label htmlFor="radio2" className=" pl-2">
                      Inactive
                    </FormCheck.Label>
                  </Form.Check>
                  ...
                  <Form.Check className=" form-check-inline">
                    <FormCheck.Input
                      ...
                      disabled
                    />
                    <FormCheck.Label htmlFor="radio3" className=" pl-2">
                      Inactive - Disabled
                    </FormCheck.Label>
                  </Form.Check>
                </div>
                <div className="bd-example">
                  <Form.Check className="form-check form-switch form-check-inline">
                    ...
                    <FormCheck.Label className=" pl-2" htmlFor="switch1">
                      Off Switch
                    </FormCheck.Label>
                  </Form.Check>
                  ...
                  <div className="form-check form-switch form-check-inline">
                    <input
                      ...
                      disabled
                    />
                    <FormCheck.Label className=" pl-2" htmlFor="switch3">
                      Disabled Switch
                    </FormCheck.Label>
                  </div>
                  <div className="form-check form-switch form-check-inline">
                    <input
                      ...
                      disabled
                    />
                    <FormCheck.Label htmlFor="switch4"> Switch</FormCheck.Label>
                  </div>
                </div>
              </Tab.Pane>
              <Tab.Pane
