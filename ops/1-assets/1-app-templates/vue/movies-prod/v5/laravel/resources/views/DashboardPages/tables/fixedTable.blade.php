                  ...
                  <tbody>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                              <img class="rounded img-fluid avatar-40 me-3 bg-primary-subtle"
                                  src="{{ asset('dashboard/images/shapes/01.png') }}" alt="profile" loading="lazy" />
                      ...
                      <tr>
                        <td>
                            <div class="d-flex align-items-center">
                              <img class="rounded img-fluid avatar-40 me-3 bg-primary-subtle"
                                  src="{{ asset('dashboard/images/shapes/02.png') }}" alt="profile" loading="lazy" />
                      ...
                      <tr>
                        <td>
                            <div class="d-flex align-items-center">
                              <img class="rounded img-fluid avatar-40 me-3 bg-primary-subtle"
                                  src="{{ asset('dashboard/images/shapes/03.png') }}" alt="profile" loading="lazy" />
                      ...
                      <tr>
                        <td>
                            <div class="d-flex align-items-center">
                              <img class="rounded img-fluid avatar-40 me-3 bg-primary-subtle"
                                  src="{{ asset('dashboard/images/shapes/04.png') }}" alt="profile" loading="lazy" />
                      ...
                      <tr>
                        <td>
                            <div class="d-flex align-items-center">
                              <img class="rounded img-fluid avatar-40 me-3 bg-primary-subtle"
                                  src="{{ asset('dashboard/images/shapes/06.png') }}" alt="profile" loading="lazy" />
