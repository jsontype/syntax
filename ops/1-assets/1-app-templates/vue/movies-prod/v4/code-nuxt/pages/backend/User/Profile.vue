              ...
              <div class="cover-container text-center">
                ...
                <div class="iq-social d-inline-block align-items-center">
                  <ul class="list-inline d-flex p-0 mb-0 align-items-center">
                    <li>
                      <a href="#" class="avatar-40 rounded-circle bg-primary mr-2 facebook"><i class="fab fa-facebook" aria-hidden="true" /></a>
                    </li>
                    <li>
                      <a href="#" class="avatar-40 rounded-circle bg-primary mr-2 twitter"><i class="fab fa-twitter" aria-hidden="true" /></a>
                    </li>
                    <li>
                      <a href="#" class="avatar-40 rounded-circle bg-primary mr-2 youtube"><i class="fab fa-youtube" aria-hidden="true" /></a>
                    </li>
                    <li>
                      <a href="#" class="avatar-40 rounded-circle bg-primary pinterest"><i class="fab fa-pinterest-p" aria-hidden="true" /></a>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <ul class="list-inline p-0 mb-0">
                  <li class="d-flex mb-4 align-items-center">
                    <div class="profile-icon bg-secondary">
                      <span><i class="ri-file-3-fill" /></span>
                    </div>
                    ...
                    <div class="iq-card-toolbar">
                      <b-dropdown id="dropdownMenuButton40" right variant="none" menu-class="p-0">
                        <template v-slot:button-content>
                          <b-link href="#" class="font-size-24">
                            <i class="ri-more-line" />
                          </b-link>
                        </template>
                        <b-dropdown-item href="#">
                          <i class="ri-user-unfollow-line mr-2" />Share
                        </b-dropdown-item>
                        <b-dropdown-item href="#">
                  ...
                  <li class="d-flex mb-4 align-items-center">
                    <div class="profile-icon bg-secondary">
                      <span><i class="ri-image-fill" /></span>
                    </div>
                    <div class="media-support-info ml-3">
                      <h6>Images</h6>
                      <p class="mb-0">
                  ...
                  <li class="d-flex mb-4 align-items-center">
                    <div class="profile-icon bg-secondary">
                      <span><i class="ri-video-fill" /></span>
                    </div>
                    <div class="media-support-info ml-3">
                      <h6>Videos</h6>
                      <p class="mb-0">
                  ...
                  <li class="d-flex align-items-center">
                    <div class="profile-icon bg-secondary">
                      <span><i class="ri-refresh-line" /></span>
                    </div>
                    <div class="media-support-info ml-3">
                      <h6>Celine Dion</h6>
                      <p class="mb-0">
          ...
          <div class="iq-card-header d-flex justify-content-between align-items-center mb-0">
            ...
            <div class="iq-card-header-toolbar d-flex align-items-center">
              <b-dropdown id="dropdownMenuButton40" right variant="none" menu-class="p-0">
                ...
                <b-dropdown-item href="#">
                  <i class="ri-delete-bin-6-fill mr-2" />Delete
                </b-dropdown-item>
                <b-dropdown-item href="#">
            ...
            <ul class="perfomer-lists m-0 p-0">
              <li class="d-flex mb-4 align-items-center">
                <div class="user-img img-fluid">
                  <img class="img-fluid avatar-50 rounded-circle" src="../../../assets/images/user/06.jpg" alt="">
                </div>
                <div class="media-support-info ml-3">
              ...
              <li class="d-flex mb-4 align-items-center">
                <div class="user-img img-fluid">
                  <img class="img-fluid avatar-50 rounded-circle" src="../../../assets/images/user/07.jpg" alt="">
                </div>
                <div class="media-support-info ml-3">
              ...
              <li class="d-flex align-items-center">
                <div class="user-img img-fluid">
                  <img class="img-fluid avatar-50 rounded-circle" src="../../../assets/images/user/08.jpg" alt="">
                </div>
                <div class="media-support-info ml-3">
              ...
              <li class="row align-items-center justify-content-between">
                ...
                <div class="col-md-4 text-right">
                  <div class="iq-card-header-toolbar d-flex align-items-center">
                    ...
                    <div class="iq-progress-bar-linear d-inline-block mt-1 w-100">
                      <Progressbar :value="85" color="danger" />
                    </div>
                  </div>
                </div>
              </li>
