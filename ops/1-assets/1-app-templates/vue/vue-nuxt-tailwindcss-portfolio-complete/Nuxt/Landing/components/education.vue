        ...
        <div class="container">
            ...
            <div class="grid grid-cols-1 mt-14">
                <div class="relative space-y-12 md:space-y-8" data-aos="fade-up">
                    ...
                    <div class="block shrink-0 bg-[url('../images/dot-line.svg')] dark:bg-[url('../images/dot-line-dark.svg')] w-[2px] bg-center bg-cover absolute h-full ltr:left-0 rtl:right-0 ltr:md:left-1/2 rtl:md:right-1/2 transform ltr:md:-translate-x-1/2 rtl:md:translate-x-1/2"></div>
                    ...
                    <div class="relative !mt-0">
                        <div class="flex flex-col items-center md:flex-row">
                            ...
                            <div class="bg-gradient-radial from-[#994FF5] to-[#FFC41F] shrink-0 rounded-full w-2.5 h-2.5 block absolute ltr:left-px rtl:right-px -translate-x-1/2 ltr:md:left-1/2 rtl:md:right-1/2 transform ltr:md:-translate-x-1/2 rtl:md:translate-x-1/2 top-1/2 -translate-y-1/2"></div>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        <div class="flex flex-col items-center md:flex-row">
                            ...
                            <div class="bg-gradient-radial from-[#994FF5] to-[#FFC41F] shrink-0 rounded-full w-2.5 h-2.5 block absolute ltr:left-px rtl:right-px ltr:-translate-x-1/2 rtl:translate-x-1/2 ltr:md:left-1/2 rtl:md:right-1/2 transform ltr:md:-translate-x-1/2 rtl:md:translate-x-1/2 top-1/2 -translate-y-1/2"></div>
                        </div>
                    </div>
                            ...
                            <div class="flex items-center justify-start w-full mx-auto">
                                <div class="w-full md:w-1/2 ltr:pl-7 rtl:pr-7 ltr:md:pr-8 rtl:md:pl-8 ltr:lg:pr-14 rtl:lg:pl-14">
                                    <div class="space-y-5 ltr:text-left rtl:text-right ltr:md:text-right rtl:md:text-left">
                                        <div>
                                            <svg class="inline-block" width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.2" d="M27.625 12.75V28.6875C27.625 28.9693 27.5131 29.2395 27.3138 29.4388C27.1145 29.6381 26.8443 29.75 26.5625 29.75H23.375V20.1875C23.375 19.6239 23.1511 19.0834 22.7526 18.6849C22.3541 18.2864 21.8136 18.0625 21.25 18.0625H12.75C12.1864 18.0625 11.6459 18.2864 11.2474 18.6849C10.8489 19.0834 10.625 19.6239 10.625 20.1875V29.75H7.4375C7.15571 29.75 6.88546 29.6381 6.6862 29.4388C6.48694 29.2395 6.375 28.9693 6.375 28.6875V12.75C6.375 11.0592 7.04665 9.43774 8.24219 8.24219C9.43774 7.04665 11.0592 6.375 12.75 6.375H21.25C22.9408 6.375 24.5623 7.04665 25.7578 8.24219C26.9534 9.43774 27.625 11.0592 27.625 12.75Z" fill="url(#paint0_radial_96_395)" />
                                                <path d="M22.3125 5.38953V4.25C22.3125 3.40462 21.9767 2.59387 21.3789 1.9961C20.7811 1.39832 19.9704 1.0625 19.125 1.0625H14.875C14.0296 1.0625 13.2189 1.39832 12.6211 1.9961C12.0233 2.59387 11.6875 3.40462 11.6875 4.25V5.38953C9.91854 5.64737 8.30129 6.53272 7.13093 7.884C5.96057 9.23527 5.31516 10.9624 5.3125 12.75V28.6875C5.3125 29.2511 5.53638 29.7916 5.9349 30.1901C6.33341 30.5886 6.87391 30.8125 7.4375 30.8125H26.5625C27.1261 30.8125 27.6666 30.5886 28.0651 30.1901C28.4636 29.7916 28.6875 29.2511 28.6875 28.6875V12.75C28.6848 10.9624 28.0394 9.23527 26.8691 7.884C25.6987 6.53272 24.0815 5.64737 22.3125 5.38953ZM14.875 3.1875H19.125C19.4068 3.1875 19.677 3.29944 19.8763 3.4987C20.0756 3.69796 20.1875 3.96821 20.1875 4.25V5.3125H13.8125V4.25C13.8125 3.96821 13.9244 3.69796 14.1237 3.4987C14.323 3.29944 14.5932 3.1875 14.875 3.1875ZM22.3125 21.25H11.6875V20.1875C11.6875 19.9057 11.7994 19.6355 11.9987 19.4362C12.198 19.2369 12.4682 19.125 12.75 19.125H21.25C21.5318 19.125 21.802 19.2369 22.0013 19.4362C22.2006 19.6355 22.3125 19.9057 22.3125 20.1875V21.25ZM11.6875 23.375H18.0625V24.4375C18.0625 24.7193 18.1744 24.9895 18.3737 25.1888C18.573 25.3881 18.8432 25.5 19.125 25.5C19.4068 25.5 19.677 25.3881 19.8763 25.1888C20.0756 24.9895 20.1875 24.7193 20.1875 24.4375V23.375H22.3125V28.6875H11.6875V23.375ZM26.5625 28.6875H24.4375V20.1875C24.4375 19.3421 24.1017 18.5314 23.5039 17.9336C22.9061 17.3358 22.0954 17 21.25 17H12.75C11.9046 17 11.0939 17.3358 10.4961 17.9336C9.89832 18.5314 9.5625 19.3421 9.5625 20.1875V28.6875H7.4375V12.75C7.4375 11.341 7.99721 9.98978 8.9935 8.99349C9.98978 7.99721 11.341 7.4375 12.75 7.4375H21.25C22.659 7.4375 24.0102 7.99721 25.0065 8.99349C26.0028 9.98978 26.5625 11.341 26.5625 12.75V28.6875ZM20.1875 11.6875C20.1875 11.9693 20.0756 12.2395 19.8763 12.4388C19.677 12.6381 19.4068 12.75 19.125 12.75H14.875C14.5932 12.75 14.323 12.6381 14.1237 12.4388C13.9244 12.2395 13.8125 11.9693 13.8125 11.6875C13.8125 11.4057 13.9244 11.1355 14.1237 10.9362C14.323 10.7369 14.5932 10.625 14.875 10.625H19.125C19.4068 10.625 19.677 10.7369 19.8763 10.9362C20.0756 11.1355 20.1875 11.4057 20.1875 11.6875Z" fill="url(#paint1_radial_96_395)" />
                                                <defs>
                                                    <radialGradient id="paint0_radial_96_395" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(17 18.0625) rotate(132.274) scale(15.7952 15.7237)">
                                                        <stop stop-color="#994FF5" />
                                                        <stop offset="1" stop-color="#FFC41F" />
                                                    </radialGradient>
                                                    <radialGradient id="paint1_radial_96_395" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(17 15.9375) rotate(128.157) scale(18.9173 18.3802)">
                                                        <stop stop-color="#994FF5" />
                                                        <stop offset="1" stop-color="#FFC41F" />
                                                    </radialGradient>
                                                </defs>
                                ...
                                <div class="w-full md:w-1/2 ltr:pl-7 rtl:pr-7 ltr:md:pl-8 rtl:md:pr-8 ltr:lg:pl-14 rtl:lg:pr-14">
                                    <div class="space-y-5 ltr:text-left rtl:text-right">
                                        ...
                                        <div class="mt-7">
                                            ...
                                            <p class="mt-5 text-gray">Collaboration with visual designers: Working closely with visual designers to ensure that UI design elements align with the overall visual aesthetics and brand guidelines.</p>
                                            <p class="mt-6 font-semibold">3336 Southern Street Mineola, NY 11501</p>
                                            <div class="flex flex-wrap items-center gap-5 mt-7">
                                                <div class="flex items-center justify-center border-2 rounded-full h-14 w-14 border-gray/10 backdrop-blur-2xl bg-gradient-liner from-gray/10 to-transparent">
