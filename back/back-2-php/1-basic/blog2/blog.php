...
2. 그 외의 파일들은 구조가 똑같음 : bbs로 된 폴더/파일명을 모두 blog로 바꾸기, 그 안의 내용중 "bbs", "게시판" 단어를 검색해 모두 "blog", "블로그"로 바꾸기
...
$blogid = $v['blogid'];
$no = $v['no'];
$sql_count = "SELECT * FROM `azuma_php_comment1` WHERE delflag = '0' AND cid = '$blogid' AND no = '$no'";
